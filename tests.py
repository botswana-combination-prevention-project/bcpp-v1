...
class ResultItemTestCase(unittest.TestCase):
    ...
    def test_haemaglobin_grade_flag(self):
            for flag_args in TRUE_G1_ASSERTIONS:
                if not self.assertTrue(self.get_result_item_flag(flag_args) == 1, "TRUE_G1 " + str(flag_args['result_value']) + " FAILED"):
                    print 'pass'
#            print "--------------------------------------------------------------------"
            for flag_args in FALSE_G1_ASSERTIONS:
                self.assertFalse(self.get_result_item_flag(flag_args) == 1, "FALSE_G1 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            for flag_args in TRUE_G2_ASSERTIONS:
                self.assertTrue(self.get_result_item_flag(flag_args) == 2, "TRUE_G2 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            for flag_args in FALSE_G2_ASSERTIONS:
                self.assertFalse(self.get_result_item_flag(flag_args) == 2, "FALSE_G2 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            for flag_args in TRUE_G3_ASSERTIONS:
                self.assertTrue(self.get_result_item_flag(flag_args) == 3, "TRUE_G3 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            for flag_args in FALSE_G3_ASSERTIONS:
                self.assertFalse(self.get_result_item_flag(flag_args) == 3, "FALSE_G3 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            #for flag_args in TRUE_G4_ASSERTIONS:
            #    self.assertTrue(self.get_result_item_flag(flag_args) == 4, "TRUE_G4 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
            #for flag_args in FALSE_G4_ASSERTIONS:
            #    self.assertFalse(self.get_result_item_flag(flag_args) == 4, "FALSE_G4 " + str(flag_args['result_value']) + " FAILED")
#            print "--------------------------------------------------------------------"
    ...
    def get_result_item_flag(self, flag_args):
        ...
        # pdb.set_trace()
        reference_range, reference_flag, grade_range, grade_flag = ResultItemFlag().calculate(result_item, hiv_status=flag_args.get('hiv_status'))
        return grade_flag
