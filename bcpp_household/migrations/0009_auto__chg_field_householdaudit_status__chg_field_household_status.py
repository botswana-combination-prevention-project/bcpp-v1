...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bcpp_household_household_audit', 'status', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'Household.status'
        db.alter_column('bcpp_household_household', 'status', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))
