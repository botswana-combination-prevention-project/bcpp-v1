...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bcpp_household_householdlogentry_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdStructureAudit._audit_subject_identifier'
        db.add_column('bcpp_household_householdstructure_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit._audit_subject_identifier'
        db.add_column('bcpp_household_household_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdLogAudit._audit_subject_identifier'
        db.add_column('bcpp_household_householdlog_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'PlotAudit._audit_subject_identifier'
        db.add_column('bcpp_household_plot_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bcpp_household_householdlogentry_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdStructureAudit._audit_subject_identifier'
        db.delete_column('bcpp_household_householdstructure_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdAudit._audit_subject_identifier'
        db.delete_column('bcpp_household_household_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdLogAudit._audit_subject_identifier'
        db.delete_column('bcpp_household_householdlog_audit', '_audit_subject_identifier')

        # Deleting field 'PlotAudit._audit_subject_identifier'
        db.delete_column('bcpp_household_plot_audit', '_audit_subject_identifier')
