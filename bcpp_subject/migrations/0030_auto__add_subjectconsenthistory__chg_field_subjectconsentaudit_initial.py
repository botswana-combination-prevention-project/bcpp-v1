...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bcpp_subject_subjectconsenthistory')
        ...
        # Changing field 'Grant.grant_type'
        db.alter_column('bcpp_subject_grant', 'grant_type', self.gf('django.db.models.fields.CharField')(max_length=34))

        # Changing field 'SubjectConsent.household_member'
        db.alter_column('bcpp_subject_subjectconsent', 'household_member_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household_member.HouseholdMember'], unique=True))
        # Adding unique constraint on 'SubjectConsent', fields ['household_member']
        db.create_unique('bcpp_subject_subjectconsent', ['household_member_id'])


        # Changing field 'SubjectConsent.registered_subject'
        db.alter_column('bcpp_subject_subjectconsent', 'registered_subject_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_registration.RegisteredSubject'], unique=True, null=True))
        # Adding unique constraint on 'SubjectConsent', fields ['registered_subject']
        db.create_unique('bcpp_subject_subjectconsent', ['registered_subject_id'])
        ...
        # Changing field 'GrantAudit.grant_type'
        db.alter_column('bcpp_subject_grant_audit', 'grant_type', self.gf('django.db.models.fields.CharField')(max_length=34))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 15, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 15, 0, 0)'}),
