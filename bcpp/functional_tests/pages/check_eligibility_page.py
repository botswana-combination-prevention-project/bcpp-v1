...
class CheckEligibilityPage(BaseModelAdminPage):
    ...
    confirm_participation = (By.ID, 'id_confirm_participation')
    confirm_participation_yes = (By.ID, 'id_confirm_participation_0')
    confirm_participation_no = (By.ID, 'id_confirm_participation_1')
    confirm_participation_na = (By.ID, 'id_confirm_participation_2')
    ...
    guardian_yes = (By.ID, 'id_guardian_0')
    guardian_no = (By.ID, 'id_guardian_1')
    guardian_na = (By.ID, 'id_guardian_2')
    ...
    def fill_check_eligibilty(
        ...
        self.set_literacy(literacy)
        self.set_guardian(guardian)
