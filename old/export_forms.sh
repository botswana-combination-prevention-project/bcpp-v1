if [ "$1" = "CPCT0" ]
then 
echo "Exporting CPC T0 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
...
if [ "$1" = "CPCT1" ]
then
echo "Exporting CPC T1 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
...
if [ "$1" = "CPCT2" ]
then
echo "Exporting CPC T2 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
python manage.py export_forms --visit=T2  > ~/export_forms/export_forms_cpc_t2-survey.txt
echo "bcpp_household"
python manage.py export_forms --app bcpp_household  > ~/export_forms/export_forms_cpc_t2-household.txt
echo "bcpp_household_member"
python manage.py export_forms --app bcpp_household_member  > ~/export_forms/export_forms_cpc_t2-householdmember.txt
echo "bcpp_lab"
python manage.py export_forms --app bcpp_lab  > ~/export_forms/export_forms_cpc_t2-lab.txt
echo "bcpp_clinic"
python manage.py export_forms --app bcpp_clinic  > ~/export_forms/export_forms_cpc_t2-clinic.txt
fi
if [ "$1" = "ECCT0" ]
then
echo "Exporting ECC T0 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
...
if [ "$1" = "ECCT1" ]
then
echo "Exporting ECC T1 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
...
if [ "$1" = "ECCT2" ]
then
echo "Exporting ECC T2 from ~/source/bhp066/bhp066_master"
cd ~/source/bhp066/bhp066_master/
echo "bcpp_subject"
python manage.py export_forms --visit=T2  > ~/export_forms/export_forms_ecc_t2-survey.txt
echo "bcpp_household"
python manage.py export_forms --app bcpp_household  > ~/export_forms/export_forms_ecc_t2-household.txt
echo "bcpp_household_member"
python manage.py export_forms --app bcpp_household_member  > ~/export_forms/export_forms_ecc_t2-householdmember.txt
echo "bcpp_lab"
python manage.py export_forms --app bcpp_lab  > ~/export_forms/export_forms_ecc_t2-lab.txt
echo "bcpp_clinic"
python manage.py export_forms --app bcpp_clinic  > ~/export_forms/export_forms_ecc_t2-clinic.txt
fi
echo "Done"
