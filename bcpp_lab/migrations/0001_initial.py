# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-15 19:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HistoricalSpecimenCollection',
            fields=[
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('user_created', edc_base.model.fields.userfield.UserField(editable=False, max_length=50, verbose_name='user created')),
                ...
                ('collection_identifier', models.CharField(db_index=True, editable=False, max_length=25, verbose_name='Collection Identifier')),
            ...
            options={
                ...
                'verbose_name': 'historical specimen collection',
                'ordering': ('-history_date', '-history_id'),
            },
        ),
        migrations.CreateModel(
            name='HistoricalSpecimenCollectionItem',
            fields=[
                ('created', django_extensions.db.fields.CreationDateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modified')),
                ('user_created', edc_base.model.fields.userfield.UserField(editable=False, max_length=50, verbose_name='user created')),
            ...
            options={
                'get_latest_by': 'history_date',
                'verbose_name': 'historical specimen collection item',
                'ordering': ('-history_date', '-history_id'),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specimen_identifier', models.CharField(max_length=25, verbose_name='Specimen Identifier')),
                ('collection_condition', models.CharField(default='OK', max_length=50, verbose_name='Condition of specimen')),
                ('specimen_collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bcpp_lab.SpecimenCollection')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='historicalspecimencollectionitem',
            name='specimen_collection',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='bcpp_lab.SpecimenCollection'),
        ),
    ]
