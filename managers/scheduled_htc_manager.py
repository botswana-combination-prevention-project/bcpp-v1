...
class ScheduledHtcManager(models.Manager):
    ...
    def get_by_natural_key(self, report_datetime, visit_instance, code, subject_identifier_as_pk):
        HtcSubjectVisit = models.get_model('bcpp_subject_htc', 'HtcSubjectVisit')
        htc_subject_visit = HtcSubjectVisit.objects.get_by_natural_key(report_datetime, visit_instance, code, subject_identifier_as_pk)
