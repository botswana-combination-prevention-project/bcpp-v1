...
class ScheduledEntryBucketManager(BaseEntryBucketManager):
    ...
    def get_entries_for(self, **kwargs):
        """Returns a queryset of ScheduledEntryBucket objects for the given subject and appointment.
    ...
    def add_for_visit(self, **kwargs):
        """ Adds entries to the scheduled_entry_bucket for a given visit_model.
