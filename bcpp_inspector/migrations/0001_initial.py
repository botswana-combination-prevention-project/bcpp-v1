...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_inspector_subjectrequisitioninspector', (
            ...
            ('specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=50)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bcpp_inspector_subjectrequisitioninspector')
