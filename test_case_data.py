...
G1_TEST_7 = {'result_value': 8.4444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_8 = {'result_value': 8.44459,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_9 = {'result_value': 9.44444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_10 = {'result_value': 9.4445,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_11 = {'result_value': 9.1111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_12 = {'result_value': 10.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
...
G2_TEST_7 = {'result_value': 6.9444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_8 = {'result_value': 7.0444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_9 = {'result_value': 8.4444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_10 = {'result_value': 8.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_11 = {'result_value': 8.11111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_12 = {'result_value': 9.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
...
G3_TEST_7 = {'result_value': 5.944,#FALSE
             ...
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_8 = {'result_value': 6.0444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_9 = {'result_value': 6.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_10 = {'result_value': 6.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_11 = {'result_value': 6.91111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_12 = {'result_value': 7.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
...
G4_TEST_5 = {'result_value': 5.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_6 = {'result_value': 5.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_7 = {'result_value': 6.0444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_8 = {'result_value': 5.0000,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_2),
             'gender': 'MF',
...
G1_TEST_13 = {'result_value': 9.4444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_14 = {'result_value': 9.44459,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_15 = {'result_value': 10.54444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_16 = {'result_value': 10.5445,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_17 = {'result_value': 9.7777,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_18 = {'result_value': 11.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
...
# Adult and Pediartic 36-56 days HIV POSETIVE/NEGATIVE-GRADE2
G2_TEST_13 = {'result_value': 7.9444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_14 = {'result_value': 8.0444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_15 = {'result_value': 9.4444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_16 = {'result_value': 9.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_17 = {'result_value': 9.11111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_18 = {'result_value': 10.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
...
G3_TEST_13 = {'result_value': 6.944,#FALSE
             ...
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_14 = {'result_value': 7.0444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_15 = {'result_value': 7.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_16 = {'result_value': 7.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_17 = {'result_value': 7.51111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_18 = {'result_value': 8.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
...
# Adult and Pediartic> 36-56 days HIV POSETIVE/NEGATIVE-GRADE4
G4_TEST_9 = {'result_value': 7.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_10 = {'result_value': 7.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_11 = {'result_value': 7.0444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_12 = {'result_value': 6.0000,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_3),
             'gender': 'MF',
...
G1_TEST_19 = {'result_value': 11.9444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_20 = {'result_value': 11.94459,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_21 = {'result_value': 13.04444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_22 = {'result_value': 13.0445,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_23 = {'result_value': 12.7777,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G1_TEST_24 = {'result_value': 13.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
...
# Adult and Pediartic 36-56 days HIV POSETIVE/NEGATIVE-GRADE2
G2_TEST_19 = {'result_value': 9.9444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_20 = {'result_value': 9.9445,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_21 = {'result_value': 11.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_22 = {'result_value': 11.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_23 = {'result_value': 10.11111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G2_TEST_24 = {'result_value': 12.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
...
G3_TEST_19 = {'result_value': 8.944,#FALSE
             ...
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_20 = {'result_value': 8.9445,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_21 = {'result_value': 9.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_22 = {'result_value': 9.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_23 = {'result_value': 9.51111,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G3_TEST_24 = {'result_value': 10.44459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
...
# Adult and Pediartic> 36-56 days HIV POSETIVE/NEGATIVE-GRADE4
G4_TEST_13 = {'result_value': 8.9444,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_14 = {'result_value': 8.94459,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_15 = {'result_value': 9.0444,#FALSE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
             'hiv_status': 'ANY'}
G4_TEST_16 = {'result_value': 8.0000,#TRUE
             'test_code': 'HGB',
             'datetime_drawn': date.today(),
             'dob': date.today()-timedelta(days=DAYS_TO_SUBTRACT_4),
             'gender': 'MF',
...
FALSE_G1_ASSERTIONS = [G1_TEST_1,G1_TEST_4,G1_TEST_6,G1_TEST_7,G1_TEST_10,G1_TEST_12,G1_TEST_13,G1_TEST_16,G1_TEST_18,G1_TEST_19,G1_TEST_22,G1_TEST_24]
