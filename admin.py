...
class GradingListItemAdmin(MyModelAdmin):
    list_display = ('test_code', 'gender', 'hiv_status','grade', 'lln', 'uln', 'age_low', 'age_low_unit','age_low_quantifier','age_high','age_high_unit','age_high_quantifier', 'panic_value_low', 'panic_value_high', 'grading_list')
