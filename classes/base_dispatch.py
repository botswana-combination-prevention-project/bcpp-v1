...
class BaseDispatch(Base):
    ...
    def _set_dispatch_container_register_instance(self):
        ...
        obj = user_container_model.objects.using(self.get_using_source()).get(**{self.get_user_container_identifier_attrname(): self.get_user_container_identifier()})
        if not getattr(obj, self.get_user_container_identifier_attrname()):
        ...
        self._dispatch_container_register = DispatchContainerRegister.objects.using(self.get_using_source()).create(
            ...
            container_identifier=getattr(obj, self.get_user_container_identifier_attrname()),
            container_pk=obj.pk)
