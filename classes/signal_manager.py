...
from bhp_subject.models.signals import base_subject_on_post_save
...
class SignalManager(object):
    ...
    def disconnect(self, obj):
        ...
        signals.pre_save.disconnect(base_subject_on_post_save, weak=False, dispatch_uid="base_subject_on_post_save")
    ...
    def reconnect(self):
        ...
        signals.pre_save.connect(base_subject_on_post_save, weak=False, dispatch_uid="base_subject_on_post_save")
