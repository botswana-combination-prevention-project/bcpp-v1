...
class BucketController(object):
    ...
    def update_all(self, visit_model_instance):
        ...
        #visit_model_help = VisitModelHelper()
...
#                        visit_model_fieldname = visit_model_help.get_visit_field(model=model, visit_model=visit_model_instance)
#                        if model.objects.filter(**{visit_model_fieldname: visit_model_instance}):
#                            instance = model.objects.get(**{visit_model_fieldname: visit_model_instance})
