# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-10 02:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_status', models.CharField(choices=[('DECEASED', 'DECEASED'), ('NOT_REPORTED', 'NOT_REPORTED'), ('REFUSED', 'REFUSED'), ('UNDECIDED', 'UNDECIDED'), ('HTC_ELIGIBLE', 'HTC_ELIGIBLE'), ('BHS', 'BHS'), ('BHS_LOSS', 'BHS_LOSS'), ('REFUSED_HTC', 'REFUSED_HTC'), ('ANNUAL', 'ANNUAL'), ('NOT_ELIGIBLE', 'NOT_ELIGIBLE'), ('HTC', 'HTC'), ('ABSENT', 'ABSENT'), ('BHS_ELIGIBLE', 'BHS_ELIGIBLE'), ('BHS_SCREEN', 'BHS_SCREEN')], db_index=True, editable=False, help_text='RESEARCH, ABSENT, REFUSED, UNDECIDED', max_length=25, null=True)),
        ...
        migrations.AlterUniqueTogether(
            name='householdmember',
            unique_together=set([('household_structure', 'first_name', 'initials', 'additional_key'), ('registered_subject', 'household_structure')]),
        ),
