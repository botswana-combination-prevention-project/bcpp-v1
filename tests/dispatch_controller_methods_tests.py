...
from bhp_dispatch.classes import Base
...
class DispatchControllerMethodsTests(TestCase):
    ...
    def test_base_methods(self):
        ...
        self.assertTrue(base_controller.has_incoming_transactions(RegisteredSubject))
        ...
        self.assertRaises(PendingTransactionError, base_controller.dispatch_model_as_json, RegisteredSubject)
        ...
        self.assertFalse(base_controller.has_incoming_transactions(RegisteredSubject))
        # assert there are no pending transactions
        self.assertFalse(base_controller.has_pending_transactions(RegisteredSubject))
