...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TestCodeReference'
        db.create_table('bhp_lab_core_testcodereference', (
            ...
            ('test_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['models.TestCode'])),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('age_low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True)),
            ('age_low_unit', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('age_low_quantifier', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('age_high', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True)),
            ('age_high_unit', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('age_high_quantifier', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('panic_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True)),
            ('panic_value_quantifier', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('bhp_lab_core', ['TestCodeReference'])

        # Changing field 'TestMap.local_test_code'
        db.alter_column('bhp_lab_core_testmap', 'local_test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['models.TestCode']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TestCodeReference'
        db.delete_table('bhp_lab_core_testcodereference')

        # Changing field 'TestMap.local_test_code'
        db.alter_column('bhp_lab_core_testmap', 'local_test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.TestCode']))
    ...
    models = {
        'bhp_lab_core.aliquot': {
            ...
            'measure': ('django.db.models.fields.DecimalField', [], {'default': "'5.00'", 'max_digits': '10', 'decimal_places': '2'}),
        ...
        'bhp_lab_core.aliquotmedium': {
            'Meta': {'ordering': "['display_index']", 'object_name': 'AliquotMedium'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'display_index': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'field_name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 21, 8, 22, 794715)'}),
        ...
        'bhp_lab_core.panel': {
            ...
            'test_code': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['models.TestCode']", 'symmetrical': 'False'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        ...
        'bhp_lab_core.testcodereference': {
            ...
            'test_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['models.TestCode']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        ...
        'bhp_lab_core.testmap': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_test_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['models.TestCode']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
