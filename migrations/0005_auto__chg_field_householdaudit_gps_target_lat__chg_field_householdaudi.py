...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseholdAudit.gps_target_lat'
        db.alter_column('bcpp_household_household_audit', 'gps_target_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'HouseholdAudit.gps_target_lon'
        db.alter_column('bcpp_household_household_audit', 'gps_target_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Household.gps_target_lat'
        db.alter_column('bcpp_household_household', 'gps_target_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Household.gps_target_lon'
        db.alter_column('bcpp_household_household', 'gps_target_lon', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_target_lat'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_target_lat' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_target_lon'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_target_lon' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_target_lat'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_target_lat' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_target_lon'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_target_lon' and its values cannot be restored.")
