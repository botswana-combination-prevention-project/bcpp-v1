...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QualityOfLife.self_care'
        db.alter_column('bcpp_subject_qualityoflife', 'self_care', self.gf('django.db.models.fields.CharField')(max_length=65))

        # Changing field 'QualityOfLifeAudit.self_care'
        db.alter_column('bcpp_subject_qualityoflife_audit', 'self_care', self.gf('django.db.models.fields.CharField')(max_length=65))


    def backwards(self, orm):
        
        # Changing field 'QualityOfLife.self_care'
        db.alter_column('bcpp_subject_qualityoflife', 'self_care', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'QualityOfLifeAudit.self_care'
        db.alter_column('bcpp_subject_qualityoflife_audit', 'self_care', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 13, 32, 540061)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 13, 32, 656012)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 13, 32, 247114)'}),
