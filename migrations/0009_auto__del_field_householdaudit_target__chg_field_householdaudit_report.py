...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdAudit.target'
        db.delete_column('bcpp_household_household_audit', 'target')


        # Changing field 'HouseholdAudit.report_datetime'
        db.alter_column('bcpp_household_household_audit', 'report_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'Household.target'
        db.delete_column('bcpp_household_household', 'target')


        # Changing field 'Household.report_datetime'
        db.alter_column('bcpp_household_household', 'report_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Adding field 'HouseholdAudit.target'
        db.add_column('bcpp_household_household_audit', 'target',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.report_datetime'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.report_datetime' and its values cannot be restored.")
        # Adding field 'Household.target'
        db.add_column('bcpp_household_household', 'target',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Household.report_datetime'
        raise RuntimeError("Cannot reverse this migration. 'Household.report_datetime' and its values cannot be restored.")
