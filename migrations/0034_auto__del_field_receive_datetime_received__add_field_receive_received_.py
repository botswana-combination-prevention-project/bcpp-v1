...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receive.received_datetime'
        db.rename_column('bhp_lab_core_receive', 'datetime_received', 'receive_datetime')


    def backwards(self, orm):
        
        # Adding field 'Receive.received_datetime'
        db.rename_column('bhp_lab_core_receive', 'receive_datetime', 'datetime_received')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 10, 6, 38, 301629)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 10, 6, 38, 333656)'}),
