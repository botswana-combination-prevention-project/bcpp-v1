...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_subjectrefusal', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 25, 17, 4, 28, 514643))),
        ...
        # Adding model 'SubjectConsentYearTwoAudit'
        db.create_table('bcpp_subject_subjectconsentyeartwo_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyeartwo', to=orm['bhp_variables.StudySite'])),
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyeartwo', to=orm['bhp_registration.RegisteredSubject'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyeartwo', to=orm['bcpp_survey.Survey'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('screening_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('randomization_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyeartwo', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearTwoAudit'])
        ...
        # Adding model 'SubjectConsentYearOne'
        db.create_table('bcpp_subject_subjectconsentyearone', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearOne'])

        # Adding unique constraint on 'SubjectConsentYearOne', fields ['first_name', 'last_name', 'dob']
        db.create_unique('bcpp_subject_subjectconsentyearone', ['first_name', 'last_name', 'dob'])

        # Adding model 'SubjectConsentYearThree'
        db.create_table('bcpp_subject_subjectconsentyearthree', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearThree'])

        # Adding unique constraint on 'SubjectConsentYearThree', fields ['first_name', 'last_name', 'dob']
        db.create_unique('bcpp_subject_subjectconsentyearthree', ['first_name', 'last_name', 'dob'])

        # Adding model 'SubjectConsentYearFive'
        db.create_table('bcpp_subject_subjectconsentyearfive', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearFive'])

        # Adding unique constraint on 'SubjectConsentYearFive', fields ['first_name', 'last_name', 'dob']
        db.create_unique('bcpp_subject_subjectconsentyearfive', ['first_name', 'last_name', 'dob'])

        # Adding model 'SubjectConsentYearFourAudit'
        db.create_table('bcpp_subject_subjectconsentyearfour_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('assessment_score', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('consent_copy', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfour', to=orm['bhp_variables.StudySite'])),
            ('consent_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('guardian_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('may_store_samples', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_incarcerated', self.gf('django.db.models.fields.CharField')(default='No', max_length=3)),
            ...
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfour', to=orm['bhp_registration.RegisteredSubject'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfour', to=orm['bcpp_survey.Survey'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('screening_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfour', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearFourAudit'])

        # Adding model 'SubjectConsentYearOneAudit'
        db.create_table('bcpp_subject_subjectconsentyearone_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('assessment_score', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('consent_copy', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearone', to=orm['bhp_variables.StudySite'])),
            ('consent_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('guardian_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('may_store_samples', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_incarcerated', self.gf('django.db.models.fields.CharField')(default='No', max_length=3)),
            ...
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearone', to=orm['bhp_registration.RegisteredSubject'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearone', to=orm['bcpp_survey.Survey'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('screening_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearone', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearOneAudit'])
        ...
        db.create_table('bcpp_subject_subjectabsenteereport', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 25, 17, 4, 28, 401832))),
        ...
        # Adding model 'SubjectConsentYearTwo'
        db.create_table('bcpp_subject_subjectconsentyeartwo', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearTwo'])

        # Adding unique constraint on 'SubjectConsentYearTwo', fields ['first_name', 'last_name', 'dob']
        db.create_unique('bcpp_subject_subjectconsentyeartwo', ['first_name', 'last_name', 'dob'])
        ...
        # Adding model 'SubjectConsentYearThreeAudit'
        db.create_table('bcpp_subject_subjectconsentyearthree_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('assessment_score', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('consent_copy', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearthree', to=orm['bhp_variables.StudySite'])),
            ('consent_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('guardian_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('may_store_samples', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_incarcerated', self.gf('django.db.models.fields.CharField')(default='No', max_length=3)),
            ...
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearthree', to=orm['bhp_registration.RegisteredSubject'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearthree', to=orm['bcpp_survey.Survey'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('screening_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearthree', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearThreeAudit'])
        ...
        # Adding model 'SubjectConsentYearFour'
        db.create_table('bcpp_subject_subjectconsentyearfour', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearFour'])

        # Adding unique constraint on 'SubjectConsentYearFour', fields ['first_name', 'last_name', 'dob']
        db.create_unique('bcpp_subject_subjectconsentyearfour', ['first_name', 'last_name', 'dob'])

        # Adding model 'SubjectConsentYearFiveAudit'
        db.create_table('bcpp_subject_subjectconsentyearfive_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('assessment_score', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('consent_copy', self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3, null=True, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfive', to=orm['bhp_variables.StudySite'])),
            ('consent_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('guardian_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('may_store_samples', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_incarcerated', self.gf('django.db.models.fields.CharField')(default='No', max_length=3)),
            ...
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfive', to=orm['bhp_registration.RegisteredSubject'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfive', to=orm['bcpp_survey.Survey'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('screening_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('registration_status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentyearfive', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectConsentYearFiveAudit'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'SubjectConsentYearFour', fields ['first_name', 'last_name', 'dob']
        db.delete_unique('bcpp_subject_subjectconsentyearfour', ['first_name', 'last_name', 'dob'])

        # Removing unique constraint on 'SubjectConsentYearTwo', fields ['first_name', 'last_name', 'dob']
        db.delete_unique('bcpp_subject_subjectconsentyeartwo', ['first_name', 'last_name', 'dob'])
        ...
        # Removing unique constraint on 'SubjectConsentYearFive', fields ['first_name', 'last_name', 'dob']
        db.delete_unique('bcpp_subject_subjectconsentyearfive', ['first_name', 'last_name', 'dob'])

        # Removing unique constraint on 'SubjectConsentYearThree', fields ['first_name', 'last_name', 'dob']
        db.delete_unique('bcpp_subject_subjectconsentyearthree', ['first_name', 'last_name', 'dob'])

        # Removing unique constraint on 'SubjectConsentYearOne', fields ['first_name', 'last_name', 'dob']
        db.delete_unique('bcpp_subject_subjectconsentyearone', ['first_name', 'last_name', 'dob'])
        ...
        db.create_table('bcpp_subject_subjectconsent', (
            ...
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('identity', self.gf('django.db.models.fields.CharField')(max_length=78L, unique=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_variables.StudySite'])),
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        # Deleting model 'SubjectConsentYearTwoAudit'
        db.delete_table('bcpp_subject_subjectconsentyeartwo_audit')

        # Deleting model 'SubjectAbsentee'
        db.delete_table('bcpp_subject_subjectabsentee')

        # Deleting model 'SubjectConsentYearOne'
        db.delete_table('bcpp_subject_subjectconsentyearone')

        # Deleting model 'SubjectConsentYearThree'
        db.delete_table('bcpp_subject_subjectconsentyearthree')

        # Deleting model 'SubjectConsentYearFive'
        db.delete_table('bcpp_subject_subjectconsentyearfive')

        # Deleting model 'SubjectConsentYearFourAudit'
        db.delete_table('bcpp_subject_subjectconsentyearfour_audit')

        # Deleting model 'SubjectConsentYearOneAudit'
        db.delete_table('bcpp_subject_subjectconsentyearone_audit')
        ...
        # Deleting model 'SubjectConsentYearTwo'
        db.delete_table('bcpp_subject_subjectconsentyeartwo')
        ...
        # Deleting model 'SubjectConsentYearThreeAudit'
        db.delete_table('bcpp_subject_subjectconsentyearthree_audit')

        # Deleting model 'SubjectMoved'
        db.delete_table('bcpp_subject_subjectmoved')

        # Deleting model 'SubjectConsentYearFour'
        db.delete_table('bcpp_subject_subjectconsentyearfour')

        # Deleting model 'SubjectConsentYearFiveAudit'
        db.delete_table('bcpp_subject_subjectconsentyearfive_audit')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 17, 4, 28, 401832)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 17, 4, 28, 514643)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 25)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 17, 4, 28, 127722)'}),
