...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseholdAudit.status'
        db.alter_column('bcpp_household_household_audit', 'status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'HouseholdAudit.gps_degrees_e'
        db.alter_column('bcpp_household_household_audit', 'gps_degrees_e', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'HouseholdAudit.gps_degrees_s'
        db.alter_column('bcpp_household_household_audit', 'gps_degrees_s', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'HouseholdAudit.gps_minutes_s'
        db.alter_column('bcpp_household_household_audit', 'gps_minutes_s', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'HouseholdAudit.gps_minutes_e'
        db.alter_column('bcpp_household_household_audit', 'gps_minutes_e', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Household.status'
        db.alter_column('bcpp_household_household', 'status', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Household.gps_degrees_e'
        db.alter_column('bcpp_household_household', 'gps_degrees_e', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Household.gps_degrees_s'
        db.alter_column('bcpp_household_household', 'gps_degrees_s', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Household.gps_minutes_s'
        db.alter_column('bcpp_household_household', 'gps_minutes_s', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Household.gps_minutes_e'
        db.alter_column('bcpp_household_household', 'gps_minutes_e', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.status'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.status' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_degrees_e'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_degrees_e' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_degrees_s'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_degrees_s' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_minutes_s'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_minutes_s' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.gps_minutes_e'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.gps_minutes_e' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.status'
        raise RuntimeError("Cannot reverse this migration. 'Household.status' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_degrees_e'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_degrees_e' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_degrees_s'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_degrees_s' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_minutes_s'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_minutes_s' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Household.gps_minutes_e'
        raise RuntimeError("Cannot reverse this migration. 'Household.gps_minutes_e' and its values cannot be restored.")
