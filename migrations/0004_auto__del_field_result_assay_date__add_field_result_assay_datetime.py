...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.assay_datetime'
        db.add_column('bhp_lab_result', 'assay_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 3, 15)), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Result.assay_date'
        raise RuntimeError("Cannot reverse this migration. 'Result.assay_date' and its values cannot be restored.")

        # Deleting field 'Result.assay_datetime'
        db.delete_column('bhp_lab_result', 'assay_datetime')
