...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'RandomizedSubject', fields ['hostname_created']
        db.create_index('bhp_registration_randomizedsubject', ['hostname_created'])

        # Adding index on 'RandomizedSubject', fields ['hostname_modified']
        db.create_index('bhp_registration_randomizedsubject', ['hostname_modified'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'RandomizedSubject', fields ['hostname_modified']
        db.delete_index('bhp_registration_randomizedsubject', ['hostname_modified'])

        # Removing index on 'RandomizedSubject', fields ['hostname_created']
        db.delete_index('bhp_registration_randomizedsubject', ['hostname_created'])
    ...
    models = {
        ...
        'bhp_registration.registeredsubject': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'identity': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'initials': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 5, 31)'}),
