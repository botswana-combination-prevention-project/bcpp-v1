...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReproductiveHealth.morechildren'
        db.alter_column('bcpp_subject_reproductivehealth', 'morechildren', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ReproductiveHealth.pregARV'
        db.alter_column('bcpp_subject_reproductivehealth', 'pregARV', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ReproductiveHealth.wherecirc'
        db.alter_column('bcpp_subject_reproductivehealth', 'wherecirc', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'ReproductiveHealth.hivlastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth', 'hivlastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealth.currentpregnant'
        db.alter_column('bcpp_subject_reproductivehealth', 'currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ReproductiveHealth.lnmp'
        db.alter_column('bcpp_subject_reproductivehealth', 'lnmp', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealth.lastbirth'
        db.alter_column('bcpp_subject_reproductivehealth', 'lastbirth', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ReproductiveHealth.ancreg'
        db.alter_column('bcpp_subject_reproductivehealth', 'ancreg', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ReproductiveHealth.anclastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth', 'anclastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealthAudit.lnmp'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'lnmp', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealthAudit.currentpregnant'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ReproductiveHealthAudit.morechildren'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'morechildren', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ReproductiveHealthAudit.hivlastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'hivlastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealthAudit.lastbirth'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'lastbirth', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ReproductiveHealthAudit.pregARV'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'pregARV', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ReproductiveHealthAudit.wherecirc'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'wherecirc', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'ReproductiveHealthAudit.ancreg'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'ancreg', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ReproductiveHealthAudit.anclastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'anclastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'ReproductiveHealth.morechildren'
        db.alter_column('bcpp_subject_reproductivehealth', 'morechildren', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealth.pregARV'
        db.alter_column('bcpp_subject_reproductivehealth', 'pregARV', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealth.wherecirc'
        db.alter_column('bcpp_subject_reproductivehealth', 'wherecirc', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealth.hivlastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth', 'hivlastpregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealth.currentpregnant'
        db.alter_column('bcpp_subject_reproductivehealth', 'currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealth.lnmp'
        db.alter_column('bcpp_subject_reproductivehealth', 'lnmp', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealth.lastbirth'
        db.alter_column('bcpp_subject_reproductivehealth', 'lastbirth', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealth.ancreg'
        db.alter_column('bcpp_subject_reproductivehealth', 'ancreg', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealth.anclastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth', 'anclastpregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealthAudit.lnmp'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'lnmp', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealthAudit.currentpregnant'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealthAudit.morechildren'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'morechildren', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealthAudit.hivlastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'hivlastpregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealthAudit.lastbirth'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'lastbirth', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'ReproductiveHealthAudit.pregARV'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'pregARV', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealthAudit.wherecirc'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'wherecirc', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ReproductiveHealthAudit.ancreg'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'ancreg', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'ReproductiveHealthAudit.anclastpregnancy'
        db.alter_column('bcpp_subject_reproductivehealth_audit', 'anclastpregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 8, 24, 33, 420363)'}),
        ...
        'bcpp_subject.reproductivehealth': {
            ...
            'pregARV': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 8, 24, 33, 420363)'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 8, 24, 33, 630244)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 8, 24, 32, 55983)'}),
