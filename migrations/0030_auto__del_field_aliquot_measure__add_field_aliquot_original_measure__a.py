...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aliquot.original_measure'
        db.add_column('bhp_lab_core_aliquot', 'original_measure', self.gf('django.db.models.fields.DecimalField')(default='5.00', max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Aliquot.current_measure'
        db.add_column('bhp_lab_core_aliquot', 'current_measure', self.gf('django.db.models.fields.DecimalField')(default='5.00', max_digits=10, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Aliquot.measure'
        db.add_column('bhp_lab_core_aliquot', 'measure', self.gf('django.db.models.fields.DecimalField')(default='5.00', max_digits=10, decimal_places=2), keep_default=False)

        # Deleting field 'Aliquot.original_measure'
        db.delete_column('bhp_lab_core_aliquot', 'original_measure')

        # Deleting field 'Aliquot.current_measure'
        db.delete_column('bhp_lab_core_aliquot', 'current_measure')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 11, 35, 22, 342198)'}),
