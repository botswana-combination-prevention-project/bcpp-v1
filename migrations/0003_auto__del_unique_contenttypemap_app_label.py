...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ContentTypeMap', fields ['app_label']
        db.delete_unique('bhp_common_contenttypemap', ['app_label'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ContentTypeMap', fields ['app_label']
        db.create_unique('bhp_common_contenttypemap', ['app_label'])
