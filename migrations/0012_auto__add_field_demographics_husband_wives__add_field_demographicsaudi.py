...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Demographics.husband_wives'
        db.add_column('bcpp_subject_demographics', 'husband_wives',
                      self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DemographicsAudit.husband_wives'
        db.add_column('bcpp_subject_demographics_audit', 'husband_wives',
                      self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Demographics.husband_wives'
        db.delete_column('bcpp_subject_demographics', 'husband_wives')

        # Deleting field 'DemographicsAudit.husband_wives'
        db.delete_column('bcpp_subject_demographics_audit', 'husband_wives')
