...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Panel.panel_type'
        db.add_column('lab_clinic_api_panel', 'panel_type',
                      self.gf('django.db.models.fields.CharField')(default='TEST', max_length=15),
                      keep_default=False)

        # Adding index on 'AliquotCondition', fields ['name']
        db.create_index('lab_clinic_api_aliquotcondition', ['name'])


        # Changing field 'AliquotCondition.short_name'
        db.alter_column('lab_clinic_api_aliquotcondition', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True))
        # Adding index on 'AliquotCondition', fields ['short_name']
    ...
    models = {
        ...
        'lab_clinic_api.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 0, 0)'}),
        ...
        'lab_clinic_api.receive': {
            ...
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 20, 0, 0)', 'db_index': 'True'}),
