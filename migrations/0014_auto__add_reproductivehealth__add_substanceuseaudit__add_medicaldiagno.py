...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_reproductivehealth', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 22, 15, 30, 13, 424959))),
            ('numberchildren', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('morechildren', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('wherecirc', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('ancreg', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('lnmp', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True, blank=True)),
            ('lastbirth', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('anclastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hivlastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('pregARV', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        ...
        db.create_table('bcpp_subject_substanceuse_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 22, 15, 30, 13, 424959))),
            ('alcohol', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('smoke', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table('bcpp_subject_medicaldiagnoses_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 22, 15, 30, 13, 424959))),
            ('heartattack', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('heartattackrecord', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('dateheartattack', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True, blank=True)),
            ('dxheartattack', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('cancer', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('cancerrecord', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('datecancer', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True, blank=True)),
            ('dxcancer', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('sti', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('tb', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('tbrecord', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('datetb', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True, blank=True)),
            ('dxTB', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
    ...
    models = {
        ...
        'bcpp_subject.baselinehouseholdsurvey': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 15, 30, 13, 424959)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 22, 15, 30, 13, 202112)'}),
