...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DefaultValueLog.subject_type'
        db.add_column('bhp_lab_tracker_defaultvaluelog', 'subject_type',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DefaultValueLog.subject_type'
        db.delete_column('bhp_lab_tracker_defaultvaluelog', 'subject_type')
