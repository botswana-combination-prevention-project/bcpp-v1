...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Result.dmis_result_item_guid'
        db.delete_column('bhp_lab_core_result', 'dmis_result_item_guid')

        # Adding field 'Result.dmis_result_guid'
        db.add_column('bhp_lab_core_result', 'dmis_result_guid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Result.dmis_result_item_guid'
        db.add_column('bhp_lab_core_result', 'dmis_result_item_guid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True), keep_default=False)

        # Deleting field 'Result.dmis_result_guid'
        db.delete_column('bhp_lab_core_result', 'dmis_result_guid')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 6, 13, 44, 55, 258156)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 6, 13, 44, 55, 372028)'}),
