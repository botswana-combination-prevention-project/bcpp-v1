...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResultItem.result_item_source'
        db.add_column('bhp_lab_core_resultitem', 'result_item_source', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.result_item_source_reference'
        db.add_column('bhp_lab_core_resultitem', 'result_item_source_reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResultItem.result_item_source'
        db.delete_column('bhp_lab_core_resultitem', 'result_item_source')

        # Deleting field 'ResultItem.result_item_source_reference'
        db.delete_column('bhp_lab_core_resultitem', 'result_item_source_reference')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 20, 13, 49, 25, 305528)'}),
