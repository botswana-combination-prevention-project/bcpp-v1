...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'DispatchContainerRegister', fields ['container_model_name', 'container_app_label', 'container_pk']
        db.delete_unique(u'bhp_dispatch_dispatchcontainerregister', ['container_model_name', 'container_app_label', 'container_pk'])


        # Changing field 'DispatchContainerRegister.container_model_name'
        db.alter_column(u'bhp_dispatch_dispatchcontainerregister', 'container_model_name', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'DispatchContainerRegister.container_app_label'
        db.alter_column(u'bhp_dispatch_dispatchcontainerregister', 'container_app_label', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'DispatchContainerRegister.container_identifier_attrname'
        db.alter_column(u'bhp_dispatch_dispatchcontainerregister', 'container_identifier_attrname', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'DispatchContainerRegister.container_pk'
        db.alter_column(u'bhp_dispatch_dispatchcontainerregister', 'container_pk', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'DispatchContainerRegister.container_identifier'
        db.alter_column(u'bhp_dispatch_dispatchcontainerregister', 'container_identifier', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))
