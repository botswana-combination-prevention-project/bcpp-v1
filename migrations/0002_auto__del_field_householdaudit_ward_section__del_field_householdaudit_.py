...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdAudit.ward_section'
        db.delete_column('bcpp_household_household_audit', 'ward_section')

        # Deleting field 'HouseholdAudit.ward'
        db.delete_column('bcpp_household_household_audit', 'ward')

        # Adding field 'HouseholdAudit.community'
        db.add_column('bcpp_household_household_audit', 'community',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'HouseholdAudit.section'
        db.add_column('bcpp_household_household_audit', 'section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'HouseholdAudit.sub_section'
        db.add_column('bcpp_household_household_audit', 'sub_section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Deleting field 'Household.ward_section'
        db.delete_column('bcpp_household_household', 'ward_section')

        # Deleting field 'Household.ward'
        db.delete_column('bcpp_household_household', 'ward')

        # Adding field 'Household.community'
        db.add_column('bcpp_household_household', 'community',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Household.section'
        db.add_column('bcpp_household_household', 'section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Household.sub_section'
        db.add_column('bcpp_household_household', 'sub_section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HouseholdAudit.ward_section'
        db.add_column('bcpp_household_household_audit', 'ward_section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'HouseholdAudit.ward'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdAudit.ward' and its values cannot be restored.")
        # Deleting field 'HouseholdAudit.community'
        db.delete_column('bcpp_household_household_audit', 'community')
        ...
        # Adding field 'Household.ward_section'
        db.add_column('bcpp_household_household', 'ward_section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Household.ward'
        raise RuntimeError("Cannot reverse this migration. 'Household.ward' and its values cannot be restored.")
        # Deleting field 'Household.community'
        db.delete_column('bcpp_household_household', 'community')
