...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_order', 'order_number')

        # Adding field 'Order.order_identifier'
        db.add_column('bhp_lab_core_order', 'order_identifier', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Order.order_number'
        db.add_column('bhp_lab_core_order', 'order_number', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Deleting field 'Order.order_identifier'
        db.delete_column('bhp_lab_core_order', 'order_identifier')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 18, 21, 32, 54, 868647)'}),
