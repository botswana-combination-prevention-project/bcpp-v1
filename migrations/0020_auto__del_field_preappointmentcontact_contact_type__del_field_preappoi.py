...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PreAppointmentContact.contact_type'
        db.delete_column('bhp_appointment_preappointmentcontact', 'contact_type')

        # Deleting field 'PreAppointmentContact.contact'
        db.delete_column('bhp_appointment_preappointmentcontact', 'contact')


    def backwards(self, orm):
        # Adding field 'PreAppointmentContact.contact_type'
        db.add_column('bhp_appointment_preappointmentcontact', 'contact_type',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=20),
                      keep_default=False)

        # Adding field 'PreAppointmentContact.contact'
        db.add_column('bhp_appointment_preappointmentcontact', 'contact',
