...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestCodeReference.age_high'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TestCodeReference.age_low'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'TestCodeReference.age_high'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

        # Changing field 'TestCodeReference.age_low'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 21, 33, 564284)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 21, 33, 607869)'}),
