...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('bhp_lab_core_testcodegroup')

        # Deleting model 'TestCodeReference'
        db.delete_table('bhp_lab_core_testcodereference')

        # Deleting model 'TestCodeInterfaceMapping'
        db.delete_table('bhp_lab_core_testcodeinterfacemapping')

        # Deleting model 'TestCode'
        db.delete_table('bhp_lab_core_testcode')

        # Changing field 'ResultItemAudit.test_code'
        db.alter_column('bhp_lab_core_resultitem_audit', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_test_code.TestCode']))

        # Changing field 'ResultItem.test_code'
        db.alter_column('bhp_lab_core_resultitem', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_test_code.TestCode']))


    def backwards(self, orm):
        
        # Adding model 'TestCodeGroup'
        db.create_table('bhp_lab_core_testcodegroup', (
        ...
        db.send_create_signal('bhp_lab_core', ['TestCodeGroup'])
        ...
        db.create_table('bhp_lab_core_testcodereference', (
            ...
            ('test_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.TestCode'])),
        ...
        db.create_table('bhp_lab_core_testcodeinterfacemapping', (
            ('foreign_test_code', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True)),
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='home', max_length=50, blank=True)),
        ...
        db.send_create_signal('bhp_lab_core', ['TestCodeInterfaceMapping'])
        ...
        db.create_table('bhp_lab_core_testcode', (
            ...
            ('test_code_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.TestCodeGroup'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Changing field 'ResultItemAudit.test_code'
        db.alter_column('bhp_lab_core_resultitem_audit', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.TestCode']))
    ...
    models = {
        'bhp_lab_core.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 12, 42, 22, 143805)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 12, 42, 22, 183439)'}),
