...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'AliquotType', fields ['name']
        db.delete_unique('bhp_lab_core_aliquottype', ['name'])

        # Deleting field 'AliquotType.version'
        db.delete_column('bhp_lab_core_aliquottype', 'version')

        # Deleting field 'AliquotType.short_name'
        db.delete_column('bhp_lab_core_aliquottype', 'short_name')

        # Deleting field 'AliquotType.field_name'
        db.delete_column('bhp_lab_core_aliquottype', 'field_name')

        # Deleting field 'AliquotType.display_index'
        db.delete_column('bhp_lab_core_aliquottype', 'display_index')

        # Adding field 'AliquotType.alpha_code'
        db.add_column('bhp_lab_core_aliquottype', 'alpha_code', self.gf('django.db.models.fields.CharField')(default='XX', max_length=15), keep_default=False)

        # Adding field 'AliquotType.numeric_code'
        db.add_column('bhp_lab_core_aliquottype', 'numeric_code', self.gf('django.db.models.fields.CharField')(default=99, max_length=2), keep_default=False)

        # Changing field 'AliquotType.name'
        db.alter_column('bhp_lab_core_aliquottype', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))


    def backwards(self, orm):
        
        # Adding field 'AliquotType.version'
        db.add_column('bhp_lab_core_aliquottype', 'version', self.gf('django.db.models.fields.CharField')(default='1.0', max_length=35), keep_default=False)

        # Adding field 'AliquotType.short_name'
        db.add_column('bhp_lab_core_aliquottype', 'short_name', self.gf('django.db.models.fields.CharField')(default=0, max_length=250, unique=True), keep_default=False)

        # Adding field 'AliquotType.field_name'
        db.add_column('bhp_lab_core_aliquottype', 'field_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Adding field 'AliquotType.display_index'
        db.add_column('bhp_lab_core_aliquottype', 'display_index', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True), keep_default=False)

        # Deleting field 'AliquotType.alpha_code'
        db.delete_column('bhp_lab_core_aliquottype', 'alpha_code')

        # Deleting field 'AliquotType.numeric_code'
        db.delete_column('bhp_lab_core_aliquottype', 'numeric_code')

        # Changing field 'AliquotType.name'
        db.alter_column('bhp_lab_core_aliquottype', 'name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True))

        # Adding unique constraint on 'AliquotType', fields ['name']
        db.create_unique('bhp_lab_core_aliquottype', ['name'])
    ...
    models = {
        'bhp_lab_core.aliquot': {
            ...
            'measure': ('django.db.models.fields.DecimalField', [], {'default': '5.0', 'max_digits': '10', 'decimal_places': '2'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 18, 15, 7, 15, 205916)'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
