...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_test_code_testcodereferencelistitem_audit', (
            ...
            ('test_code', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testcodereferencelistitem', to=orm['bhp_lab_test_code.TestCode'])),
            ...
            ('test_code_reference_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_testcodereferencelistitem', to=orm['bhp_lab_test_code.TestCodeReferenceList'])),
        ...
        db.send_create_signal('bhp_lab_test_code', ['TestCodeReferenceListItemAudit'])
