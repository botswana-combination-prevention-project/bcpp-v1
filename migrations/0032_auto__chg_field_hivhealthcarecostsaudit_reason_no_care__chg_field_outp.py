...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivHealthCareCostsAudit.reason_no_care'
        db.alter_column('bcpp_subject_hivhealthcarecosts_audit', 'reason_no_care', self.gf('django.db.models.fields.CharField')(max_length=115, null=True))

        # Changing field 'OutpatientCareAudit.travel_time'
        db.alter_column('bcpp_subject_outpatientcare_audit', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'OutpatientCareAudit.waiting_hours'
        db.alter_column('bcpp_subject_outpatientcare_audit', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'HivHealthCareCosts.reason_no_care'
        db.alter_column('bcpp_subject_hivhealthcarecosts', 'reason_no_care', self.gf('django.db.models.fields.CharField')(max_length=115, null=True))

        # Changing field 'OutpatientCare.travel_time'
        db.alter_column('bcpp_subject_outpatientcare', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'OutpatientCare.waiting_hours'
        db.alter_column('bcpp_subject_outpatientcare', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=25))


    def backwards(self, orm):
        
        # Changing field 'HivHealthCareCostsAudit.reason_no_care'
        db.alter_column('bcpp_subject_hivhealthcarecosts_audit', 'reason_no_care', self.gf('django.db.models.fields.CharField')(default=0, max_length=115))

        # Changing field 'OutpatientCareAudit.travel_time'
        db.alter_column('bcpp_subject_outpatientcare_audit', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'OutpatientCareAudit.waiting_hours'
        db.alter_column('bcpp_subject_outpatientcare_audit', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'HivHealthCareCosts.reason_no_care'
        db.alter_column('bcpp_subject_hivhealthcarecosts', 'reason_no_care', self.gf('django.db.models.fields.CharField')(default=0, max_length=115))

        # Changing field 'OutpatientCare.travel_time'
        db.alter_column('bcpp_subject_outpatientcare', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'OutpatientCare.waiting_hours'
        db.alter_column('bcpp_subject_outpatientcare', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 54, 15, 230432)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 54, 15, 346941)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 54, 14, 936239)'}),
