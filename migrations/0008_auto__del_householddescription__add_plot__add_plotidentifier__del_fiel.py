...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'HouseholdDescription'
        db.delete_table(u'bcpp_household_householddescription')

        # Adding model 'Plot'
        db.create_table(u'bcpp_household_plot', (
        ...
        db.create_table(u'bcpp_household_plotidentifier', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        # Deleting field 'HouseholdStructure.household'
        db.delete_column(u'bcpp_household_householdstructure', 'household_id')

        # Adding field 'HouseholdStructure.plot'
        db.add_column(u'bcpp_household_householdstructure', 'plot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bcpp_household.Plot']),
                      keep_default=False)

        # Adding unique constraint on 'HouseholdStructure', fields ['plot', 'survey']
        db.create_unique(u'bcpp_household_householdstructure', ['plot_id', 'survey_id'])

        # Deleting field 'HouseholdStructureAudit.household'
        db.delete_column(u'bcpp_household_householdstructure_audit', 'household_id')

        # Adding field 'HouseholdStructureAudit.plot'
        db.add_column(u'bcpp_household_householdstructure_audit', 'plot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_householdstructure', to=orm['bcpp_household.Plot']),
                      keep_default=False)

        # Deleting field 'HouseholdAudit.device_id'
        db.delete_column(u'bcpp_household_household_audit', 'device_id')

        # Deleting field 'HouseholdAudit.section'
        db.delete_column(u'bcpp_household_household_audit', 'section')

        # Deleting field 'HouseholdAudit.cso_number'
        db.delete_column(u'bcpp_household_household_audit', 'cso_number')

        # Deleting field 'HouseholdAudit.sub_section'
        db.delete_column(u'bcpp_household_household_audit', 'sub_section')

        # Deleting field 'Household.section'
        db.delete_column(u'bcpp_household_household', 'section')

        # Deleting field 'Household.device_id'
        db.delete_column(u'bcpp_household_household', 'device_id')

        # Deleting field 'Household.sub_section'
        db.delete_column(u'bcpp_household_household', 'sub_section')

        # Deleting field 'Household.cso_number'
        db.delete_column(u'bcpp_household_household', 'cso_number')


    def backwards(self, orm):
        # Removing unique constraint on 'HouseholdStructure', fields ['plot', 'survey']
        db.delete_unique(u'bcpp_household_householdstructure', ['plot_id', 'survey_id'])

        # Adding model 'HouseholdDescription'
        db.create_table(u'bcpp_household_householddescription', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('eligible_members', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('availability_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ...
        db.send_create_signal('bcpp_household', ['HouseholdDescription'])

        # Deleting model 'Plot'
        db.delete_table(u'bcpp_household_plot')

        # Deleting model 'PlotIdentifier'
        db.delete_table(u'bcpp_household_plotidentifier')

        # Adding field 'HouseholdStructure.household'
        db.add_column(u'bcpp_household_householdstructure', 'household',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bcpp_household.Household']),
                      keep_default=False)

        # Deleting field 'HouseholdStructure.plot'
        db.delete_column(u'bcpp_household_householdstructure', 'plot_id')
        ...
        # Adding field 'HouseholdStructureAudit.household'
        db.add_column(u'bcpp_household_householdstructure_audit', 'household',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_householdstructure', to=orm['bcpp_household.Household']),
                      keep_default=False)

        # Deleting field 'HouseholdStructureAudit.plot'
        db.delete_column(u'bcpp_household_householdstructure_audit', 'plot_id')

        # Adding field 'HouseholdAudit.device_id'
        db.add_column(u'bcpp_household_household_audit', 'device_id',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.section'
        db.add_column(u'bcpp_household_household_audit', 'section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.cso_number'
        db.add_column(u'bcpp_household_household_audit', 'cso_number',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=78L, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.sub_section'
        db.add_column(u'bcpp_household_household_audit', 'sub_section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'Household.section'
        db.add_column(u'bcpp_household_household', 'section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'Household.device_id'
        db.add_column(u'bcpp_household_household', 'device_id',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True),
                      keep_default=False)

        # Adding field 'Household.sub_section'
        db.add_column(u'bcpp_household_household', 'sub_section',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'Household.cso_number'
        db.add_column(u'bcpp_household_household', 'cso_number',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=78L, null=True, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_household.householdstructure': {
            ...
            'plot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_household.Plot']"}),
        ...
        'bcpp_household.householdstructureaudit': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'note': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'plot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_householdstructure'", 'to': "orm['bcpp_household.Plot']"}),
            'progress': ('django.db.models.fields.CharField', [], {'default': "'Not Started'", 'max_length': '25', 'null': 'True'}),
