...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuditComment.audit_code'
        db.add_column('audit_trail_auditcomment', 'audit_code', self.gf('django.db.models.fields.CharField')(default='00', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuditComment.audit_code'
        db.delete_column('audit_trail_auditcomment', 'audit_code')
