...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demographics.numwives'
        db.alter_column('bcpp_subject_demographics', 'numwives', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'DemographicsAudit.numwives'
        db.alter_column('bcpp_subject_demographics_audit', 'numwives', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))


    def backwards(self, orm):
        
        # Changing field 'Demographics.numwives'
        db.alter_column('bcpp_subject_demographics', 'numwives', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'DemographicsAudit.numwives'
        db.alter_column('bcpp_subject_demographics_audit', 'numwives', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 10, 51, 40, 879357)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 10, 51, 40, 993040)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 10, 51, 40, 588101)'}),
