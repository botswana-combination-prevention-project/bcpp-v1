...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TestCode.group'
        db.delete_column('bhp_lab_core_testcode', 'group_id')

        # Adding field 'TestCode.test_code_group'
        db.add_column('bhp_lab_core_testcode', 'test_code_group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.TestCodeGroup']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TestCode.group'
        db.add_column('bhp_lab_core_testcode', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.TestGroup']), keep_default=False)

        # Deleting field 'TestCode.test_code_group'
        db.delete_column('bhp_lab_core_testcode', 'test_code_group_id')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 21, 25, 26, 281037)'}),
