...
#        db.create_unique('bhp_appointment_appointment', ['visit_definition_id', 'visit_instance', 'registered_subject_id'])
        ...
        db.add_column('bhp_appointment_configuration', 'default_contact',
                      self.gf('django.db.models.fields.CharField')(default='clinic', max_length=10),
                      keep_default=False)

        # Adding index on 'Configuration', fields ['user_modified']
        db.create_index('bhp_appointment_configuration', ['user_modified'])

        # Adding index on 'Configuration', fields ['user_created']
        db.create_index('bhp_appointment_configuration', ['user_created'])


    def backwards(self, orm):
        # Removing index on 'Configuration', fields ['user_created']
        db.delete_index('bhp_appointment_configuration', ['user_created'])

        # Removing index on 'Configuration', fields ['user_modified']
        db.delete_index('bhp_appointment_configuration', ['user_modified'])

        # Removing unique constraint on 'Appointment', fields ['visit_definition', 'visit_instance', 'registered_subject']
        db.delete_unique('bhp_appointment_appointment', ['visit_definition_id', 'visit_instance', 'registered_subject_id'])

        # Removing index on 'Appointment', fields ['user_created']
        db.delete_index('bhp_appointment_appointment', ['user_created'])

        # Removing index on 'Appointment', fields ['user_modified']
        db.delete_index('bhp_appointment_appointment', ['user_modified'])

        # Removing index on 'Holiday', fields ['user_created']
        db.delete_index('bhp_appointment_holiday', ['user_created'])

        # Removing index on 'Holiday', fields ['user_modified']
        db.delete_index('bhp_appointment_holiday', ['user_modified'])

        # Removing index on 'AppointmentAudit', fields ['user_modified']
        db.delete_index('bhp_appointment_appointment_audit', ['user_modified'])

        # Removing index on 'AppointmentAudit', fields ['user_created']
        db.delete_index('bhp_appointment_appointment_audit', ['user_created'])
    ...
    models = {
        ...
        'bhp_appointment.configuration': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'default_contact': ('django.db.models.fields.CharField', [], {'default': "'clinic'", 'max_length': '10'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
