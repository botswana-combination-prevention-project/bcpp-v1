...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dispatch.returned_datetime'
        db.delete_column('bhp_dispatch_dispatch', 'returned_datetime')

        # Adding field 'Dispatch.return_datetime'
        db.add_column('bhp_dispatch_dispatch', 'return_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DispatchItem.returned_datetime'
        db.delete_column('bhp_dispatch_dispatchitem', 'returned_datetime')

        # Adding field 'DispatchItem.return_datetime'
        db.add_column('bhp_dispatch_dispatchitem', 'return_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Dispatch.returned_datetime'
        db.add_column('bhp_dispatch_dispatch', 'returned_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Dispatch.return_datetime'
        db.delete_column('bhp_dispatch_dispatch', 'return_datetime')

        # Adding field 'DispatchItem.returned_datetime'
        db.add_column('bhp_dispatch_dispatchitem', 'returned_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DispatchItem.return_datetime'
        db.delete_column('bhp_dispatch_dispatchitem', 'return_datetime')
