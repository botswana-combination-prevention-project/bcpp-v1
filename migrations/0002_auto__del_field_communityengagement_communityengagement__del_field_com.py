...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CommunityEngagement.communityengagement'
        db.delete_column('bcpp_subject_communityengagement', 'communityengagement')

        # Deleting field 'CommunityEngagement.solveengagement'
        db.delete_column('bcpp_subject_communityengagement', 'solveengagement')

        # Deleting field 'CommunityEngagement.voteengagement'
        db.delete_column('bcpp_subject_communityengagement', 'voteengagement')

        # Adding field 'CommunityEngagement.community_engagement'
        db.add_column('bcpp_subject_communityengagement', 'community_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagement.vote_engagement'
        db.add_column('bcpp_subject_communityengagement', 'vote_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagement.problems_engagement_other'
        db.add_column('bcpp_subject_communityengagement', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'CommunityEngagement.solve_engagement'
        db.add_column('bcpp_subject_communityengagement', 'solve_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)
        ...
        # Deleting field 'CommunityEngagementAudit.communityengagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'communityengagement')

        # Deleting field 'CommunityEngagementAudit.solveengagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'solveengagement')

        # Deleting field 'CommunityEngagementAudit.voteengagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'voteengagement')

        # Adding field 'CommunityEngagementAudit.community_engagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'community_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagementAudit.vote_engagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'vote_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagementAudit.problems_engagement_other'
        db.add_column('bcpp_subject_communityengagement_audit', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'CommunityEngagementAudit.solve_engagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'solve_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CommunityEngagement.communityengagement'
        db.add_column('bcpp_subject_communityengagement', 'communityengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagement.solveengagement'
        db.add_column('bcpp_subject_communityengagement', 'solveengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagement.voteengagement'
        db.add_column('bcpp_subject_communityengagement', 'voteengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Deleting field 'CommunityEngagement.community_engagement'
        db.delete_column('bcpp_subject_communityengagement', 'community_engagement')

        # Deleting field 'CommunityEngagement.vote_engagement'
        db.delete_column('bcpp_subject_communityengagement', 'vote_engagement')

        # Deleting field 'CommunityEngagement.problems_engagement_other'
        db.delete_column('bcpp_subject_communityengagement', 'problems_engagement_other')

        # Deleting field 'CommunityEngagement.solve_engagement'
        db.delete_column('bcpp_subject_communityengagement', 'solve_engagement')
        ...
        # Adding field 'CommunityEngagementAudit.communityengagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'communityengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagementAudit.solveengagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'solveengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'CommunityEngagementAudit.voteengagement'
        db.add_column('bcpp_subject_communityengagement_audit', 'voteengagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Deleting field 'CommunityEngagementAudit.community_engagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'community_engagement')

        # Deleting field 'CommunityEngagementAudit.vote_engagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'vote_engagement')

        # Deleting field 'CommunityEngagementAudit.problems_engagement_other'
        db.delete_column('bcpp_subject_communityengagement_audit', 'problems_engagement_other')

        # Deleting field 'CommunityEngagementAudit.solve_engagement'
        db.delete_column('bcpp_subject_communityengagement_audit', 'solve_engagement')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 10, 8, 26, 477618)'}),
        ...
        'bcpp_subject.residencymobility': {
            ...
            'cattlepostlands': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '25', 'null': 'True', 'blank': 'True'}),
            ...
            'reasonaway': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 10, 8, 26, 601602)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 10, 8, 26, 203115)'}),
