...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aliquot.comment'
        db.add_column('bhp_lab_core_aliquot', 'comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Aliquot.comment'
        db.delete_column('bhp_lab_core_aliquot', 'comment')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 8, 50, 24, 318992)'}),
