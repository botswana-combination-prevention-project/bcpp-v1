...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PanelGroup', fields ['name']
        db.create_unique('bhp_lab_core_panelgroup', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PanelGroup', fields ['name']
        db.delete_unique('bhp_lab_core_panelgroup', ['name'])
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 10, 18, 45, 160877)'}),
