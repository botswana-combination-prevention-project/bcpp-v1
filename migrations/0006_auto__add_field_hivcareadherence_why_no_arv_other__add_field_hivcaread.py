...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HivCareAdherence.why_no_arv_other'
        db.add_column('bcpp_subject_hivcareadherence', 'why_no_arv_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivCareAdherence.arv_stop_date'
        db.add_column('bcpp_subject_hivcareadherence', 'arv_stop_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'HivCareAdherence.arv_stop_other'
        db.add_column('bcpp_subject_hivcareadherence', 'arv_stop_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'HivCareAdherence.why_no_arv'
        db.alter_column('bcpp_subject_hivcareadherence', 'why_no_arv', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Adding field 'HivCareAdherenceAudit.why_no_arv_other'
        db.add_column('bcpp_subject_hivcareadherence_audit', 'why_no_arv_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivCareAdherenceAudit.arv_stop_date'
        db.add_column('bcpp_subject_hivcareadherence_audit', 'arv_stop_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'HivCareAdherenceAudit.arv_stop_other'
        db.add_column('bcpp_subject_hivcareadherence_audit', 'arv_stop_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'HivCareAdherenceAudit.why_no_arv'
        db.alter_column('bcpp_subject_hivcareadherence_audit', 'why_no_arv', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))


    def backwards(self, orm):
        
        # Deleting field 'HivCareAdherence.why_no_arv_other'
        db.delete_column('bcpp_subject_hivcareadherence', 'why_no_arv_other')

        # Deleting field 'HivCareAdherence.arv_stop_date'
        db.delete_column('bcpp_subject_hivcareadherence', 'arv_stop_date')

        # Deleting field 'HivCareAdherence.arv_stop_other'
        db.delete_column('bcpp_subject_hivcareadherence', 'arv_stop_other')

        # Changing field 'HivCareAdherence.why_no_arv'
        db.alter_column('bcpp_subject_hivcareadherence', 'why_no_arv', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Deleting field 'HivCareAdherenceAudit.why_no_arv_other'
        db.delete_column('bcpp_subject_hivcareadherence_audit', 'why_no_arv_other')

        # Deleting field 'HivCareAdherenceAudit.arv_stop_date'
        db.delete_column('bcpp_subject_hivcareadherence_audit', 'arv_stop_date')

        # Deleting field 'HivCareAdherenceAudit.arv_stop_other'
        db.delete_column('bcpp_subject_hivcareadherence_audit', 'arv_stop_other')

        # Changing field 'HivCareAdherenceAudit.why_no_arv'
        db.alter_column('bcpp_subject_hivcareadherence_audit', 'why_no_arv', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 10, 34, 34, 622954)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 10, 34, 34, 744662)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 10, 34, 34, 349741)'}),
