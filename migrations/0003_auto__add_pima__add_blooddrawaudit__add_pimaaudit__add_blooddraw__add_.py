...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivUntestedAudit.hiv_pills'
        db.alter_column('bcpp_subject_hivuntested_audit', 'hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Adding field 'MonthsRecentPartnerAudit.partner_hiv_test'
        db.add_column('bcpp_subject_monthsrecentpartner_audit', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)


        # Changing field 'FutureHivTesting.hiv_test_week'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_week', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTesting.prefer_hivtest'
        db.alter_column('bcpp_subject_futurehivtesting', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'FutureHivTesting.hiv_test_time_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_time_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTesting.hiv_test_time'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_time', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTesting.hiv_test_week_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_week_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTesting.hiv_test_year_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_year_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTesting.hiv_test_year'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_year', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Adding field 'MonthsSecondPartnerAudit.partner_hiv_test'
        db.add_column('bcpp_subject_monthssecondpartner_audit', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)


        # Changing field 'HivUntested.hiv_pills'
        db.alter_column('bcpp_subject_hivuntested', 'hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Adding field 'MonthsThirdPartnerAudit.partner_hiv_test'
        db.add_column('bcpp_subject_monthsthirdpartner_audit', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)

        # Adding field 'MonthsThirdPartner.partner_hiv_test'
        db.add_column('bcpp_subject_monthsthirdpartner', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)


        # Changing field 'FutureHivTestingAudit.hiv_test_week'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_week', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTestingAudit.prefer_hivtest'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'FutureHivTestingAudit.hiv_test_time_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_time_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTestingAudit.hiv_test_time'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_time', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTestingAudit.hiv_test_week_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_week_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTestingAudit.hiv_test_year_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_year_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'FutureHivTestingAudit.hiv_test_year'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_year', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Adding field 'MonthsRecentPartner.partner_hiv_test'
        db.add_column('bcpp_subject_monthsrecentpartner', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)

        # Adding field 'MonthsSecondPartner.partner_hiv_test'
        db.add_column('bcpp_subject_monthssecondpartner', 'partner_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)


        # Changing field 'HivTestedAudit.hiv_pills'
        db.alter_column('bcpp_subject_hivtested_audit', 'hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivTestedAudit.where_hiv_test'
        db.alter_column('bcpp_subject_hivtested_audit', 'where_hiv_test', self.gf('django.db.models.fields.CharField')(default=0, max_length=85))

        # Changing field 'HivTested.hiv_pills'
        db.alter_column('bcpp_subject_hivtested', 'hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivTested.where_hiv_test'
        db.alter_column('bcpp_subject_hivtested', 'where_hiv_test', self.gf('django.db.models.fields.CharField')(default=0, max_length=85))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HivUntestedAudit.hiv_pills'
        db.alter_column('bcpp_subject_hivuntested_audit', 'hiv_pills', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        # Deleting field 'MonthsRecentPartnerAudit.partner_hiv_test'
        db.delete_column('bcpp_subject_monthsrecentpartner_audit', 'partner_hiv_test')


        # Changing field 'FutureHivTesting.hiv_test_week'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_week', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'FutureHivTesting.prefer_hivtest'
        db.alter_column('bcpp_subject_futurehivtesting', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=70))

        # Changing field 'FutureHivTesting.hiv_test_time_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_time_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTesting.hiv_test_time'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_time', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'FutureHivTesting.hiv_test_week_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTesting.hiv_test_year_other'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTesting.hiv_test_year'
        db.alter_column('bcpp_subject_futurehivtesting', 'hiv_test_year', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        # Deleting field 'MonthsSecondPartnerAudit.partner_hiv_test'
        db.delete_column('bcpp_subject_monthssecondpartner_audit', 'partner_hiv_test')


        # Changing field 'HivUntested.hiv_pills'
        db.alter_column('bcpp_subject_hivuntested', 'hiv_pills', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        # Deleting field 'MonthsThirdPartnerAudit.partner_hiv_test'
        db.delete_column('bcpp_subject_monthsthirdpartner_audit', 'partner_hiv_test')

        # Deleting field 'MonthsThirdPartner.partner_hiv_test'
        db.delete_column('bcpp_subject_monthsthirdpartner', 'partner_hiv_test')


        # Changing field 'FutureHivTestingAudit.hiv_test_week'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_week', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'FutureHivTestingAudit.prefer_hivtest'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=70))

        # Changing field 'FutureHivTestingAudit.hiv_test_time_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_time_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTestingAudit.hiv_test_time'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_time', self.gf('django.db.models.fields.CharField')(default=0, max_length=35))

        # Changing field 'FutureHivTestingAudit.hiv_test_week_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTestingAudit.hiv_test_year_other'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'FutureHivTestingAudit.hiv_test_year'
        db.alter_column('bcpp_subject_futurehivtesting_audit', 'hiv_test_year', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        # Deleting field 'MonthsRecentPartner.partner_hiv_test'
        db.delete_column('bcpp_subject_monthsrecentpartner', 'partner_hiv_test')

        # Deleting field 'MonthsSecondPartner.partner_hiv_test'
        db.delete_column('bcpp_subject_monthssecondpartner', 'partner_hiv_test')


        # Changing field 'HivTestedAudit.hiv_pills'
        db.alter_column('bcpp_subject_hivtested_audit', 'hiv_pills', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'HivTestedAudit.where_hiv_test'
        db.alter_column('bcpp_subject_hivtested_audit', 'where_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=85, null=True))

        # Changing field 'HivTested.hiv_pills'
        db.alter_column('bcpp_subject_hivtested', 'hiv_pills', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'HivTested.where_hiv_test'
        db.alter_column('bcpp_subject_hivtested', 'where_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=85, null=True))
