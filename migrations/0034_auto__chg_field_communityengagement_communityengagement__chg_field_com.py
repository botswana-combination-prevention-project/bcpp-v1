...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommunityEngagement.communityengagement'
        db.alter_column('bcpp_subject_communityengagement', 'communityengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'CommunityEngagement.solveengagement'
        db.alter_column('bcpp_subject_communityengagement', 'solveengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'CommunityEngagement.voteengagement'
        db.alter_column('bcpp_subject_communityengagement', 'voteengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Adding field 'Demographics.religion_other'
        db.add_column('bcpp_subject_demographics', 'religion_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'Demographics.other'
        db.add_column('bcpp_subject_demographics', 'other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'Demographics.maritalstatus'
        db.alter_column('bcpp_subject_demographics', 'maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=55))

        # Changing field 'Demographics.religion'
        db.alter_column('bcpp_subject_demographics', 'religion', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'Demographics.ethnic'
        db.alter_column('bcpp_subject_demographics', 'ethnic', self.gf('django.db.models.fields.CharField')(max_length=35))
        ...
        # Changing field 'ResidencyMobilityAudit.reasonaway'
        db.alter_column('bcpp_subject_residencymobility_audit', 'reasonaway', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ResidencyMobilityAudit.intendresidency'
        db.alter_column('bcpp_subject_residencymobility_audit', 'intendresidency', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobilityAudit.forteennights'
        db.alter_column('bcpp_subject_residencymobility_audit', 'forteennights', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobilityAudit.lengthresidence'
        db.alter_column('bcpp_subject_residencymobility_audit', 'lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobilityAudit.cattlepostlands'
        db.alter_column('bcpp_subject_residencymobility_audit', 'cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ResidencyMobilityAudit.nightsaway'
        db.alter_column('bcpp_subject_residencymobility_audit', 'nightsaway', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'CommunityEngagementAudit.communityengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'communityengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'CommunityEngagementAudit.solveengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'solveengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'CommunityEngagementAudit.voteengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'voteengagement', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Adding field 'DemographicsAudit.religion_other'
        db.add_column('bcpp_subject_demographics_audit', 'religion_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'DemographicsAudit.other'
        db.add_column('bcpp_subject_demographics_audit', 'other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'DemographicsAudit.maritalstatus'
        db.alter_column('bcpp_subject_demographics_audit', 'maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=55))

        # Changing field 'DemographicsAudit.ethnic'
        db.alter_column('bcpp_subject_demographics_audit', 'ethnic', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'DemographicsAudit.religion'
        db.alter_column('bcpp_subject_demographics_audit', 'religion', self.gf('django.db.models.fields.CharField')(max_length=35))
        ...
        # Changing field 'ResidencyMobility.reasonaway'
        db.alter_column('bcpp_subject_residencymobility', 'reasonaway', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ResidencyMobility.intendresidency'
        db.alter_column('bcpp_subject_residencymobility', 'intendresidency', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobility.forteennights'
        db.alter_column('bcpp_subject_residencymobility', 'forteennights', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobility.lengthresidence'
        db.alter_column('bcpp_subject_residencymobility', 'lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'ResidencyMobility.cattlepostlands'
        db.alter_column('bcpp_subject_residencymobility', 'cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ResidencyMobility.nightsaway'
        db.alter_column('bcpp_subject_residencymobility', 'nightsaway', self.gf('django.db.models.fields.CharField')(max_length=35))


    def backwards(self, orm):
        
        # Changing field 'CommunityEngagement.communityengagement'
        db.alter_column('bcpp_subject_communityengagement', 'communityengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CommunityEngagement.solveengagement'
        db.alter_column('bcpp_subject_communityengagement', 'solveengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CommunityEngagement.voteengagement'
        db.alter_column('bcpp_subject_communityengagement', 'voteengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Deleting field 'Demographics.religion_other'
        db.delete_column('bcpp_subject_demographics', 'religion_other')

        # Deleting field 'Demographics.other'
        db.delete_column('bcpp_subject_demographics', 'other')

        # Changing field 'Demographics.maritalstatus'
        db.alter_column('bcpp_subject_demographics', 'maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Demographics.religion'
        db.alter_column('bcpp_subject_demographics', 'religion', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Demographics.ethnic'
        db.alter_column('bcpp_subject_demographics', 'ethnic', self.gf('django.db.models.fields.CharField')(max_length=15))
        ...
        # Changing field 'ResidencyMobilityAudit.reasonaway'
        db.alter_column('bcpp_subject_residencymobility_audit', 'reasonaway', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ResidencyMobilityAudit.intendresidency'
        db.alter_column('bcpp_subject_residencymobility_audit', 'intendresidency', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobilityAudit.forteennights'
        db.alter_column('bcpp_subject_residencymobility_audit', 'forteennights', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobilityAudit.lengthresidence'
        db.alter_column('bcpp_subject_residencymobility_audit', 'lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobilityAudit.cattlepostlands'
        db.alter_column('bcpp_subject_residencymobility_audit', 'cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ResidencyMobilityAudit.nightsaway'
        db.alter_column('bcpp_subject_residencymobility_audit', 'nightsaway', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CommunityEngagementAudit.communityengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'communityengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CommunityEngagementAudit.solveengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'solveengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'CommunityEngagementAudit.voteengagement'
        db.alter_column('bcpp_subject_communityengagement_audit', 'voteengagement', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Deleting field 'DemographicsAudit.religion_other'
        db.delete_column('bcpp_subject_demographics_audit', 'religion_other')

        # Deleting field 'DemographicsAudit.other'
        db.delete_column('bcpp_subject_demographics_audit', 'other')

        # Changing field 'DemographicsAudit.maritalstatus'
        db.alter_column('bcpp_subject_demographics_audit', 'maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'DemographicsAudit.ethnic'
        db.alter_column('bcpp_subject_demographics_audit', 'ethnic', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'DemographicsAudit.religion'
        db.alter_column('bcpp_subject_demographics_audit', 'religion', self.gf('django.db.models.fields.CharField')(max_length=15))
        ...
        # Changing field 'ResidencyMobility.reasonaway'
        db.alter_column('bcpp_subject_residencymobility', 'reasonaway', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ResidencyMobility.intendresidency'
        db.alter_column('bcpp_subject_residencymobility', 'intendresidency', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobility.forteennights'
        db.alter_column('bcpp_subject_residencymobility', 'forteennights', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobility.lengthresidence'
        db.alter_column('bcpp_subject_residencymobility', 'lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'ResidencyMobility.cattlepostlands'
        db.alter_column('bcpp_subject_residencymobility', 'cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'ResidencyMobility.nightsaway'
        db.alter_column('bcpp_subject_residencymobility', 'nightsaway', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 15, 19, 52, 46565)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 15, 19, 52, 161087)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 6, 20)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 15, 19, 51, 755654)'}),
