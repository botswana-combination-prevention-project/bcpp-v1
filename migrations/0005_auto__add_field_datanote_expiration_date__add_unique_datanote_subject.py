...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataNote.expiration_date'
        db.add_column('bhp_data_manager_datanote', 'expiration_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 4, 0, 0)),
                      keep_default=False)

        # Adding unique constraint on 'DataNote', fields ['subject']
        db.create_unique('bhp_data_manager_datanote', ['subject'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataNote', fields ['subject']
        db.delete_unique('bhp_data_manager_datanote', ['subject'])

        # Deleting field 'DataNote.expiration_date'
        db.delete_column('bhp_data_manager_datanote', 'expiration_date')
    ...
    models = {
        'bhp_data_manager.comment': {
            ...
            'comment_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 6, 0, 0)'}),
        ...
        'bhp_data_manager.datanote': {
            ...
            'expiration_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
