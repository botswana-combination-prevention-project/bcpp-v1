...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'HistoryModel', fields ['source', 'source_identifier', 'test_code']
        db.create_unique('bhp_lab_tracker_historymodel', ['source', 'source_identifier', 'test_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'HistoryModel', fields ['source', 'source_identifier', 'test_code']
        db.delete_unique('bhp_lab_tracker_historymodel', ['source', 'source_identifier', 'test_code'])
    ...
    models = {
        ...
        'bhp_lab_tracker.historymodel': {
            'Meta': {'unique_together': "(('source', 'source_identifier', 'test_code'),)", 'object_name': 'HistoryModel'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
