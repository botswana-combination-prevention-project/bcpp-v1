...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receive.clinician_initials'
        db.add_column('bhp_lab_core_receive', 'clinician_initials', self.gf('django.db.models.fields.CharField')(default='XXX', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receive.clinician_initials'
        db.delete_column('bhp_lab_core_receive', 'clinician_initials')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 14, 21, 8, 922693)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 14, 21, 8, 956135)'}),
