...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Aliquot.aliquot_datetime'
        db.add_column('bhp_lab_core_aliquot', 'aliquot_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 2, 10, 3, 45, 11115)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Aliquot.aliquot_datetime'
        db.delete_column('bhp_lab_core_aliquot', 'aliquot_datetime')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 10, 3, 45, 11115)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 10, 3, 45, 45331)'}),
