...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bcpp_household_householdlogentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=25),
                      keep_default=False)

        # Adding field 'HouseholdStructure.progress'
        db.add_column('bcpp_household_householdstructure', 'progress',
                      self.gf('django.db.models.fields.CharField')(default='Not Started', max_length=25, null=True),
                      keep_default=False)

        # Adding field 'HouseholdLogEntryAudit.status'
        db.add_column('bcpp_household_householdlogentry_audit', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=25),
                      keep_default=False)

        # Adding field 'HouseholdStructureAudit.progress'
        db.add_column('bcpp_household_householdstructure_audit', 'progress',
                      self.gf('django.db.models.fields.CharField')(default='Not Started', max_length=25, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bcpp_household_householdlogentry', 'status')

        # Deleting field 'HouseholdStructure.progress'
        db.delete_column('bcpp_household_householdstructure', 'progress')

        # Deleting field 'HouseholdLogEntryAudit.status'
        db.delete_column('bcpp_household_householdlogentry_audit', 'status')

        # Deleting field 'HouseholdStructureAudit.progress'
        db.delete_column('bcpp_household_householdstructure_audit', 'progress')
