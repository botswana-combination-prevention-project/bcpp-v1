...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DispatchItem.dispatch_using'
        db.add_column('bhp_dispatch_dispatchitem', 'dispatch_using',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DispatchItem.dispatch_using'
        db.delete_column('bhp_dispatch_dispatchitem', 'dispatch_using')
