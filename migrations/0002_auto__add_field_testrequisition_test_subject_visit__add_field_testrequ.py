...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestRequisition.test_subject_visit'
        db.add_column(u'lab_requisition_testrequisition', 'test_subject_visit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['bhp_visit_tracking.TestSubjectVisit']),
                      keep_default=False)

        # Adding field 'TestRequisitionAudit.test_subject_visit'
        db.add_column(u'lab_requisition_testrequisition_audit', 'test_subject_visit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', related_name='_audit_testrequisition', to=orm['bhp_visit_tracking.TestSubjectVisit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestRequisition.test_subject_visit'
        db.delete_column(u'lab_requisition_testrequisition', 'test_subject_visit_id')

        # Deleting field 'TestRequisitionAudit.test_subject_visit'
        db.delete_column(u'lab_requisition_testrequisition_audit', 'test_subject_visit_id')
    ...
    models = {
        ...
        'bhp_visit_tracking.testsubjectvisit': {
        ...
        'lab_requisition.testrequisition': {
            ...
            'test_subject_visit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_visit_tracking.TestSubjectVisit']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'lab_requisition.testrequisitionaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'TestRequisitionAudit', 'db_table': "u'lab_requisition_testrequisition_audit'"},
            ...
            'test_subject_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_testrequisition'", 'to': "orm['bhp_visit_tracking.TestSubjectVisit']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
