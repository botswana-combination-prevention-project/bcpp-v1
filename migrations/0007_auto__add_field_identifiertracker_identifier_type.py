...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IdentifierTracker.identifier_type'
        db.add_column('bhp_common_identifiertracker', 'identifier_type', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=35), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IdentifierTracker.identifier_type'
        db.delete_column('bhp_common_identifiertracker', 'identifier_type')
