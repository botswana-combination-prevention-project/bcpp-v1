...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'ResultItem.status'
        db.rename_column('bhp_lab_core_resultitem', 'status', 'validation_status')

        # Rename field 'ResultItem.result_quantifier'
        db.rename_column('bhp_lab_core_resultitem', 'result_quantifier', 'result_item_quantifier')

        # Rename field 'ResultItem.result_value'
        db.rename_column('bhp_lab_core_resultitem', 'result_value', 'result_item_value')

        # Adding field 'ResultItem.result_item_datetime'
        db.add_column('bhp_lab_core_resultitem', 'result_item_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 2, 21, 50, 19, 974724)), keep_default=False)

        # Adding field 'ResultItem.validation_datetime'
        db.add_column('bhp_lab_core_resultitem', 'validation_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ResultItem.validation_user'
        db.add_column('bhp_lab_core_resultitem', 'validation_user', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Rename field 'ResultItem.status'
        db.rename_column('bhp_lab_core_resultitem', 'validation_status', 'status')

        # Rename field 'ResultItem.result_quantifier'
        db.rename_column('bhp_lab_core_resultitem', 'result_item_quantifier', 'result_quantifier')

        # Rename field 'ResultItem.result_value'
        db.rename_column('bhp_lab_core_resultitem', 'result_item_value', 'result_value')

        # Deleting field 'ResultItem.result_item_datetime'
        db.delete_column('bhp_lab_core_resultitem', 'result_item_datetime')

        # Deleting field 'ResultItem.validation_datetime'
        db.delete_column('bhp_lab_core_resultitem', 'validation_datetime')

        # Deleting field 'ResultItem.validation_user'
        db.delete_column('bhp_lab_core_resultitem', 'validation_user')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 21, 49, 34, 821543)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 21, 49, 34, 857862)'}),
