...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result.result_datetime'
        db.add_column('bhp_lab_result', 'result_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 3, 15)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Result.result_datetime'
        db.delete_column('bhp_lab_result', 'result_datetime')
