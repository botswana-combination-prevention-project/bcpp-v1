...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_testmap', (
            ...
            ('local_test_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.Test'])),
        ))
        db.send_create_signal('bhp_lab', ['TestMap'])

        # Adding field 'Test.test_group'
        db.add_column('bhp_lab_test', 'test_group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab.TestGroup']), keep_default=False)

        # Adding field 'Test.units'
        db.add_column('bhp_lab_test', 'units', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'Test.reference_range_hi'
        db.add_column('bhp_lab_test', 'reference_range_hi', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4), keep_default=False)

        # Adding field 'Test.reference_range_lo'
        db.add_column('bhp_lab_test', 'reference_range_lo', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4), keep_default=False)

        # Adding field 'Test.display_decimal_places'
        db.add_column('bhp_lab_test', 'display_decimal_places', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Test.lln'
        db.add_column('bhp_lab_test', 'lln', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True), keep_default=False)

        # Adding field 'Test.uln'
        db.add_column('bhp_lab_test', 'uln', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=4, blank=True), keep_default=False)

        # Adding field 'Test.is_absolute'
        db.add_column('bhp_lab_test', 'is_absolute', self.gf('django.db.models.fields.CharField')(default='ABS', max_length='5'), keep_default=False)

        # Adding field 'Test.formula'
        db.add_column('bhp_lab_test', 'formula', self.gf('django.db.models.fields.CharField')(max_length='50', null=True, blank=True), keep_default=False)

        # Changing field 'Test.test_code'
        db.alter_column('bhp_lab_test', 'test_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Test.test_group'
        db.delete_column('bhp_lab_test', 'test_group_id')

        # Deleting field 'Test.units'
        db.delete_column('bhp_lab_test', 'units')

        # Deleting field 'Test.reference_range_hi'
        db.delete_column('bhp_lab_test', 'reference_range_hi')

        # Deleting field 'Test.reference_range_lo'
        db.delete_column('bhp_lab_test', 'reference_range_lo')

        # Deleting field 'Test.display_decimal_places'
        db.delete_column('bhp_lab_test', 'display_decimal_places')

        # Deleting field 'Test.lln'
        db.delete_column('bhp_lab_test', 'lln')

        # Deleting field 'Test.uln'
        db.delete_column('bhp_lab_test', 'uln')

        # Deleting field 'Test.is_absolute'
        db.delete_column('bhp_lab_test', 'is_absolute')

        # Deleting field 'Test.formula'
        db.delete_column('bhp_lab_test', 'formula')

        # Changing field 'Test.test_code'
        db.alter_column('bhp_lab_test', 'test_code', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
    ...
    models = {
        ...
        'bhp_lab.test': {
            ...
            'test_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '15'}),
            'test_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab.TestGroup']"}),
        ...
        'bhp_lab.testmap': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_test_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab.Test']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
