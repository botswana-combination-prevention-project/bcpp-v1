...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppointmentAudit.is_confirmed'
        db.add_column('bhp_appointment_appointment_audit', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AppointmentAudit.contact_count'
        db.add_column('bhp_appointment_appointment_audit', 'contact_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Appointment.is_confirmed'
        db.add_column('bhp_appointment_appointment', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Appointment.contact_count'
        db.add_column('bhp_appointment_appointment', 'contact_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppointmentAudit.is_confirmed'
        db.delete_column('bhp_appointment_appointment_audit', 'is_confirmed')

        # Deleting field 'AppointmentAudit.contact_count'
        db.delete_column('bhp_appointment_appointment_audit', 'contact_count')

        # Deleting field 'Appointment.is_confirmed'
        db.delete_column('bhp_appointment_appointment', 'is_confirmed')

        # Deleting field 'Appointment.contact_count'
        db.delete_column('bhp_appointment_appointment', 'contact_count')
