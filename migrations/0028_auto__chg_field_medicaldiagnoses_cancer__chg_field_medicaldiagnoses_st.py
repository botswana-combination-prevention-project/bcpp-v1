...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicalDiagnoses.cancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'cancer', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnoses.sti'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'sti', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnoses.dateheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dateheartattack', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnoses.dxcancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxcancer', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'MedicalDiagnoses.datecancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'datecancer', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnoses.heartattackrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'heartattackrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnoses.tb'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'tb', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnoses.dxTB'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxTB', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MedicalDiagnoses.datetb'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'datetb', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnoses.dxheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxheartattack', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'MedicalDiagnoses.tbrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'tbrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnoses.heartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'heartattack', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnoses.cancerrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'cancerrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.cancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'cancer', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnosesAudit.dateheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dateheartattack', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnosesAudit.dxcancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxcancer', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'MedicalDiagnosesAudit.datecancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'datecancer', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnosesAudit.heartattackrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'heartattackrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.tb'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'tb', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnosesAudit.dxTB'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxTB', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'MedicalDiagnosesAudit.datetb'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'datetb', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicalDiagnosesAudit.dxheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxheartattack', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'MedicalDiagnosesAudit.tbrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'tbrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.heartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'heartattack', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnosesAudit.sti'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'sti', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MedicalDiagnosesAudit.cancerrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'cancerrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'MedicalDiagnoses.cancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'cancer', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnoses.sti'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'sti', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnoses.dateheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dateheartattack', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnoses.dxcancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxcancer', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnoses.datecancer'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'datecancer', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnoses.heartattackrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'heartattackrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnoses.tb'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'tb', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnoses.dxTB'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxTB', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnoses.datetb'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'datetb', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnoses.dxheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'dxheartattack', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnoses.tbrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'tbrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnoses.heartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'heartattack', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnoses.cancerrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses', 'cancerrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.cancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'cancer', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnosesAudit.dateheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dateheartattack', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.dxcancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxcancer', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.datecancer'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'datecancer', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.heartattackrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'heartattackrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.tb'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'tb', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnosesAudit.dxTB'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxTB', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.datetb'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'datetb', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'MedicalDiagnosesAudit.dxheartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'dxheartattack', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.tbrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'tbrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'MedicalDiagnosesAudit.heartattack'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'heartattack', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnosesAudit.sti'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'sti', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MedicalDiagnosesAudit.cancerrecord'
        db.alter_column('bcpp_subject_medicaldiagnoses_audit', 'cancerrecord', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 9, 14, 35, 728101)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 9, 14, 35, 843763)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 9, 14, 35, 437262)'}),
