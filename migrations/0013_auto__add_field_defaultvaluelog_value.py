...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DefaultValueLog.value'
        db.add_column('bhp_lab_tracker_defaultvaluelog', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DefaultValueLog.value'
        db.delete_column('bhp_lab_tracker_defaultvaluelog', 'value')
