...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VisitDefinition.grouping'
        db.add_column('bhp_visit_visitdefinition', 'grouping', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VisitDefinition.grouping'
        db.delete_column('bhp_visit_visitdefinition', 'grouping')
