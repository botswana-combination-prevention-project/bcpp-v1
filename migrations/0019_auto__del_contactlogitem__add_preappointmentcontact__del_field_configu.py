...
#        db.delete_table('bhp_appointment_contactlogitem')
        ...
        # Adding field 'Configuration.default_appt_type'
        db.add_column('bhp_appointment_configuration', 'default_appt_type',
    ...
    def backwards(self, orm):
        ...
        db.create_table('bhp_appointment_contactlogitem', (
        ...
        db.send_create_signal('bhp_appointment', ['ContactLogItem'])
        ...
        # Deleting field 'Configuration.default_appt_type'
        db.delete_column('bhp_appointment_configuration', 'default_appt_type')
    ...
    models = {
        ...
        'bhp_appointment.preappointmentcontact': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'new_appt_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
