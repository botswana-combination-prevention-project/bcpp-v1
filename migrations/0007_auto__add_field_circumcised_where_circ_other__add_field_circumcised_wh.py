...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Circumcised.where_circ_other'
        db.add_column('bcpp_subject_circumcised', 'where_circ_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'Circumcised.why_circ_other'
        db.add_column('bcpp_subject_circumcised', 'why_circ_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'Circumcised.where_circ'
        db.alter_column('bcpp_subject_circumcised', 'where_circ', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'Circumcised.why_circ'
        db.alter_column('bcpp_subject_circumcised', 'why_circ', self.gf('django.db.models.fields.CharField')(max_length=55))

        # Adding field 'Uncircumcised.circumcision_day_other'
        db.add_column('bcpp_subject_uncircumcised', 'circumcision_day_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'Uncircumcised.circumcision_week_other'
        db.add_column('bcpp_subject_uncircumcised', 'circumcision_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'Uncircumcised.circumcision_year_other'
        db.add_column('bcpp_subject_uncircumcised', 'circumcision_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)
        ...
        # Adding field 'CircumcisedAudit.where_circ_other'
        db.add_column('bcpp_subject_circumcised_audit', 'where_circ_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'CircumcisedAudit.why_circ_other'
        db.add_column('bcpp_subject_circumcised_audit', 'why_circ_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'CircumcisedAudit.where_circ'
        db.alter_column('bcpp_subject_circumcised_audit', 'where_circ', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'CircumcisedAudit.why_circ'
        db.alter_column('bcpp_subject_circumcised_audit', 'why_circ', self.gf('django.db.models.fields.CharField')(max_length=55))

        # Adding field 'UncircumcisedAudit.circumcision_day_other'
        db.add_column('bcpp_subject_uncircumcised_audit', 'circumcision_day_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'UncircumcisedAudit.circumcision_week_other'
        db.add_column('bcpp_subject_uncircumcised_audit', 'circumcision_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'UncircumcisedAudit.circumcision_year_other'
        db.add_column('bcpp_subject_uncircumcised_audit', 'circumcision_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Circumcised.where_circ_other'
        db.delete_column('bcpp_subject_circumcised', 'where_circ_other')

        # Deleting field 'Circumcised.why_circ_other'
        db.delete_column('bcpp_subject_circumcised', 'why_circ_other')

        # Changing field 'Circumcised.where_circ'
        db.alter_column('bcpp_subject_circumcised', 'where_circ', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Circumcised.why_circ'
        db.alter_column('bcpp_subject_circumcised', 'why_circ', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Deleting field 'Uncircumcised.circumcision_day_other'
        db.delete_column('bcpp_subject_uncircumcised', 'circumcision_day_other')

        # Deleting field 'Uncircumcised.circumcision_week_other'
        db.delete_column('bcpp_subject_uncircumcised', 'circumcision_week_other')

        # Deleting field 'Uncircumcised.circumcision_year_other'
        db.delete_column('bcpp_subject_uncircumcised', 'circumcision_year_other')

        # Changing field 'Uncircumcised.aware_free'
        db.alter_column('bcpp_subject_uncircumcised', 'aware_free', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Deleting field 'CircumcisedAudit.where_circ_other'
        db.delete_column('bcpp_subject_circumcised_audit', 'where_circ_other')

        # Deleting field 'CircumcisedAudit.why_circ_other'
        db.delete_column('bcpp_subject_circumcised_audit', 'why_circ_other')

        # Changing field 'CircumcisedAudit.where_circ'
        db.alter_column('bcpp_subject_circumcised_audit', 'where_circ', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'CircumcisedAudit.why_circ'
        db.alter_column('bcpp_subject_circumcised_audit', 'why_circ', self.gf('django.db.models.fields.CharField')(max_length=25))
        ...
        # Changing field 'UncircumcisedAudit.aware_free'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'aware_free', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 11, 16, 20, 6785)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 11, 16, 20, 129535)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 11, 16, 19, 727731)'}),
