...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bcpp_subject_hivtestingsupplemental', 'whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=55, null=True))

        # Changing field 'HivTestingSupplementalAudit.whynohivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental_audit', 'whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=55, null=True))


    def backwards(self, orm):
        
        # Changing field 'HivTestingSupplemental.whynohivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental', 'whynohivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=55))

        # Changing field 'HivTestingSupplementalAudit.whynohivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental_audit', 'whynohivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=55))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 9, 22, 28, 893262)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 9, 22, 29, 9990)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 9, 22, 28, 601659)'}),
