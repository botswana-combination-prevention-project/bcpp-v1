...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receive.protocol'
        db.add_column('bhp_lab_core_receive', 'protocol', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_research_protocol.Protocol']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receive.protocol'
        db.delete_column('bhp_lab_core_receive', 'protocol_id')
