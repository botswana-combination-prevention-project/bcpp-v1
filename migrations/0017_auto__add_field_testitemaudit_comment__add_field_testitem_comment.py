...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestItemAudit.comment'
        db.add_column('bhp_dispatch_testitem_audit', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'TestItem.comment'
        db.add_column('bhp_dispatch_testitem', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestItemAudit.comment'
        db.delete_column('bhp_dispatch_testitem_audit', 'comment')

        # Deleting field 'TestItem.comment'
        db.delete_column('bhp_dispatch_testitem', 'comment')
    ...
    models = {
        'bhp_dispatch.dispatchcontainer': {
            ...
            'dispatch_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'bhp_dispatch.preparehistory': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'prepare_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 25, 0, 0)'}),
            'producer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_sync.Producer']"}),
