...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bhp_registration_registeredsubject', 'salt', self.gf('django.db.models.fields.CharField')(default='sK5rKr@F[(uh', unique=True, max_length=25), keep_default=False)

        # Changing field 'RegisteredSubject.last_name'
        db.alter_column('bhp_registration_registeredsubject', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=78L))

        # Changing field 'RegisteredSubject.first_name'
        db.alter_column('bhp_registration_registeredsubject', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=78L))
        ...
        db.add_column('bhp_registration_registeredsubject_audit', 'salt', self.gf('django.db.models.fields.CharField')(default='sK5rKr@F[(uh', max_length=25), keep_default=False)

        # Changing field 'RegisteredSubjectAudit.last_name'
        db.alter_column('bhp_registration_registeredsubject_audit', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=78L))

        # Changing field 'RegisteredSubjectAudit.first_name'
        db.alter_column('bhp_registration_registeredsubject_audit', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=78L))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RegisteredSubject.last_name'
        db.alter_column('bhp_registration_registeredsubject', 'last_name', self.gf('django.db.models.fields.TextField')(max_length=78))

        # Changing field 'RegisteredSubject.first_name'
        db.alter_column('bhp_registration_registeredsubject', 'first_name', self.gf('django.db.models.fields.TextField')(max_length=78))

        # Changing field 'RegisteredSubject.identity'
        db.alter_column('bhp_registration_registeredsubject', 'identity', self.gf('django.db.models.fields.TextField')(unique=True, max_length=78, null=True))

        # Deleting field 'RegisteredSubjectAudit.salt'
        db.delete_column('bhp_registration_registeredsubject_audit', 'salt')

        # Changing field 'RegisteredSubjectAudit.last_name'
        db.alter_column('bhp_registration_registeredsubject_audit', 'last_name', self.gf('django.db.models.fields.TextField')(max_length=78))
    ...
    models = {
        'bhp_registration.registeredsubject': {
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '78L'}),
            ...
            'salt': ('django.db.models.fields.CharField', [], {'default': "'sK5rKr@F[(uh'", 'unique': 'True', 'max_length': '25'}),
        ...
        'bhp_registration.registeredsubjectaudit': {
            ...
            'registration_status': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'relative_identifier': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'salt': ('django.db.models.fields.CharField', [], {'default': "'sK5rKr@F[(uh'", 'max_length': '25'}),
            'screening_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sid': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 6, 21)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
