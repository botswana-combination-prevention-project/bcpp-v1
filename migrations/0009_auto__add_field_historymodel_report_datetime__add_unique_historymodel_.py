...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoryModel.report_datetime'
        db.add_column('bhp_lab_tracker_historymodel', 'report_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding unique constraint on 'HistoryModel', fields ['source', 'source_identifier']
        db.create_unique('bhp_lab_tracker_historymodel', ['source', 'source_identifier'])

        # Adding field 'HistoryModelError.report_datetime'
        db.add_column('bhp_lab_tracker_historymodelerror', 'report_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HistoryModel.report_datetime'
        db.delete_column('bhp_lab_tracker_historymodel', 'report_datetime')

        # Deleting field 'HistoryModelError.report_datetime'
        db.delete_column('bhp_lab_tracker_historymodelerror', 'report_datetime')
    ...
    models = {
        ...
        'bhp_lab_tracker.historymodel': {
            'Meta': {'unique_together': "(('source', 'source_identifier'),)", 'object_name': 'HistoryModel'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
