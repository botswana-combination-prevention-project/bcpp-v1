...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabelPrinter.default'
        db.add_column('lab_barcode_labelprinter', 'default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabelPrinter.default'
        db.delete_column('lab_barcode_labelprinter', 'default')
