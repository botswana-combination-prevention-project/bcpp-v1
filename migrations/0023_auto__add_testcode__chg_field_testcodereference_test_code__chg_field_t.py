...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestCodeReference.test_code'
        db.alter_column('bhp_lab_core_testcodereference', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.TestCode']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TestCodeReference.test_code'
        db.alter_column('bhp_lab_core_testcodereference', 'test_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['models.TestCode']))
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 21, 15, 36, 212733)'}),
