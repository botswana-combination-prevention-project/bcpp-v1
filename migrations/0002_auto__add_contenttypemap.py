...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContentTypeMap'
        db.create_table('bhp_common_contenttypemap', (
            ...
            ('app_label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('model', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('bhp_common', ['ContentTypeMap'])


    def backwards(self, orm):
        
        # Deleting model 'ContentTypeMap'
        db.delete_table('bhp_common_contenttypemap')
