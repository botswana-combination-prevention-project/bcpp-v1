...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DeathCauseCategory', fields ['hostname_created']
        db.create_index('bhp_adverse_deathcausecategory', ['hostname_created'])

        # Adding index on 'DeathCauseCategory', fields ['hostname_modified']
        db.create_index('bhp_adverse_deathcausecategory', ['hostname_modified'])

        # Adding index on 'SimpleAdverseEvent', fields ['hostname_created']
        db.create_index('bhp_adverse_simpleadverseevent', ['hostname_created'])

        # Adding index on 'SimpleAdverseEvent', fields ['hostname_modified']
        db.create_index('bhp_adverse_simpleadverseevent', ['hostname_modified'])

        # Adding index on 'DeathMedicalResponsibility', fields ['hostname_created']
        db.create_index('bhp_adverse_deathmedicalresponsibility', ['hostname_created'])

        # Adding index on 'DeathMedicalResponsibility', fields ['hostname_modified']
        db.create_index('bhp_adverse_deathmedicalresponsibility', ['hostname_modified'])

        # Adding index on 'Ae010ReportType', fields ['hostname_created']
        db.create_index('bhp_adverse_ae010reporttype', ['hostname_created'])

        # Adding index on 'Ae010ReportType', fields ['hostname_modified']
        db.create_index('bhp_adverse_ae010reporttype', ['hostname_modified'])

        # Adding index on 'DeathCauseInfo', fields ['hostname_created']
        db.create_index('bhp_adverse_deathcauseinfo', ['hostname_created'])

        # Adding index on 'DeathCauseInfo', fields ['hostname_modified']
        db.create_index('bhp_adverse_deathcauseinfo', ['hostname_modified'])

        # Adding index on 'Ae010AdverseStudyRel', fields ['hostname_created']
        db.create_index('bhp_adverse_ae010adversestudyrel', ['hostname_created'])

        # Adding index on 'Ae010AdverseStudyRel', fields ['hostname_modified']
        db.create_index('bhp_adverse_ae010adversestudyrel', ['hostname_modified'])

        # Adding index on 'DeathReasonHospitalized', fields ['hostname_created']
        db.create_index('bhp_adverse_deathreasonhospitalized', ['hostname_created'])

        # Adding index on 'DeathReasonHospitalized', fields ['hostname_modified']
        db.create_index('bhp_adverse_deathreasonhospitalized', ['hostname_modified'])

        # Adding index on 'AdverseEventReportType', fields ['hostname_created']
        db.create_index('bhp_adverse_adverseeventreporttype', ['hostname_created'])

        # Adding index on 'AdverseEventReportType', fields ['hostname_modified']
        db.create_index('bhp_adverse_adverseeventreporttype', ['hostname_modified'])

        # Adding index on 'AdverseEventStudyRelation', fields ['hostname_created']
        db.create_index('bhp_adverse_adverseeventstudyrelation', ['hostname_created'])

        # Adding index on 'AdverseEventStudyRelation', fields ['hostname_modified']
        db.create_index('bhp_adverse_adverseeventstudyrelation', ['hostname_modified'])
