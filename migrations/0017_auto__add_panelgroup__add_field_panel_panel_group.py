...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Panel.panel_group'
        db.add_column('bhp_lab_core_panel', 'panel_group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.PanelGroup']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Panel.panel_group'
        db.delete_column('bhp_lab_core_panel', 'panel_group_id')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 10, 13, 25, 616077)'}),
