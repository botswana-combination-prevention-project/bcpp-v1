...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('bhp_registration_randomizedsubject', (
            ('first_name', self.gf('django.db.models.fields.TextField')(max_length=78)),
    ...
    models = {
        'bhp_registration.registeredsubject': {
            ...
            'first_name': ('django.db.models.fields.TextField', [], {'max_length': '78'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True'}),
            'hiv_status': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'identity': ('django.db.models.fields.TextField', [], {'max_length': '78', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'last_name': ('django.db.models.fields.TextField', [], {'max_length': '78'}),
        ...
        'bhp_registration.registeredsubjectaudit': {
            ...
            'identity': ('django.db.models.fields.TextField', [], {'max_length': '78', 'null': 'True', 'blank': 'True'}),
            'identity_type': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'initials': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'is_dob_estimated': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'last_name': ('django.db.models.fields.TextField', [], {'max_length': '78'}),
        ...
        'bhp_registration.subjectidentifieraudittrail': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_allocated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2012, 6, 18)'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
