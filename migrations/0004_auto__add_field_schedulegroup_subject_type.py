...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScheduleGroup.subject_type'
        db.add_column('bhp_visit_schedulegroup', 'subject_type', self.gf('django.db.models.fields.CharField')(default='OTHER', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScheduleGroup.subject_type'
        db.delete_column('bhp_visit_schedulegroup', 'subject_type')
    ...
    models = {
        ...
        'bhp_visit.schedulegroup': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'membership_form': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_common.ContentTypeMap']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'subject_type': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
