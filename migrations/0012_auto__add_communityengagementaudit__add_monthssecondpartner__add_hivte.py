...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_communityengagement_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('communityengagement', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('voteengagement', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('solveengagement', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table('bcpp_subject_monthssecondpartner', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('firstpartnerlive', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('thirdlastsex', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('firstfirstsex', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('firstsexcurrent', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstrelationship', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstexchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('concurrent', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('goods_exchange', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstsexfreq', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('firstpartnerhiv', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firsthaart', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstdisclose', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstcondomfreq', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstpartnercp', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('bcpp_subject', ['MonthsSecondPartner'])

        # Adding model 'HivTestingSupplementalAudit'
        db.create_table('bcpp_subject_hivtestingsupplemental_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('numhivtests', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('wherehivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whyhivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('arvshivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('prefer_hivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hivtest_time', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hivtest_week', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hivtest_year', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_hivtestingsupplemental', to=orm['bcpp_subject.SubjectVisit'])),
        ))
        db.send_create_signal('bcpp_subject', ['HivTestingSupplementalAudit'])
        ...
        db.create_table('bcpp_subject_residencymobility_audit', (
            ...
            ('forteennights', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('intendresidency', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('nightsaway', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('reasonaway', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivtestinghistory', (
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_subject.SubjectVisit'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('HHhivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('everhivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('hivtestrecord', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        ...
        db.create_table('bcpp_subject_sexualbehaviour', (
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_subject.SubjectVisit'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('eversex', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('lastyearpartners', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('moresex', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('firstsex', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('condom', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('alcohol_sex', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('lastsex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('lastsex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=25)),
        ))
        ...
        db.create_table('bcpp_subject_demographics_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('religion', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('ethnic', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('numwives', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_education', (
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_subject.SubjectVisit'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('education', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('employment', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('moneyforwork', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('seekingwork', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        ...
        db.create_table('bcpp_subject_hivtestreview_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 19, 17, 33, 3, 734014))),
            ('hivtestdate', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True, blank=True)),
            ('recordedhivresult', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        # Adding model 'HivTestingSupplemental'
        db.create_table('bcpp_subject_hivtestingsupplemental', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['HivTestingSupplemental'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HivTestingSupplementalAudit'
        db.delete_table('bcpp_subject_hivtestingsupplemental_audit')
        ...
        # Deleting model 'HivTestingSupplemental'
        db.delete_table('bcpp_subject_hivtestingsupplemental')
    ...
    models = {
        ...
        'bcpp_subject.baselinehouseholdsurvey': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 17, 33, 3, 734014)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 19)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 19, 17, 33, 3, 529394)'}),
