...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_hivhealthcarecosts_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 16, 16, 28, 8, 964106))),
            ('hiv_medical_care', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('reason_no_care', self.gf('django.db.models.fields.CharField')(max_length=115)),
        ...
        db.create_table('bcpp_subject_qualityoflife_audit', (
            ...
            ('self_care', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.create_table('bcpp_subject_outpatientcare_audit', (
            ...
            ('travel_time', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
    ...
    models = {
        ...
        'bcpp_subject.hivhealthcarecosts': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 16, 16, 28, 8, 964106)'}),
