...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Panel.name'
        db.alter_column('bhp_lab_core_panel', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Panel.name'
        db.alter_column('bhp_lab_core_panel', 'name', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 19, 22, 13, 24, 831914)'}),
