...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestConsent.language'
        db.add_column('bhp_base_test_testconsent', 'language',
                      self.gf('django.db.models.fields.CharField')(default='not specified', max_length=25),
                      keep_default=False)


        # Changing field 'TestConsent.initials'
        db.alter_column('bhp_base_test_testconsent', 'initials', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
        # Deleting field 'TestBaseOffStudyAudit._audit_subject_identifier'
        db.delete_column('bhp_base_test_testbaseoffstudy_audit', '_audit_subject_identifier')

        # Adding field 'TestConsentNoRs.language'
        db.add_column('bhp_base_test_testconsentnors', 'language',
                      self.gf('django.db.models.fields.CharField')(default='not specified', max_length=25),
                      keep_default=False)


        # Changing field 'TestConsentNoRs.initials'
        db.alter_column('bhp_base_test_testconsentnors', 'initials', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TestConsent.language'
        db.delete_column('bhp_base_test_testconsent', 'language')


        # Changing field 'TestConsent.initials'
        db.alter_column('bhp_base_test_testconsent', 'initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
        # Adding field 'TestBaseOffStudyAudit._audit_subject_identifier'
        db.add_column('bhp_base_test_testbaseoffstudy_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'TestConsentNoRs.language'
        db.delete_column('bhp_base_test_testconsentnors', 'language')


        # Changing field 'TestConsentNoRs.initials'
        db.alter_column('bhp_base_test_testconsentnors', 'initials', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
