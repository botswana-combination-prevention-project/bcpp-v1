...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Receive.specimen_medium'
        db.delete_column('bhp_lab_core_receive', 'specimen_medium')

        # Deleting field 'Receive.specimen_measure_units'
        db.delete_column('bhp_lab_core_receive', 'specimen_measure_units')

        # Deleting field 'Receive.specimen_measure'
        db.delete_column('bhp_lab_core_receive', 'specimen_measure')

        # Deleting field 'Receive.specimen_type'
        db.delete_column('bhp_lab_core_receive', 'specimen_type_id')

        # Deleting field 'Aliquot.volume'
        db.delete_column('bhp_lab_core_aliquot', 'volume')

        # Adding field 'Aliquot.medium'
        db.add_column('bhp_lab_core_aliquot', 'medium', self.gf('django.db.models.fields.CharField')(default='tube', max_length=25), keep_default=False)

        # Adding field 'Aliquot.measure'
        db.add_column('bhp_lab_core_aliquot', 'measure', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Aliquot.measure_units'
        db.add_column('bhp_lab_core_aliquot', 'measure_units', self.gf('django.db.models.fields.CharField')(default='mL', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Receive.specimen_medium'
        db.add_column('bhp_lab_core_receive', 'specimen_medium', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'Receive.specimen_measure_units'
        db.add_column('bhp_lab_core_receive', 'specimen_measure_units', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'Receive.specimen_measure'
        db.add_column('bhp_lab_core_receive', 'specimen_measure', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Adding field 'Receive.specimen_type'
        db.add_column('bhp_lab_core_receive', 'specimen_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.SpecimenType']), keep_default=False)

        # Adding field 'Aliquot.volume'
        db.add_column('bhp_lab_core_aliquot', 'volume', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2), keep_default=False)

        # Deleting field 'Aliquot.medium'
        db.delete_column('bhp_lab_core_aliquot', 'medium')

        # Deleting field 'Aliquot.measure'
        db.delete_column('bhp_lab_core_aliquot', 'measure')

        # Deleting field 'Aliquot.measure_units'
        db.delete_column('bhp_lab_core_aliquot', 'measure_units')
    ...
    models = {
        'bhp_lab_core.aliquot': {
            ...
            'measure': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
