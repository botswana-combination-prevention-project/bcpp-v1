...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bcpp_subject_education', 'employment', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'EducationAudit.employment'
        db.alter_column('bcpp_subject_education_audit', 'employment', self.gf('django.db.models.fields.CharField')(max_length=45))
