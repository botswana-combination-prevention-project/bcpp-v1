...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'TestCodeReferenceListItem.panic_value'
        db.rename_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value', 'panic_value_high')

        # Deleting field 'TestCodeReferenceListItem.panic_value_quantifier'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value_quantifier')

        # Adding field 'TestCodeReferenceListItem.panic_value_low'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value_low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True), keep_default=False)

        # Rename field 'TestCodeReferenceListItemAudit.panic_value'
        db.rename_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value', 'panic_value_high')

        # Deleting field 'TestCodeReferenceListItemAudit.panic_value_quantifier'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value_quantifier')

        # Adding field 'TestCodeReferenceListItemAudit.panic_value_low'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value_low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Rename field 'TestCodeReferenceListItem.panic_value'
        db.rename_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value_high', 'panic_value')

        # Adding field 'TestCodeReferenceListItem.panic_value_quantifier'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value_quantifier', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Deleting field 'TestCodeReferenceListItem.panic_value_low'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem', 'panic_value_low')

        # Rename field 'TestCodeReferenceListItemAudit.panic_value'
        db.rename_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value_high', 'panic_value')

        # Adding field 'TestCodeReferenceListItemAudit.panic_value_quantifier'
        db.add_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value_quantifier', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)

        # Deleting field 'TestCodeReferenceListItemAudit.panic_value_low'
        db.delete_column('bhp_lab_test_code_testcodereferencelistitem_audit', 'panic_value_low')
