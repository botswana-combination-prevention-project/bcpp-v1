...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TestCodeReference.lln'
        db.add_column('bhp_lab_core_testcodereference', 'lln', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True), keep_default=False)

        # Adding field 'TestCodeReference.uln'
        db.add_column('bhp_lab_core_testcodereference', 'uln', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TestCodeReference.lln'
        db.delete_column('bhp_lab_core_testcodereference', 'lln')

        # Deleting field 'TestCodeReference.uln'
        db.delete_column('bhp_lab_core_testcodereference', 'uln')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 3, 7, 375300)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 3, 7, 425968)'}),
