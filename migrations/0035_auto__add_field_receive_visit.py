...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Receive.visit'
        db.add_column('bhp_lab_core_receive', 'visit', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Receive.visit'
        db.delete_column('bhp_lab_core_receive', 'visit')


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 21, 27, 6, 21597)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 21, 27, 6, 91484)'}),
