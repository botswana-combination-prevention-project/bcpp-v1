...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScheduleGroup.membership_form'
        db.alter_column('bhp_visit_schedulegroup', 'membership_form_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_common.ContentTypeMap']))


    def backwards(self, orm):
        
        # Changing field 'ScheduleGroup.membership_form'
        db.alter_column('bhp_visit_schedulegroup', 'membership_form_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))


    models = {
        'bhp_common.contenttypemap': {
            'Meta': {'object_name': 'ContentTypeMap'},
            'app_label': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
