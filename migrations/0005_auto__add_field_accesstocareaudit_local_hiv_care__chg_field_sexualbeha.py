...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccessToCareAudit.local_hiv_care'
        db.add_column('bcpp_subject_accesstocare_audit', 'local_hiv_care',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


        # Changing field 'SexualBehaviourAudit.lifetime_sex_partners'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lifetime_sex_partners', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'SexualBehaviour.lifetime_sex_partners'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lifetime_sex_partners', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))
        # Adding field 'AccessToCare.local_hiv_care'
        db.add_column('bcpp_subject_accesstocare', 'local_hiv_care',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccessToCareAudit.local_hiv_care'
        db.delete_column('bcpp_subject_accesstocare_audit', 'local_hiv_care')


        # Changing field 'SexualBehaviourAudit.lifetime_sex_partners'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lifetime_sex_partners', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3))

        # Changing field 'SexualBehaviour.lifetime_sex_partners'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lifetime_sex_partners', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=3))
        # Deleting field 'AccessToCare.local_hiv_care'
        db.delete_column('bcpp_subject_accesstocare', 'local_hiv_care')
