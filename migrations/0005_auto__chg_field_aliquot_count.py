...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aliquot.count'
        db.alter_column('bhp_lab_core_aliquot', 'count', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Aliquot.count'
        db.alter_column('bhp_lab_core_aliquot', 'count', self.gf('django.db.models.fields.IntegerField')(default=0))
