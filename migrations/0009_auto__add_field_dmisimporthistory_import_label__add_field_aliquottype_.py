...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DmisImportHistory.import_label'
        db.add_column('bhp_lab_core_dmisimporthistory', 'import_label', self.gf('django.db.models.fields.CharField')(default='fetch_receive', max_length=25), keep_default=False)

        # Adding field 'AliquotType.dmis_reference'
        db.add_column('bhp_lab_core_aliquottype', 'dmis_reference', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DmisImportHistory.import_label'
        db.delete_column('bhp_lab_core_dmisimporthistory', 'import_label')

        # Deleting field 'AliquotType.dmis_reference'
        db.delete_column('bhp_lab_core_aliquottype', 'dmis_reference')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 18, 15, 56, 51, 276713)'}),
