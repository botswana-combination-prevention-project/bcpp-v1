...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdAudit.action'
        db.add_column('bcpp_household_household_audit', 'action',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'Household.action'
        db.add_column('bcpp_household_household', 'action',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdAudit.action'
        db.delete_column('bcpp_household_household_audit', 'action')

        # Deleting field 'Household.action'
        db.delete_column('bcpp_household_household', 'action')
