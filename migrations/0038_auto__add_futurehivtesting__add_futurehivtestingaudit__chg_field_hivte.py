...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_futurehivtesting', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 24, 8, 56, 41, 555311))),
        ...
        # Changing field 'HivTestReviewAudit.hivtestdate'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'hivtestdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Deleting field 'HivTestingSupplemental.hivtest_time'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_time')

        # Deleting field 'HivTestingSupplemental.hivtest_week'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_week')

        # Deleting field 'HivTestingSupplemental.hivtest_week_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_week_other')

        # Deleting field 'HivTestingSupplemental.prefer_hivtest'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'prefer_hivtest')

        # Deleting field 'HivTestingSupplemental.hivtest_time_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_time_other')

        # Deleting field 'HivTestingSupplemental.hivtest_year'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_year')

        # Deleting field 'HivTestingSupplemental.hivtest_year_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental', 'hivtest_year_other')

        # Changing field 'HivTestingSupplemental.arvshivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental', 'arvshivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Deleting field 'HivTestingSupplementalAudit.hivtest_time'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_time')

        # Deleting field 'HivTestingSupplementalAudit.hivtest_week'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_week')

        # Deleting field 'HivTestingSupplementalAudit.hivtest_week_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_week_other')

        # Deleting field 'HivTestingSupplementalAudit.prefer_hivtest'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'prefer_hivtest')

        # Deleting field 'HivTestingSupplementalAudit.hivtest_time_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_time_other')

        # Deleting field 'HivTestingSupplementalAudit.hivtest_year'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_year')

        # Deleting field 'HivTestingSupplementalAudit.hivtest_year_other'
        db.delete_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_year_other')

        # Changing field 'HivTestingSupplementalAudit.arvshivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental_audit', 'arvshivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivTestReview.hivtestdate'
        db.alter_column('bcpp_subject_hivtestreview', 'hivtestdate', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HivTestReviewAudit.hivtestdate'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'hivtestdate', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Adding field 'HivTestingSupplemental.hivtest_time'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_time', self.gf('django.db.models.fields.CharField')(default=0, max_length=35), keep_default=False)

        # Adding field 'HivTestingSupplemental.hivtest_week'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_week', self.gf('django.db.models.fields.CharField')(default=0, max_length=35), keep_default=False)

        # Adding field 'HivTestingSupplemental.hivtest_week_other'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivTestingSupplemental.prefer_hivtest'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=70), keep_default=False)

        # Adding field 'HivTestingSupplemental.hivtest_time_other'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_time_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivTestingSupplemental.hivtest_year'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_year', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'HivTestingSupplemental.hivtest_year_other'
        db.add_column('bcpp_subject_hivtestingsupplemental', 'hivtest_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'HivTestingSupplemental.arvshivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental', 'arvshivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Adding field 'HivTestingSupplementalAudit.hivtest_time'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_time', self.gf('django.db.models.fields.CharField')(default=0, max_length=35), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.hivtest_week'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_week', self.gf('django.db.models.fields.CharField')(default=0, max_length=35), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.hivtest_week_other'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_week_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.prefer_hivtest'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'prefer_hivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=70), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.hivtest_time_other'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_time_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.hivtest_year'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_year', self.gf('django.db.models.fields.CharField')(default=0, max_length=25), keep_default=False)

        # Adding field 'HivTestingSupplementalAudit.hivtest_year_other'
        db.add_column('bcpp_subject_hivtestingsupplemental_audit', 'hivtest_year_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'HivTestingSupplementalAudit.arvshivtest'
        db.alter_column('bcpp_subject_hivtestingsupplemental_audit', 'arvshivtest', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'HivTestReview.hivtestdate'
        db.alter_column('bcpp_subject_hivtestreview', 'hivtestdate', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 56, 41, 555311)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 56, 41, 674212)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 6, 24)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 56, 41, 262189)'}),
