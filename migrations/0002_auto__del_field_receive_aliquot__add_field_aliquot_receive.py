...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Receive.aliquot'
        db.delete_column('bhp_lab_core_receive', 'aliquot_id')

        # Adding field 'Aliquot.receive'
        db.add_column('bhp_lab_core_aliquot', 'receive', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.Receive']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Receive.aliquot'
        db.add_column('bhp_lab_core_receive', 'aliquot', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.Aliquot']), keep_default=False)

        # Deleting field 'Aliquot.receive'
        db.delete_column('bhp_lab_core_aliquot', 'receive_id')
