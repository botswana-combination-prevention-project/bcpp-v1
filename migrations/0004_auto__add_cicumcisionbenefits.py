...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CicumcisionBenefits'
        db.create_table('bcpp_list_cicumcisionbenefits', (
        ...
        db.send_create_signal('bcpp_list', ['CicumcisionBenefits'])


    def backwards(self, orm):
        
        # Deleting model 'CicumcisionBenefits'
        db.delete_table('bcpp_list_cicumcisionbenefits')
