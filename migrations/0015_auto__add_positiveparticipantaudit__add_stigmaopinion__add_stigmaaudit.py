...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_positiveparticipant_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 23, 12, 12, 59, 174825))),
            ('internalize1stigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('internalized2stigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('friendstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('familystigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedtalkstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedrespectstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedjobstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table('bcpp_subject_stigmaopinion', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 23, 12, 12, 59, 174825))),
            ('testcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('gossipcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('respectcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedverbalstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedphyicalstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedfamilystigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('fearstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        ...
        db.create_table('bcpp_subject_stigma_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 23, 12, 12, 59, 174825))),
            ('anticipatestigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('enactedshamestigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('salivastigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('teacherstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('childrenstigma', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_accesstocare', (
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_subject.SubjectVisit'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 23, 12, 12, 59, 174825))),
            ('often_medicalcare', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('overallaccess', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('emergencyaccess', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('expensiveaccess', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('convenientaccess', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('wheneverlaccess', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('bcpp_subject', ['AccessToCare'])

        # Adding M2M table for field whereaccess on 'AccessToCare'
        db.create_table('bcpp_subject_accesstocare_whereaccess', (
        ...
        db.create_unique('bcpp_subject_accesstocare_whereaccess', ['accesstocare_id', 'medicalcareaccess_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field whereaccess on 'AccessToCare'
        db.delete_table('bcpp_subject_accesstocare_whereaccess')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 23, 12, 12, 59, 174825)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 23)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 23, 12, 12, 58, 965257)'}),
