...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdLogEntry.hbc'
        db.delete_column('bcpp_household_householdlogentry', 'hbc')

        # Deleting field 'HouseholdLogEntryAudit.hbc'
        db.delete_column('bcpp_household_householdlogentry_audit', 'hbc')

        # Adding field 'HouseholdAudit.status'
        db.add_column('bcpp_household_household_audit', 'status',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=15),
                      keep_default=False)

        # Adding field 'Household.status'
        db.add_column('bcpp_household_household', 'status',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=15),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'HouseholdLogEntry.hbc'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdLogEntry.hbc' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HouseholdLogEntryAudit.hbc'
        raise RuntimeError("Cannot reverse this migration. 'HouseholdLogEntryAudit.hbc' and its values cannot be restored.")
        # Deleting field 'HouseholdAudit.status'
        db.delete_column('bcpp_household_household_audit', 'status')

        # Deleting field 'Household.status'
        db.delete_column('bcpp_household_household', 'status')
