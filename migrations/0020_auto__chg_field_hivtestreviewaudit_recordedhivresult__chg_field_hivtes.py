...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivTestReviewAudit.recordedhivresult'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'recordedhivresult', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'HivTestReviewAudit.whenhivtest'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'HivTestReviewAudit.verbalhivresult'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'HivTestReview.recordedhivresult'
        db.alter_column('bcpp_subject_hivtestreview', 'recordedhivresult', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'HivTestReview.whenhivtest'
        db.alter_column('bcpp_subject_hivtestreview', 'whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'HivTestReview.verbalhivresult'
        db.alter_column('bcpp_subject_hivtestreview', 'verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'HivTestReviewAudit.recordedhivresult'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'recordedhivresult', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'HivTestReviewAudit.whenhivtest'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'HivTestReviewAudit.verbalhivresult'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'HivTestReview.recordedhivresult'
        db.alter_column('bcpp_subject_hivtestreview', 'recordedhivresult', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'HivTestReview.whenhivtest'
        db.alter_column('bcpp_subject_hivtestreview', 'whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'HivTestReview.verbalhivresult'
        db.alter_column('bcpp_subject_hivtestreview', 'verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 12, 6, 54, 955563)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 12, 6, 55, 69992)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 17, 12, 6, 54, 664092)'}),
