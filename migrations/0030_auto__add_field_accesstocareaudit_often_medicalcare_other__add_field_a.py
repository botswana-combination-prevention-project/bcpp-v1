...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccessToCareAudit.often_medicalcare_other'
        db.add_column('bcpp_subject_accesstocare_audit', 'often_medicalcare_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'AccessToCareAudit.whereaccess_other'
        db.add_column('bcpp_subject_accesstocare_audit', 'whereaccess_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'AccessToCareAudit.often_medicalcare'
        db.alter_column('bcpp_subject_accesstocare_audit', 'often_medicalcare', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'AccessToCareAudit.expensiveaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'expensiveaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCareAudit.emergencyaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'emergencyaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCareAudit.wheneverlaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'wheneverlaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCareAudit.overallaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'overallaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCareAudit.convenientaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'convenientaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Adding field 'AccessToCare.often_medicalcare_other'
        db.add_column('bcpp_subject_accesstocare', 'often_medicalcare_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Adding field 'AccessToCare.whereaccess_other'
        db.add_column('bcpp_subject_accesstocare', 'whereaccess_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)

        # Changing field 'AccessToCare.expensiveaccess'
        db.alter_column('bcpp_subject_accesstocare', 'expensiveaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCare.emergencyaccess'
        db.alter_column('bcpp_subject_accesstocare', 'emergencyaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCare.wheneverlaccess'
        db.alter_column('bcpp_subject_accesstocare', 'wheneverlaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCare.overallaccess'
        db.alter_column('bcpp_subject_accesstocare', 'overallaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCare.convenientaccess'
        db.alter_column('bcpp_subject_accesstocare', 'convenientaccess', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'AccessToCare.often_medicalcare'
        db.alter_column('bcpp_subject_accesstocare', 'often_medicalcare', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Deleting field 'AccessToCareAudit.often_medicalcare_other'
        db.delete_column('bcpp_subject_accesstocare_audit', 'often_medicalcare_other')

        # Deleting field 'AccessToCareAudit.whereaccess_other'
        db.delete_column('bcpp_subject_accesstocare_audit', 'whereaccess_other')

        # Changing field 'AccessToCareAudit.often_medicalcare'
        db.alter_column('bcpp_subject_accesstocare_audit', 'often_medicalcare', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCareAudit.expensiveaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'expensiveaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCareAudit.emergencyaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'emergencyaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCareAudit.wheneverlaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'wheneverlaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCareAudit.overallaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'overallaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCareAudit.convenientaccess'
        db.alter_column('bcpp_subject_accesstocare_audit', 'convenientaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Deleting field 'AccessToCare.often_medicalcare_other'
        db.delete_column('bcpp_subject_accesstocare', 'often_medicalcare_other')

        # Deleting field 'AccessToCare.whereaccess_other'
        db.delete_column('bcpp_subject_accesstocare', 'whereaccess_other')

        # Changing field 'AccessToCare.expensiveaccess'
        db.alter_column('bcpp_subject_accesstocare', 'expensiveaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCare.emergencyaccess'
        db.alter_column('bcpp_subject_accesstocare', 'emergencyaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCare.wheneverlaccess'
        db.alter_column('bcpp_subject_accesstocare', 'wheneverlaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCare.overallaccess'
        db.alter_column('bcpp_subject_accesstocare', 'overallaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCare.convenientaccess'
        db.alter_column('bcpp_subject_accesstocare', 'convenientaccess', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'AccessToCare.often_medicalcare'
        db.alter_column('bcpp_subject_accesstocare', 'often_medicalcare', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 5, 4, 891277)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 5, 5, 6558)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 11, 5, 4, 598917)'}),
