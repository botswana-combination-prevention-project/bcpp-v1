...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DispatchItem.dispatch_host'
        db.add_column('bhp_dispatch_dispatchitem', 'dispatch_host',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DispatchItem.dispatch_host'
        db.delete_column('bhp_dispatch_dispatchitem', 'dispatch_host')
