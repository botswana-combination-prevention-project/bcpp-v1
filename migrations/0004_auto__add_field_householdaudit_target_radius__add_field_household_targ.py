...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'HouseholdAudit.target_radius'
        db.delete_column('bcpp_household_household_audit', 'target_radius')

        # Deleting field 'Household.target_radius'
        db.delete_column('bcpp_household_household', 'target_radius')
