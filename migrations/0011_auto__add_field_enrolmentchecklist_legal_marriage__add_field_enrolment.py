...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnrolmentChecklist.legal_marriage'
        db.add_column('bcpp_household_member_enrolmentchecklist', 'legal_marriage',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'EnrolmentChecklist.marriage_certificate'
        db.add_column('bcpp_household_member_enrolmentchecklist', 'marriage_certificate',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrolmentChecklist.marriage_certificate_no'
        db.add_column('bcpp_household_member_enrolmentchecklist', 'marriage_certificate_no',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrolmentChecklistAudit.legal_marriage'
        db.add_column('bcpp_household_member_enrolmentchecklist_audit', 'legal_marriage',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'EnrolmentChecklistAudit.marriage_certificate'
        db.add_column('bcpp_household_member_enrolmentchecklist_audit', 'marriage_certificate',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrolmentChecklistAudit.marriage_certificate_no'
        db.add_column('bcpp_household_member_enrolmentchecklist_audit', 'marriage_certificate_no',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnrolmentChecklist.legal_marriage'
        db.delete_column('bcpp_household_member_enrolmentchecklist', 'legal_marriage')

        # Deleting field 'EnrolmentChecklist.marriage_certificate'
        db.delete_column('bcpp_household_member_enrolmentchecklist', 'marriage_certificate')

        # Deleting field 'EnrolmentChecklist.marriage_certificate_no'
        db.delete_column('bcpp_household_member_enrolmentchecklist', 'marriage_certificate_no')

        # Deleting field 'EnrolmentChecklistAudit.legal_marriage'
        db.delete_column('bcpp_household_member_enrolmentchecklist_audit', 'legal_marriage')

        # Deleting field 'EnrolmentChecklistAudit.marriage_certificate'
        db.delete_column('bcpp_household_member_enrolmentchecklist_audit', 'marriage_certificate')

        # Deleting field 'EnrolmentChecklistAudit.marriage_certificate_no'
        db.delete_column('bcpp_household_member_enrolmentchecklist_audit', 'marriage_certificate_no')
