...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestCodeReference.panic_value_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'panic_value_quantifier', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TestCodeReference.age_low_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low_quantifier', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'TestCodeReference.age_high_unit'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high_unit', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'TestCodeReference.age_low_unit'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low_unit', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'TestCodeReference.age_high_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high_quantifier', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'TestCodeReference.panic_value_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'panic_value_quantifier', self.gf('django.db.models.fields.CharField')(default='', max_length=75))

        # Changing field 'TestCodeReference.age_low_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low_quantifier', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'TestCodeReference.age_high_unit'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high_unit', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'TestCodeReference.age_low_unit'
        db.alter_column('bhp_lab_core_testcodereference', 'age_low_unit', self.gf('django.db.models.fields.CharField')(max_length=75))

        # Changing field 'TestCodeReference.age_high_quantifier'
        db.alter_column('bhp_lab_core_testcodereference', 'age_high_quantifier', self.gf('django.db.models.fields.CharField')(max_length=75))


    models = {
        'bhp_lab_core.aliquot': {
            'Meta': {'object_name': 'Aliquot'},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 28, 53, 120443)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 11, 28, 53, 174488)'}),
        ...
        'bhp_lab_core.resultitem': {
            ...
            'validation_user': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
