...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_pregnancy', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 8, 0, 0))),
        ...
        m2m_table_name = db.shorten_name('bcpp_subject_pregnancy_family_planning')
        ...
        db.create_unique(m2m_table_name, ['pregnancy_id', 'familyplanning_id'])
        ...
        # Deleting field 'ReproductiveHealth.lnmp'
        db.delete_column('bcpp_subject_reproductivehealth', 'lnmp')
        ...
        # Adding field 'ReproductiveHealth.menopause'
        db.add_column('bcpp_subject_reproductivehealth', 'menopause',
        ...
        db.delete_table(db.shorten_name('bcpp_subject_reproductivehealth_family_planning'))

        # Deleting field 'HivTestingHistory.hiv_result'
        db.delete_column('bcpp_subject_hivtestinghistory', 'hiv_result')

        # Adding field 'HivTestingHistory.take_hiv_testing'
        db.add_column('bcpp_subject_hivtestinghistory', 'take_hiv_testing',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=75),
                      keep_default=False)

        # Adding field 'HivTestingHistory.when_hiv_test'
        db.add_column('bcpp_subject_hivtestinghistory', 'when_hiv_test',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HivTestingHistory.verbal_hiv_result'
        db.add_column('bcpp_subject_hivtestinghistory', 'verbal_hiv_result',
        ...
        # Changing field 'HivTestReviewAudit.hiv_test_date'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'hiv_test_date', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'HivTestReviewAudit.recorded_hiv_result'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'recorded_hiv_result', self.gf('django.db.models.fields.CharField')(default=0, max_length=30))
        # Adding field 'SubjectVisitAudit.subject_identifier'
        db.add_column('bcpp_subject_subjectvisit_audit', 'subject_identifier',
        ...
        # Deleting field 'ReproductiveHealthAudit.lnmp'
        db.delete_column('bcpp_subject_reproductivehealth_audit', 'lnmp')
        ...
        # Adding field 'ReproductiveHealthAudit.menopause'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'menopause',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)
        ...
        # Changing field 'HivTestReview.hiv_test_date'
        db.alter_column('bcpp_subject_hivtestreview', 'hiv_test_date', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'HivTestReview.recorded_hiv_result'
        db.alter_column('bcpp_subject_hivtestreview', 'recorded_hiv_result', self.gf('django.db.models.fields.CharField')(default=0, max_length=30))
        ...
        # Changing field 'ResidencyMobilityAudit.cattle_postlands'
        db.alter_column('bcpp_subject_residencymobility_audit', 'cattle_postlands', self.gf('django.db.models.fields.CharField')(max_length=25))
        # Adding field 'SubjectVisit.subject_identifier'
        db.add_column('bcpp_subject_subjectvisit', 'subject_identifier',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)


        # Changing field 'Education.money_forwork'
        db.alter_column('bcpp_subject_education', 'money_forwork', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        # Deleting field 'HivTestingHistoryAudit.hiv_result'
        db.delete_column('bcpp_subject_hivtestinghistory_audit', 'hiv_result')

        # Adding field 'HivTestingHistoryAudit.take_hiv_testing'
        db.add_column('bcpp_subject_hivtestinghistory_audit', 'take_hiv_testing',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=75),
                      keep_default=False)

        # Adding field 'HivTestingHistoryAudit.when_hiv_test'
        db.add_column('bcpp_subject_hivtestinghistory_audit', 'when_hiv_test',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HivTestingHistoryAudit.verbal_hiv_result'
        db.add_column('bcpp_subject_hivtestinghistory_audit', 'verbal_hiv_result',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)
        ...
        # Changing field 'ResidencyMobility.cattle_postlands'
        db.alter_column('bcpp_subject_residencymobility', 'cattle_postlands', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'EducationAudit.money_forwork'
        db.alter_column('bcpp_subject_education_audit', 'money_forwork', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('bcpp_subject_pregnancy_family_planning'))
        ...
        db.add_column('bcpp_subject_reproductivehealth', 'where_circ',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=70),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.hiv_last_pregnancy'
        db.add_column('bcpp_subject_reproductivehealth', 'hiv_last_pregnancy',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.anc_last_pregnancy'
        db.add_column('bcpp_subject_reproductivehealth', 'anc_last_pregnancy',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.more_children'
        db.add_column('bcpp_subject_reproductivehealth', 'more_children',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.anc_reg'
        db.add_column('bcpp_subject_reproductivehealth', 'anc_reg',
                      self.gf('django.db.models.fields.CharField')(max_length=55, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.preg_arv'
        db.add_column('bcpp_subject_reproductivehealth', 'preg_arv',
                      self.gf('django.db.models.fields.CharField')(max_length=95, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.lnmp'
        db.add_column('bcpp_subject_reproductivehealth', 'lnmp',
                      self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.last_birth'
        db.add_column('bcpp_subject_reproductivehealth', 'last_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.current_pregnant'
        db.add_column('bcpp_subject_reproductivehealth', 'current_pregnant',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'ReproductiveHealth.family_planning_other'
        db.add_column('bcpp_subject_reproductivehealth', 'family_planning_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Deleting field 'ReproductiveHealth.menopause'
        db.delete_column('bcpp_subject_reproductivehealth', 'menopause')

        # Adding M2M table for field family_planning on 'ReproductiveHealth'
        m2m_table_name = db.shorten_name('bcpp_subject_reproductivehealth_family_planning')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        # Adding field 'HivTestingHistory.hiv_result'
        db.add_column('bcpp_subject_hivtestinghistory', 'hiv_result',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=75),
                      keep_default=False)

        # Deleting field 'HivTestingHistory.take_hiv_testing'
        db.delete_column('bcpp_subject_hivtestinghistory', 'take_hiv_testing')

        # Deleting field 'HivTestingHistory.when_hiv_test'
        db.delete_column('bcpp_subject_hivtestinghistory', 'when_hiv_test')

        # Deleting field 'HivTestingHistory.verbal_hiv_result'
        db.delete_column('bcpp_subject_hivtestinghistory', 'verbal_hiv_result')

        # Adding field 'HivTestReviewAudit.verbal_hiv_result'
        db.add_column('bcpp_subject_hivtestreview_audit', 'verbal_hiv_result',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)

        # Adding field 'HivTestReviewAudit.when_hiv_test'
        db.add_column('bcpp_subject_hivtestreview_audit', 'when_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)


        # Changing field 'HivTestReviewAudit.hiv_test_date'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'hiv_test_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivTestReviewAudit.recorded_hiv_result'
        db.alter_column('bcpp_subject_hivtestreview_audit', 'recorded_hiv_result', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
        # Deleting field 'SubjectVisitAudit.subject_identifier'
        db.delete_column('bcpp_subject_subjectvisit_audit', 'subject_identifier')

        # Adding field 'ReproductiveHealthAudit.where_circ'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'where_circ',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=70),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.hiv_last_pregnancy'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'hiv_last_pregnancy',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.anc_last_pregnancy'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'anc_last_pregnancy',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.more_children'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'more_children',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.anc_reg'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'anc_reg',
                      self.gf('django.db.models.fields.CharField')(max_length=55, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.preg_arv'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'preg_arv',
                      self.gf('django.db.models.fields.CharField')(max_length=95, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.lnmp'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'lnmp',
                      self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.last_birth'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'last_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.current_pregnant'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'current_pregnant',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'ReproductiveHealthAudit.family_planning_other'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'family_planning_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Deleting field 'ReproductiveHealthAudit.menopause'
        db.delete_column('bcpp_subject_reproductivehealth_audit', 'menopause')

        # Adding field 'HivTestReview.when_hiv_test'
        db.add_column('bcpp_subject_hivtestreview', 'when_hiv_test',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'HivTestReview.verbal_hiv_result'
        db.add_column('bcpp_subject_hivtestreview', 'verbal_hiv_result',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)


        # Changing field 'HivTestReview.hiv_test_date'
        db.alter_column('bcpp_subject_hivtestreview', 'hiv_test_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivTestReview.recorded_hiv_result'
        db.alter_column('bcpp_subject_hivtestreview', 'recorded_hiv_result', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
        # Adding field 'ResidencyMobilityAudit.reason_away'
        db.add_column('bcpp_subject_residencymobility_audit', 'reason_away',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResidencyMobilityAudit.reason_away_other'
        db.add_column('bcpp_subject_residencymobility_audit', 'reason_away_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


        # Changing field 'ResidencyMobilityAudit.cattle_postlands'
        db.alter_column('bcpp_subject_residencymobility_audit', 'cattle_postlands', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Deleting field 'SubjectVisit.subject_identifier'
        db.delete_column('bcpp_subject_subjectvisit', 'subject_identifier')


        # Changing field 'Education.money_forwork'
        db.alter_column('bcpp_subject_education', 'money_forwork', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Adding field 'HivTestingHistoryAudit.hiv_result'
        db.add_column('bcpp_subject_hivtestinghistory_audit', 'hiv_result',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=75),
                      keep_default=False)

        # Deleting field 'HivTestingHistoryAudit.take_hiv_testing'
        db.delete_column('bcpp_subject_hivtestinghistory_audit', 'take_hiv_testing')

        # Deleting field 'HivTestingHistoryAudit.when_hiv_test'
        db.delete_column('bcpp_subject_hivtestinghistory_audit', 'when_hiv_test')

        # Deleting field 'HivTestingHistoryAudit.verbal_hiv_result'
        db.delete_column('bcpp_subject_hivtestinghistory_audit', 'verbal_hiv_result')

        # Adding field 'ResidencyMobility.reason_away'
        db.add_column('bcpp_subject_residencymobility', 'reason_away',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResidencyMobility.reason_away_other'
        db.add_column('bcpp_subject_residencymobility', 'reason_away_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


        # Changing field 'ResidencyMobility.cattle_postlands'
        db.alter_column('bcpp_subject_residencymobility', 'cattle_postlands', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'EducationAudit.money_forwork'
        db.alter_column('bcpp_subject_education_audit', 'money_forwork', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'bcpp_subject.education': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'money_forwork': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'}),
        ...
        'bcpp_subject.hivtestinghistory': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'take_hiv_testing': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
