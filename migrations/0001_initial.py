...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_core_receive', (
            ...
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_patient.Patient'])),
            ('datetime_drawn', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('receive_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 29, 23, 57, 35, 764089), db_index=True)),
        ...
        db.send_create_signal('bhp_lab_receive', ['Receive'])
    ...
    models = {
        ...
        'bhp_lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 35, 764089)', 'db_index': 'True'}),
