...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_core_resultitem_audit', (
            ...
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_resultitem', to=orm['bhp_lab_result.Result'])),
            ...
            ('result_item_source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_resultitem', to=orm['bhp_lab_result.ResultSource'])),
        ...
        db.send_create_signal('bhp_lab_result_item', ['ResultItemAudit'])
        ...
        db.create_table('bhp_lab_core_resultitem', (
            ...
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_result.Result'])),
            ...
            ('validation_reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('result_item_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_result.ResultSource'])),
            ('result_item_source_reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('error_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal('bhp_lab_result_item', ['ResultItem'])
    ...
    models = {
        ...
        'bhp_lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 46, 567943)'}),
        ...
        'bhp_lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 46, 562657)', 'db_index': 'True'}),
        ...
        'bhp_lab_result_item.resultitem': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_result.Result']"}),
            ...
            'result_item_source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_result.ResultSource']"}),
        ...
        'bhp_lab_result_item.resultitemaudit': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_resultitem'", 'to': "orm['bhp_lab_result.Result']"}),
            'result_item_datetime': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'result_item_operator': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'result_item_quantifier': ('django.db.models.fields.CharField', [], {'default': "'='", 'max_length': '25'}),
            'result_item_source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_resultitem'", 'to': "orm['bhp_lab_result.ResultSource']"}),
            'result_item_source_reference': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'result_item_value': ('django.db.models.fields.CharField', [], {'max_length': '25', 'db_index': 'True'}),
    ...
    complete_apps = ['bhp_lab_result_item']
