...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_core_aliquottype', (
            ...
            ('alpha_code', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('numeric_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('dmis_reference', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table('bhp_lab_core_aliquot', (
            ...
            ('aliquot_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 13, 38, 13, 340726))),
        ...
        db.create_table('bhp_lab_core_result', (
            ...
            ('assay_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('result_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_core.ResultSource'])),
            ('result_source_reference', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        ...
        db.create_table('bhp_lab_core_resultitem_audit', (
            ...
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('result_item_source', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
        ...
        db.create_table('bhp_lab_core_dmisimporthistory', (
            ...
            ('import_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 13, 38, 13, 377435))),
        ))
    ...
    models = {
        'bhp_lab_core.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 13, 38, 13, 340726)'}),
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 13, 38, 13, 377435)'}),
