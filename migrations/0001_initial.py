...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_aliquot', (
            ...
            ('condition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.AliquotCondition'])),
        ...
        db.create_table('bhp_lab_receive', (
            ...
            ('specimen_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['models.SpecimenType'])),
    ...
    models = {
        'bhp_lab.aliquot': {
            ...
            'condition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab.AliquotCondition']"}),
        ...
        'bhp_lab.receive': {
            ...
            'specimen_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['models.SpecimenType']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_lab.result': {
        ...
        'models.specimentype': {
            'Meta': {'ordering': "['display_index']", 'object_name': 'SpecimenType'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'display_index': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'field_name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'dmc3'", 'max_length': '50', 'blank': 'True'}),
