...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_lab_result', ['ResultSource'])
        ...
        db.create_table('bhp_lab_core_result', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_order.Order'])),
        ...
        db.send_create_signal('bhp_lab_result', ['Result'])
    ...
    models = {
        ...
        'bhp_lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 41, 735321)'}),
        ...
        'bhp_lab_order.order': {
            ...
            'aliquot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_aliquot.Aliquot']"}),
        ...
        'bhp_lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 41, 729464)', 'db_index': 'True'}),
        ...
        'bhp_lab_result.result': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_order.Order']"}),
