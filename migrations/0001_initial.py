...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_dispatch_dispatch', (
            ...
            ('is_dispatched', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dispatched_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dispatch_items', self.gf('django.db.models.fields.TextField')(max_length=500)),
        ))
        db.send_create_signal('bhp_dispatch', ['Dispatch'])

        # Adding model 'DispatchItem'
        db.create_table('bhp_dispatch_dispatchitem', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('is_dispatched', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dispatched_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('dispatch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.Dispatch'], null=True)),
            ('item_identifier', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('bhp_dispatch', ['DispatchItem'])


    def backwards(self, orm):
        # Deleting model 'Dispatch'
        db.delete_table('bhp_dispatch_dispatch')

        # Deleting model 'DispatchItem'
        db.delete_table('bhp_dispatch_dispatchitem')
