...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_household_member_householdmember', (
            ...
            ('is_eligible_member', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('target', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('household_structure', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household.HouseholdStructure'], unique=True, null=True, blank=True)),
    ...
    models = {
        ...
        'bcpp_household_member.householdmember': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'honeypot'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'honeypot'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_structure': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_household.HouseholdStructure']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
