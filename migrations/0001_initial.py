...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_lab_order', ['OrderIdentifierTracker'])
        ...
        db.create_table('bhp_lab_core_order', (
            ...
            ('aliquot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_aliquot.Aliquot'])),
        ...
        db.send_create_signal('bhp_lab_order', ['Order'])
    ...
    models = {
        ...
        'bhp_lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 27, 822016)'}),
        ...
        'bhp_lab_order.orderidentifiertracker': {
        ...
        'bhp_lab_receive.receive': {
            ...
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 27, 816574)', 'db_index': 'True'}),
