...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_lab_patient', ['SimpleConsent'])
        ...
        db.send_create_signal('bhp_lab_patient', ['Patient'])
        ...
        db.create_table('bhp_lab_registration_patient_account', (
            ...
            ('patient', models.ForeignKey(orm['bhp_lab_patient.patient'], null=False)),
        ...
        db.create_table('bhp_lab_registration_patient_simple_consent', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patient', models.ForeignKey(orm['bhp_lab_patient.patient'], null=False)),
            ('simpleconsent', models.ForeignKey(orm['bhp_lab_patient.simpleconsent'], null=False))
        ))
