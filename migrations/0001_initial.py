...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('bhp_lab_aliquot', ['AliquotType'])
        ...
        db.send_create_signal('bhp_lab_aliquot', ['AliquotCondition'])
        ...
        db.create_table('bhp_lab_core_aliquot', (
            ...
            ('aliquot_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 29, 23, 57, 21, 508948))),
            ('receive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_receive.Receive'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('parent_identifier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_aliquot.Aliquot'], to_field='aliquot_identifier', null=True, blank=True)),
            ('aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab_aliquot.AliquotType'])),
            ...
            ('condition', self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['bhp_lab_aliquot.AliquotCondition'])),
        ...
        db.send_create_signal('bhp_lab_aliquot', ['Aliquot'])
    ...
    models = {
        ...
        'bhp_lab_aliquot.aliquot': {
            'Meta': {'object_name': 'Aliquot', 'db_table': "'bhp_lab_core_aliquot'"},
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 21, 508948)'}),
            'aliquot_identifier': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
            'aliquot_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_aliquot.AliquotType']"}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'condition': ('django.db.models.fields.related.ForeignKey', [], {'default': '10', 'to': "orm['bhp_lab_aliquot.AliquotCondition']"}),
            ...
            'parent_identifier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_aliquot.Aliquot']", 'to_field': "'aliquot_identifier'", 'null': 'True', 'blank': 'True'}),
            'receive': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_receive.Receive']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'available'", 'max_length': '25'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_lab_aliquot.aliquotcondition': {
        ...
        'bhp_lab_patient.patient': {
            ...
            'account': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['bhp_lab_account.Account']", 'null': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'simple_consent': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['bhp_lab_patient.SimpleConsent']", 'null': 'True', 'blank': 'True'}),
            'subject_identifier': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25', 'db_index': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_lab_patient.simpleconsent': {
        ...
        'bhp_lab_receive.receive': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_lab_patient.Patient']"}),
            'protocol': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_research_protocol.Protocol']"}),
            'receive_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 29, 23, 57, 21, 501976)', 'db_index': 'True'}),
