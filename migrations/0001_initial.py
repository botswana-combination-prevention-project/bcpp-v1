...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_subject_subjectconsent_audit', (
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsent', null=True, to=orm['bhp_registration.RegisteredSubject'])),
        ))
        ...
        db.create_table(u'bcpp_subject_subjectconsent', (
            ...
            ('survey', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_survey.Survey'], unique=True)),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'bcpp_subject_subjectlocator_audit', (
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s030', max_length=50, db_index=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('date_signed', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
        ...
        db.create_table(u'bcpp_subject_recentpartner_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_recentpartner', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_secondpartner_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_secondpartner', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_thirdpartner_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_thirdpartner', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_baselinehouseholdsurvey_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_baselinehouseholdsurvey', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        m2m_table_name = db.shorten_name(u'bcpp_subject_baselinehouseholdsurvey_electrical_appliances')
        ...
        db.create_unique(m2m_table_name, ['baselinehouseholdsurvey_id', 'electricalappliances_id'])

        # Adding M2M table for field transport_mode on 'BaselineHouseholdSurvey'
        m2m_table_name = db.shorten_name(u'bcpp_subject_baselinehouseholdsurvey_transport_mode')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baselinehouseholdsurvey', models.ForeignKey(orm['bcpp_subject.baselinehouseholdsurvey'], null=False)),
            ('transportmode', models.ForeignKey(orm['bcpp_list.transportmode'], null=False))
        ))
        db.create_unique(m2m_table_name, ['baselinehouseholdsurvey_id', 'transportmode_id'])

        # Adding model 'CeaEnrolmentChecklistAudit'
        db.create_table(u'bcpp_subject_ceaenrolmentchecklist_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_ceaenrolmentchecklist', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_enrolmentchecklist_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_enrolmentchecklist', to=orm['bhp_registration.RegisteredSubject'])),
        ))
        db.send_create_signal('bcpp_subject', ['EnrolmentChecklistAudit'])

        # Adding model 'EnrolmentChecklist'
        db.create_table(u'bcpp_subject_enrolmentchecklist', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['EnrolmentChecklist'])
        ...
        db.create_table(u'bcpp_subject_hivtested_audit', (
            ...
            ('arvs_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
        ...
        db.create_table(u'bcpp_subject_futurehivtesting_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('prefer_hivtest', self.gf('django.db.models.fields.CharField')(max_length=70, null=True)),
            ('hiv_test_time', self.gf('django.db.models.fields.CharField')(max_length=35, null=True)),
            ('hiv_test_time_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('hiv_test_week', self.gf('django.db.models.fields.CharField')(max_length=35, null=True)),
            ('hiv_test_week_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('hiv_test_year', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('hiv_test_year_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table(u'bcpp_subject_futurehivtesting', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_monthsrecentpartner_audit', (
            ...
            ('partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.create_table(u'bcpp_subject_uncircumcised_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('circumcised', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('reason_circ', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('future_circ', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('circumcision_day', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('circumcision_day_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('circumcision_week', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('circumcision_week_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('circumcision_year', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('circumcision_year_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('future_reasons_smc', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
            ('service_facilities', self.gf('django.db.models.fields.CharField')(max_length=15, null=True)),
        ...
        db.create_table(u'bcpp_subject_medicaldiagnoses_audit', (
            ...
            ('sti_record', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
        ...
        db.create_table(u'bcpp_subject_sti_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('sti_date', self.gf('django.db.models.fields.DateField')()),
            ('sti_dx', self.gf('django.db.models.fields.CharField')(max_length=65)),
        ...
        db.create_table(u'bcpp_subject_pregnancy_audit', (
            ...
            ('hiv_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('preg_arv', self.gf('django.db.models.fields.CharField')(max_length=95, null=True)),
        ...
        db.create_table(u'bcpp_subject_subjectrefusal_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectrefusal', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectabsentee_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_unique(u'bcpp_subject_subjectabsentee', ['registered_subject_id', 'survey_id'])

        # Adding model 'SubjectAbsenteeReportAudit'
        db.create_table(u'bcpp_subject_subjectabsenteereport_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectabsenteereport', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectabsenteeentry_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectabsenteeentry', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_unique(u'bcpp_subject_subjectabsenteeentry', ['subject_absentee_id', 'report_datetime'])

        # Adding model 'SubjectMovedAudit'
        db.create_table(u'bcpp_subject_subjectmoved_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectmoved', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table(u'bcpp_subject_subjectundecided_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s030', max_length=50, db_index=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectundecided', null=True, to=orm['bhp_registration.RegisteredSubject'])),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectUndecidedAudit'])

        # Adding model 'SubjectUndecided'
        db.create_table(u'bcpp_subject_subjectundecided', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectUndecided'])

        # Adding unique constraint on 'SubjectUndecided', fields ['registered_subject', 'survey']
        db.create_unique(u'bcpp_subject_subjectundecided', ['registered_subject_id', 'survey_id'])

        # Adding model 'SubjectUndecidedEntryAudit'
        db.create_table(u'bcpp_subject_subjectundecidedentry_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('contact_details', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True, blank=True)),
            ('subject_undecided', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectundecidedentry', to=orm['bcpp_subject.SubjectUndecided'])),
            ('subject_undecided_reason', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectUndecidedEntryAudit'])

        # Adding model 'SubjectUndecidedEntry'
        db.create_table(u'bcpp_subject_subjectundecidedentry', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('contact_details', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True, blank=True)),
            ('subject_undecided', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_subject.SubjectUndecided'])),
            ('subject_undecided_reason', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('bcpp_subject', ['SubjectUndecidedEntry'])

        # Adding unique constraint on 'SubjectUndecidedEntry', fields ['subject_undecided', 'report_datetime']
        db.create_unique(u'bcpp_subject_subjectundecidedentry', ['subject_undecided_id', 'report_datetime'])
        ...
        db.create_table(u'bcpp_subject_subjectreferral_audit', (
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s030', max_length=50, db_index=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectreferral', null=True, to=orm['bhp_registration.RegisteredSubject'])),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectreferral', to=orm['bcpp_survey.Survey'])),
            ('subject_referral_reason', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('subject_referral_reason_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('next_appt_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('referral_result', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('in_clinic', self.gf('django.db.models.fields.CharField')(default='No', max_length=10)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectreferral', to=orm['bcpp_household_member.HouseholdMember'])),
        ))
        ...
        db.create_table(u'bcpp_subject_pima_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('cd4_value', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('draw_time', self.gf('django.db.models.fields.TimeField')()),
            ('is_drawn', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_drawn_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        # Adding model 'BloodDrawAudit'
        db.create_table(u'bcpp_subject_blooddraw_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
            ('draw_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_blood_drawn', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_blood_drawn_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_blooddraw', to=orm['bcpp_subject.SubjectVisit'])),
        ))
        db.send_create_signal('bcpp_subject', ['BloodDrawAudit'])

        # Adding model 'BloodDraw'
        db.create_table(u'bcpp_subject_blooddraw', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['BloodDraw'])

        # Adding unique constraint on 'BloodDraw', fields ['subject_visit', 'report_datetime']
        db.create_unique(u'bcpp_subject_blooddraw', ['subject_visit_id', 'report_datetime'])


    def backwards(self, orm):
        # Removing unique constraint on 'BloodDraw', fields ['subject_visit', 'report_datetime']
        db.delete_unique(u'bcpp_subject_blooddraw', ['subject_visit_id', 'report_datetime'])
        ...
        db.delete_table(u'bcpp_subject_baselinehouseholdsurvey_audit')

        # Deleting model 'BaselineHouseholdSurvey'
        db.delete_table(u'bcpp_subject_baselinehouseholdsurvey')

        # Removing M2M table for field electrical_appliances on 'BaselineHouseholdSurvey'
        db.delete_table(db.shorten_name(u'bcpp_subject_baselinehouseholdsurvey_electrical_appliances'))

        # Removing M2M table for field transport_mode on 'BaselineHouseholdSurvey'
        db.delete_table(db.shorten_name(u'bcpp_subject_baselinehouseholdsurvey_transport_mode'))

        # Deleting model 'CeaEnrolmentChecklistAudit'
        db.delete_table(u'bcpp_subject_ceaenrolmentchecklist_audit')

        # Deleting model 'CeaEnrolmentChecklist'
        db.delete_table(u'bcpp_subject_ceaenrolmentchecklist')

        # Deleting model 'EnrolmentChecklistAudit'
        db.delete_table(u'bcpp_subject_enrolmentchecklist_audit')

        # Deleting model 'EnrolmentChecklist'
        db.delete_table(u'bcpp_subject_enrolmentchecklist')
        ...
        db.delete_table(u'bcpp_subject_futurehivtesting_audit')

        # Deleting model 'FutureHivTesting'
        db.delete_table(u'bcpp_subject_futurehivtesting')
        ...
        db.delete_table(u'bcpp_subject_subjectrefusal_audit')

        # Deleting model 'SubjectRefusal'
        db.delete_table(u'bcpp_subject_subjectrefusal')
        ...
        db.delete_table(u'bcpp_subject_subjectabsenteereport_audit')

        # Deleting model 'SubjectAbsenteeReport'
        db.delete_table(u'bcpp_subject_subjectabsenteereport')
        ...
        db.delete_table(u'bcpp_subject_subjectmoved_audit')

        # Deleting model 'SubjectMoved'
        db.delete_table(u'bcpp_subject_subjectmoved')

        # Deleting model 'SubjectUndecidedAudit'
        db.delete_table(u'bcpp_subject_subjectundecided_audit')

        # Deleting model 'SubjectUndecided'
        db.delete_table(u'bcpp_subject_subjectundecided')

        # Deleting model 'SubjectUndecidedEntryAudit'
        db.delete_table(u'bcpp_subject_subjectundecidedentry_audit')

        # Deleting model 'SubjectUndecidedEntry'
        db.delete_table(u'bcpp_subject_subjectundecidedentry')
        ...
        # Deleting model 'BloodDrawAudit'
        db.delete_table(u'bcpp_subject_blooddraw_audit')

        # Deleting model 'BloodDraw'
        db.delete_table(u'bcpp_subject_blooddraw')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 0, 0)'}),
        ...
        'bcpp_subject.baselinehouseholdsurveyaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'BaselineHouseholdSurveyAudit', 'db_table': "u'bcpp_subject_baselinehouseholdsurvey_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'cattle_owned': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.blooddrawaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'BloodDrawAudit', 'db_table': "u'bcpp_subject_blooddraw_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.ceaenrolmentchecklistaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'CeaEnrolmentChecklistAudit', 'db_table': "u'bcpp_subject_ceaenrolmentchecklist_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'cd4_count': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
        ...
        'bcpp_subject.circumcised': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'health_benefits_smc': ('django.db.models.fields.related.ManyToManyField', [], {'max_length': '25', 'to': "orm['bcpp_list.CircumcisionBenefits']", 'null': 'True', 'symmetrical': 'False'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'s030'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'s030'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.enrolmentchecklist': {
        ...
        'bcpp_subject.enrolmentchecklistaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'EnrolmentChecklistAudit', 'db_table': "u'bcpp_subject_enrolmentchecklist_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'census_number': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
        ...
        'bcpp_subject.hivtested': {
            ...
            'arvs_hiv_test': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.recentpartneraudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RecentPartnerAudit', 'db_table': "u'bcpp_subject_recentpartner_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'alcohol_before_sex': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        'bcpp_subject.secondpartneraudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SecondPartnerAudit', 'db_table': "u'bcpp_subject_secondpartner_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'alcohol_before_sex': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        'bcpp_subject.subjectabsenteeaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectAbsenteeAudit', 'db_table': "u'bcpp_subject_subjectabsentee_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectabsenteeentryaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectAbsenteeEntryAudit', 'db_table': "u'bcpp_subject_subjectabsenteeentry_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectabsenteereportaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectAbsenteeReportAudit', 'db_table': "u'bcpp_subject_subjectabsenteereport_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectconsent': {
            ...
            'survey': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_survey.Survey']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 29, 0, 0)'}),
        ...
        'bcpp_subject.subjectmovedaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectMovedAudit', 'db_table': "u'bcpp_subject_subjectmoved_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'area_moved': ('django.db.models.fields.CharField', [], {'max_length': '35'}),
        ...
        'bcpp_subject.subjectrefusalaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectRefusalAudit', 'db_table': "u'bcpp_subject_subjectrefusal_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'age': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
        ...
        'bcpp_subject.subjectundecidedaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectUndecidedAudit', 'db_table': "u'bcpp_subject_subjectundecided_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectundecidedentryaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectUndecidedEntryAudit', 'db_table': "u'bcpp_subject_subjectundecidedentry_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.thirdpartneraudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ThirdPartnerAudit', 'db_table': "u'bcpp_subject_thirdpartner_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'alcohol_before_sex': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        'bcpp_subject.uncircumcised': {
            ...
            'circumcised': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'circumcision_day': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'circumcision_day_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            'circumcision_week': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'circumcision_week_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'null': 'True', 'blank': 'True'}),
            'circumcision_year': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            ...
            'future_reasons_smc': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'health_benefits_smc': ('django.db.models.fields.related.ManyToManyField', [], {'max_length': '25', 'to': "orm['bcpp_list.CircumcisionBenefits']", 'null': 'True', 'symmetrical': 'False'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'s030'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'s030'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'reason_circ': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 0, 0)'}),
            'service_facilities': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
