...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_test', (
            ...
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='dmc3', max_length=50, blank=True)),
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='dmc3', max_length=50, blank=True)),
            ('test_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ...
        # Adding M2M table for field test on 'Panel'
        db.create_table('bhp_lab_panel_test', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panel', models.ForeignKey(orm['bhp_lab.panel'], null=False)),
            ('test', models.ForeignKey(orm['bhp_lab.test'], null=False))
        ))
        db.create_unique('bhp_lab_panel_test', ['panel_id', 'test_id'])
        ...
        db.create_table('bhp_lab_result', (
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='dmc3', max_length=50, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.Order'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field test on 'Panel'
        db.delete_table('bhp_lab_panel_test')
    ...
    models = {
        ...
        'bhp_lab.panel': {
            ...
            'test': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bhp_lab.Test']", 'symmetrical': 'False'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_lab.receive': {
        ...
        'bhp_lab.test': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'test_code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
            'test_name': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
