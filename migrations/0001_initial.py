...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_lab_aliquottype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='s018', max_length=50, blank=True)),
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s018', max_length=50, blank=True)),
        ...
        db.send_create_signal('bhp_lab', ['AliquotType'])

        # Adding model 'AliquotCondition'
        db.create_table('bhp_lab_aliquotcondition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('bhp_lab', ['AliquotCondition'])

        # Adding model 'Aliquot'
        db.create_table('bhp_lab_aliquot', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('id_int', self.gf('django.db.models.fields.IntegerField')()),
            ('id_seed', self.gf('django.db.models.fields.IntegerField')()),
            ('aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.AliquotType'])),
            ('aliquot_volume', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('aliquot_condition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.AliquotCondition'])),
        ))
        db.send_create_signal('bhp_lab', ['Aliquot'])

        # Adding model 'TestGroup'
        db.create_table('bhp_lab_testgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('bhp_lab', ['TestGroup'])
        ...
        db.create_table('bhp_lab_testmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('local_test_code', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.TestCode'])),
        ))
        db.send_create_signal('bhp_lab', ['TestMap'])

        # Adding model 'Panel'
        db.create_table('bhp_lab_panel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('bhp_lab', ['Panel'])

        # Adding M2M table for field test_code on 'Panel'
        db.create_table('bhp_lab_panel_test_code', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('panel', models.ForeignKey(orm['bhp_lab.panel'], null=False)),
            ('testcode', models.ForeignKey(orm['bhp_lab.testcode'], null=False))
        ))
        db.create_unique('bhp_lab_panel_test_code', ['panel_id', 'testcode_id'])
        ...
        db.create_table('bhp_lab_order', (
            ...
            ('aliquot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.Aliquot'])),
            ('panel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.Panel'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal('bhp_lab', ['Order'])

        # Adding model 'Receive'
        db.create_table('bhp_lab_receive', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s018', max_length=50, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('aliquot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bhp_lab.Aliquot'], unique=True)),
        ...
        db.send_create_signal('bhp_lab', ['Receive'])

        # Adding model 'Result'
        db.create_table('bhp_lab_result', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
        ...
        db.send_create_signal('bhp_lab', ['Result'])

        # Adding model 'ResultItem'
        db.create_table('bhp_lab_resultitem', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='s018', max_length=50, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_lab.Result'])),
        ...
        db.send_create_signal('bhp_lab', ['ResultItem'])


    def backwards(self, orm):
        
        # Deleting model 'AliquotType'
        db.delete_table('bhp_lab_aliquottype')

        # Deleting model 'AliquotCondition'
        db.delete_table('bhp_lab_aliquotcondition')

        # Deleting model 'Aliquot'
        db.delete_table('bhp_lab_aliquot')

        # Deleting model 'TestGroup'
        db.delete_table('bhp_lab_testgroup')

        # Deleting model 'TestCode'
        db.delete_table('bhp_lab_testcode')

        # Deleting model 'TestMap'
        db.delete_table('bhp_lab_testmap')

        # Deleting model 'Panel'
        db.delete_table('bhp_lab_panel')

        # Removing M2M table for field test_code on 'Panel'
        db.delete_table('bhp_lab_panel_test_code')
        ...
        db.delete_table('bhp_lab_order')

        # Deleting model 'Receive'
        db.delete_table('bhp_lab_receive')

        # Deleting model 'Result'
        db.delete_table('bhp_lab_result')

        # Deleting model 'ResultItem'
        db.delete_table('bhp_lab_resultitem')
    ...
    models = {
        'bhp_lab.aliquot': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'s018'", 'max_length': '50', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'s018'", 'max_length': '50', 'blank': 'True'}),
        ...
        'bhp_lab.panel': {
            ...
            'test_code': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bhp_lab.TestCode']", 'symmetrical': 'False'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'})
        },
        'bhp_lab.receive': {
