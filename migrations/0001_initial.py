...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_subjectconsent_audit', (
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsent', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        ...
        db.create_table('bcpp_subject_subjectconsent', (
            ...
            ('household_structure_member', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household.HouseholdStructureMember'], unique=True)),
        ...
        db.create_table('bcpp_subject_subjectlocator_audit', (
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='mac.local', max_length=50, db_index=True, blank=True)),
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('date_signed', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
        ...
        db.create_table('bcpp_subject_recentpartner_audit', (
            ...
            ('having_sex', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ...
        db.create_table('bcpp_subject_residencymobility_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('forteennights', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('intendresidency', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('nightsaway', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('cattlepostlands', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('cattlepostlands_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('reasonaway', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('reasonaway_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_demographics_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('religion', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ...
            ('maritalstatus', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('numwives', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        # Adding M2M table for field livewith on 'Demographics'
        db.create_table('bcpp_subject_demographics_livewith', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('bcpp_subject_demographics_livewith', ['demographics_id', 'livewith_id'])
        ...
        db.create_table('bcpp_subject_communityengagement_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('communityengagement', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('voteengagement', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('solveengagement', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        # Adding M2M table for field problemsengagement on 'CommunityEngagement'
        db.create_table('bcpp_subject_communityengagement_problemsengagement', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('bcpp_subject_communityengagement_problemsengagement', ['communityengagement_id', 'neighbourhoodproblems_id'])
        ...
        db.create_table('bcpp_subject_education_audit', (
            ...
            ('employment', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('moneyforwork', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('seekingwork', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivtestinghistory_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('hiv_result', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('why_not_tested', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('has_tested', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('has_record', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivtestreview_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('hivtestdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('recordedhivresult', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('whenhivtest', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('verbalhivresult', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivtested_audit', (
            ...
            ('arvshivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('numhivtests', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('wherehivtest', self.gf('django.db.models.fields.CharField')(max_length=85, null=True, blank=True)),
            ('whyhivtest', self.gf('django.db.models.fields.CharField')(max_length=105, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivuntested_audit', (
            ...
            ('hiv_pills', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('arvshivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=55, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_futurehivtesting_audit', (
            ...
            ('hivtest_time', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('hivtest_time_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('hivtest_week', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('hivtest_week_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('hivtest_year', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('hivtest_year_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_sexualbehaviour_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('eversex', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('lastyearpartners', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('moresex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('firstsex', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ...
            ('lastsex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('lastsex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_monthsrecentpartner_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('first_partner_live', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('first_partner_hiv', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('first_haart', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('first_disclose', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('first_condom_freq', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('first_partner_cp', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_hivcareadherence_audit', (
            ...
            ('why_no_arv', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
        ...
        db.create_table('bcpp_subject_circumcised_audit', (
            ...
            ('where_circ', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('why_circ', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_uncircumcised_audit', (
            ...
            ('aware_free', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_reproductivehealth_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('numberchildren', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('morechildren', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('wherecirc', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('currentpregnant', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('ancreg', self.gf('django.db.models.fields.CharField')(max_length=55, null=True, blank=True)),
            ('lnmp', self.gf('django.db.models.fields.DateField')(max_length=25, null=True, blank=True)),
            ('lastbirth', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('anclastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('hivlastpregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('pregARV', self.gf('django.db.models.fields.CharField')(max_length=95, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_medicaldiagnoses_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('heartattack', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('heartattackrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('dateheartattack', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('dxheartattack', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True)),
            ('cancer', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('cancerrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('datecancer', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('dxcancer', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True)),
            ('sti', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('tb', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('tbrecord', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ('datetb', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('dxTB', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_stigma_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('anticipatestigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedshamestigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('salivastigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('teacherstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('childrenstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_stigmaopinion_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('testcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('gossipcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('respectcommunitystigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedverbalstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedphyicalstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedfamilystigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('fearstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_positiveparticipant_audit', (
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 25, 0, 0))),
            ('internalize1stigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('internalized2stigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('friendstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('familystigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedtalkstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedrespectstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('enactedjobstigma', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ...
        db.create_table('bcpp_subject_subjectrefusal_audit', (
            ...
            ('lengthresidence', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('refusal_date', self.gf('django.db.models.fields.DateField')()),
            ('whynoparticipate', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whynoparticipate_other', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True)),
            ('subject_refusal_status', self.gf('django.db.models.fields.CharField')(default='REFUSED', max_length=25)),
            ('hivtesttoday', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('whynohivtest', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectrefusal', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        ...
        db.create_table('bcpp_subject_subjectabsentee_audit', (
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectabsentee', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
        ...
        db.create_table('bcpp_subject_subjectmoved_audit', (
            ...
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('household_structure_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectmoved', to=orm['bcpp_household.HouseholdStructureMember'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field livewith on 'Demographics'
        db.delete_table('bcpp_subject_demographics_livewith')
        ...
        # Removing M2M table for field problemsengagement on 'CommunityEngagement'
        db.delete_table('bcpp_subject_communityengagement_problemsengagement')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
        ...
        'bcpp_subject.communityengagement': {
            ...
            'communityengagement': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'problemsengagement': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bcpp_list.NeighbourhoodProblems']", 'symmetrical': 'False'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
            'solveengagement': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'voteengagement': ('django.db.models.fields.CharField', [], {'max_length': '25'})
        },
        ...
        'bcpp_subject.demographics': {
            ...
            'maritalstatus': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.education': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'moneyforwork': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
            'seekingwork': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_subject.hivtested': {
            ...
            'arvshivtest': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.hivtestinghistory': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'has_record': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'why_not_tested': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'})
        },
        ...
        'bcpp_subject.hivtestreview': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hivtestdate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_subject.residencymobility': {
            ...
            'cattlepostlands': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'cattlepostlands_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'forteennights': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'intendresidency': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'lengthresidence': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'nightsaway': ('django.db.models.fields.CharField', [], {'max_length': '35'}),
            'reasonaway': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'reasonaway_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)'}),
