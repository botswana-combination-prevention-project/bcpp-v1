...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bhp_supplimental_fields_excluded', (
        ...
        db.send_create_signal('bhp_supplimental_fields', ['Excluded'])


    def backwards(self, orm):
        # Deleting model 'Excluded'
        db.delete_table('bhp_supplimental_fields_excluded')


    models = {
        'bhp_supplimental_fields.excluded': {
    ...
    complete_apps = ['bhp_supplimental_fields']