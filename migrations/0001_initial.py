...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_lab_packinglist', (
            ...
            ('list_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 12, 16, 40, 35, 636410))),
        ...
        db.create_table('bcpp_lab_subjectrequisition_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table('bcpp_lab_subjectrequisition', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_table('bcpp_lab_subjectrequisition_test_code', (
        ...
        db.create_unique('bcpp_lab_subjectrequisition_test_code', ['subjectrequisition_id', 'testcode_id'])

        # Adding model 'PackingListItem'
        db.create_table('bcpp_lab_packinglistitem', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bcpp_lab_packinglist')

        # Deleting model 'SubjectRequisitionAudit'
        db.delete_table('bcpp_lab_subjectrequisition_audit')

        # Deleting model 'SubjectRequisition'
        db.delete_table('bcpp_lab_subjectrequisition')

        # Removing M2M table for field test_code on 'SubjectRequisition'
        db.delete_table('bcpp_lab_subjectrequisition_test_code')

        # Deleting model 'PackingListItem'
        db.delete_table('bcpp_lab_packinglistitem')
    ...
    models = {
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 16, 40, 35, 636410)'}),
