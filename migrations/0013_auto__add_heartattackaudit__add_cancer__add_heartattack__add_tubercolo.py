...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_heartattack_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 9, 0, 0))),
        ...
        m2m_table_name = db.shorten_name('bcpp_subject_heartattack_dx_heart_attack')
        ...
        # Deleting field 'MedicalDiagnoses.cancer'
        db.delete_column('bcpp_subject_medicaldiagnoses', 'cancer')
        ...
        # Deleting field 'MedicalDiagnoses.tb'
        db.delete_column('bcpp_subject_medicaldiagnoses', 'tb')
        ...
        # Removing M2M table for field dx_heart_attack on 'MedicalDiagnoses'
        db.delete_table(db.shorten_name('bcpp_subject_medicaldiagnoses_dx_heart_attack'))

        # Adding M2M table for field diagnoses on 'MedicalDiagnoses'
        m2m_table_name = db.shorten_name('bcpp_subject_medicaldiagnoses_diagnoses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        # Deleting field 'MedicalDiagnosesAudit.cancer'
        db.delete_column('bcpp_subject_medicaldiagnoses_audit', 'cancer')
        ...
        # Deleting field 'MedicalDiagnosesAudit.tb'
        db.delete_column('bcpp_subject_medicaldiagnoses_audit', 'tb')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('bcpp_subject_heartattack_dx_heart_attack'))
        ...
        # Adding field 'MedicalDiagnoses.cancer'
        db.add_column('bcpp_subject_medicaldiagnoses', 'cancer',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.dx_tb'
        db.add_column('bcpp_subject_medicaldiagnoses', 'dx_tb',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.dx_cancer'
        db.add_column('bcpp_subject_medicaldiagnoses', 'dx_cancer',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.tb'
        db.add_column('bcpp_subject_medicaldiagnoses', 'tb',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.date_heart_attack'
        db.add_column('bcpp_subject_medicaldiagnoses', 'date_heart_attack',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.date_tb'
        db.add_column('bcpp_subject_medicaldiagnoses', 'date_tb',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.date_cancer'
        db.add_column('bcpp_subject_medicaldiagnoses', 'date_cancer',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnoses.heart_attack'
        db.add_column('bcpp_subject_medicaldiagnoses', 'heart_attack',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding M2M table for field dx_heart_attack on 'MedicalDiagnoses'
        m2m_table_name = db.shorten_name('bcpp_subject_medicaldiagnoses_dx_heart_attack')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('medicaldiagnoses', models.ForeignKey(orm['bcpp_subject.medicaldiagnoses'], null=False)),
            ('heartdisease', models.ForeignKey(orm['bcpp_list.heartdisease'], null=False))
        ))
        db.create_unique(m2m_table_name, ['medicaldiagnoses_id', 'heartdisease_id'])

        # Removing M2M table for field diagnoses on 'MedicalDiagnoses'
        db.delete_table(db.shorten_name('bcpp_subject_medicaldiagnoses_diagnoses'))

        # Adding field 'MedicalDiagnosesAudit.cancer'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'cancer',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.dx_tb'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'dx_tb',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.dx_cancer'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'dx_cancer',
                      self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.tb'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'tb',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.date_heart_attack'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'date_heart_attack',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.date_tb'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'date_tb',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.date_cancer'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'date_cancer',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'MedicalDiagnosesAudit.heart_attack'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'heart_attack',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
