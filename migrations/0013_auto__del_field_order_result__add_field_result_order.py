...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Order.result'
        db.delete_column('bhp_lab_core_order', 'result_id')

        # Adding field 'Result.order'
        db.add_column('bhp_lab_core_result', 'order', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.Order']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Order.result'
        db.add_column('bhp_lab_core_order', 'result', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_lab_core.Result']), keep_default=False)

        # Deleting field 'Result.order'
        db.delete_column('bhp_lab_core_result', 'order_id')
    ...
    models = {
        ...
        'bhp_lab_core.dmisimporthistory': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'home'", 'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'import_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 18, 21, 53, 43, 178560)'}),
