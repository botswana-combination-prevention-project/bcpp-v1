...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Education.seekingwork'
        db.alter_column('bcpp_subject_education', 'seekingwork', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Education.education'
        db.alter_column('bcpp_subject_education', 'education', self.gf('django.db.models.fields.CharField')(max_length=65))

        # Changing field 'Education.employment'
        db.alter_column('bcpp_subject_education', 'employment', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'Education.moneyforwork'
        db.alter_column('bcpp_subject_education', 'moneyforwork', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'EducationAudit.seekingwork'
        db.alter_column('bcpp_subject_education_audit', 'seekingwork', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'EducationAudit.education'
        db.alter_column('bcpp_subject_education_audit', 'education', self.gf('django.db.models.fields.CharField')(max_length=65))

        # Changing field 'EducationAudit.employment'
        db.alter_column('bcpp_subject_education_audit', 'employment', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'EducationAudit.moneyforwork'
        db.alter_column('bcpp_subject_education_audit', 'moneyforwork', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))


    def backwards(self, orm):
        
        # Changing field 'Education.seekingwork'
        db.alter_column('bcpp_subject_education', 'seekingwork', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Education.education'
        db.alter_column('bcpp_subject_education', 'education', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Education.employment'
        db.alter_column('bcpp_subject_education', 'employment', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Education.moneyforwork'
        db.alter_column('bcpp_subject_education', 'moneyforwork', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'EducationAudit.seekingwork'
        db.alter_column('bcpp_subject_education_audit', 'seekingwork', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'EducationAudit.education'
        db.alter_column('bcpp_subject_education_audit', 'education', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'EducationAudit.employment'
        db.alter_column('bcpp_subject_education_audit', 'employment', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'EducationAudit.moneyforwork'
        db.alter_column('bcpp_subject_education_audit', 'moneyforwork', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 8, 7, 971098)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 8, 8, 91050)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 8, 8, 7, 619814)'}),
