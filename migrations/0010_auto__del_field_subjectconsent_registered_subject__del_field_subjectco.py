...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubjectConsent.registered_subject'
        db.delete_column('bcpp_subject_subjectconsent', 'registered_subject_id')

        # Deleting field 'SubjectConsentAudit.registered_subject'
        db.delete_column('bcpp_subject_subjectconsent_audit', 'registered_subject_id')


    def backwards(self, orm):
        
        # Adding field 'SubjectConsent.registered_subject'
        db.add_column('bcpp_subject_subjectconsent', 'registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_registration.RegisteredSubject']), keep_default=False)

        # Adding field 'SubjectConsentAudit.registered_subject'
        db.add_column('bcpp_subject_subjectconsent_audit', 'registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='_audit_subjectconsent', to=orm['bhp_registration.RegisteredSubject']), keep_default=False)
    ...
    models = {
        ...
        'bcpp_subject.baselinehouseholdsurvey': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 11, 29, 22, 378488)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 11, 29, 22, 173330)'}),
