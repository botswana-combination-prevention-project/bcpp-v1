...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MedicalDiagnoses.sti'
        db.delete_column('bcpp_subject_medicaldiagnoses', 'sti')

        # Adding field 'MedicalDiagnoses.sti_record'
        db.add_column('bcpp_subject_medicaldiagnoses', 'sti_record',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MedicalDiagnosesAudit.sti'
        db.delete_column('bcpp_subject_medicaldiagnoses_audit', 'sti')

        # Adding field 'MedicalDiagnosesAudit.sti_record'
        db.add_column('bcpp_subject_medicaldiagnoses_audit', 'sti_record',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'MedicalDiagnoses.sti'
        raise RuntimeError("Cannot reverse this migration. 'MedicalDiagnoses.sti' and its values cannot be restored.")
        # Deleting field 'MedicalDiagnoses.sti_record'
        db.delete_column('bcpp_subject_medicaldiagnoses', 'sti_record')


        # User chose to not deal with backwards NULL issues for 'MedicalDiagnosesAudit.sti'
        raise RuntimeError("Cannot reverse this migration. 'MedicalDiagnosesAudit.sti' and its values cannot be restored.")
        # Deleting field 'MedicalDiagnosesAudit.sti_record'
        db.delete_column('bcpp_subject_medicaldiagnoses_audit', 'sti_record')
