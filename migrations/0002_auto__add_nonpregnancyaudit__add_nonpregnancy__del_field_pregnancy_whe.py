...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_nonpregnancy_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 17, 0, 0))),
        ...
        # Deleting field 'Pregnancy.where_circ'
        db.delete_column('bcpp_subject_pregnancy', 'where_circ')

        # Deleting field 'Pregnancy.more_children'
        db.delete_column('bcpp_subject_pregnancy', 'more_children')

        # Deleting field 'Pregnancy.family_planning_other'
        db.delete_column('bcpp_subject_pregnancy', 'family_planning_other')

        # Deleting field 'Pregnancy.current_pregnant'
        db.delete_column('bcpp_subject_pregnancy', 'current_pregnant')
        ...
        # Changing field 'Pregnancy.preg_arv'
        db.alter_column('bcpp_subject_pregnancy', 'preg_arv', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'Pregnancy.hiv_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy', 'hiv_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        ...
        # Adding field 'ReproductiveHealth.currently_pregnant'
        db.add_column('bcpp_subject_reproductivehealth', 'currently_pregnant',
        ...
        # Deleting field 'PregnancyAudit.where_circ'
        db.delete_column('bcpp_subject_pregnancy_audit', 'where_circ')

        # Deleting field 'PregnancyAudit.more_children'
        db.delete_column('bcpp_subject_pregnancy_audit', 'more_children')

        # Deleting field 'PregnancyAudit.current_pregnant'
        db.delete_column('bcpp_subject_pregnancy_audit', 'current_pregnant')

        # Deleting field 'PregnancyAudit.family_planning_other'
        db.delete_column('bcpp_subject_pregnancy_audit', 'family_planning_other')


        # Changing field 'PregnancyAudit.preg_arv'
        db.alter_column('bcpp_subject_pregnancy_audit', 'preg_arv', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'PregnancyAudit.hiv_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy_audit', 'hiv_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        ...
        # Adding field 'ReproductiveHealthAudit.currently_pregnant'
        db.add_column('bcpp_subject_reproductivehealth_audit', 'currently_pregnant',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Pregnancy.where_circ'
        db.add_column('bcpp_subject_pregnancy', 'where_circ',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=70),
                      keep_default=False)

        # Adding field 'Pregnancy.more_children'
        db.add_column('bcpp_subject_pregnancy', 'more_children',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'Pregnancy.family_planning_other'
        db.add_column('bcpp_subject_pregnancy', 'family_planning_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'Pregnancy.current_pregnant'
        db.add_column('bcpp_subject_pregnancy', 'current_pregnant',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)
        ...
        # Changing field 'Pregnancy.preg_arv'
        db.alter_column('bcpp_subject_pregnancy', 'preg_arv', self.gf('django.db.models.fields.CharField')(default=0, max_length=95))

        # Changing field 'Pregnancy.hiv_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy', 'hiv_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        ...
        # Deleting field 'ReproductiveHealth.currently_pregnant'
        db.delete_column('bcpp_subject_reproductivehealth', 'currently_pregnant')
        ...
        # Adding field 'PregnancyAudit.where_circ'
        db.add_column('bcpp_subject_pregnancy_audit', 'where_circ',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=70),
                      keep_default=False)

        # Adding field 'PregnancyAudit.more_children'
        db.add_column('bcpp_subject_pregnancy_audit', 'more_children',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'PregnancyAudit.current_pregnant'
        db.add_column('bcpp_subject_pregnancy_audit', 'current_pregnant',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Adding field 'PregnancyAudit.family_planning_other'
        db.add_column('bcpp_subject_pregnancy_audit', 'family_planning_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


        # Changing field 'PregnancyAudit.preg_arv'
        db.alter_column('bcpp_subject_pregnancy_audit', 'preg_arv', self.gf('django.db.models.fields.CharField')(default=0, max_length=95))

        # Changing field 'PregnancyAudit.hiv_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy_audit', 'hiv_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
        ...
        # Deleting field 'ReproductiveHealthAudit.currently_pregnant'
        db.delete_column('bcpp_subject_reproductivehealth_audit', 'currently_pregnant')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 17, 0, 0)'}),
