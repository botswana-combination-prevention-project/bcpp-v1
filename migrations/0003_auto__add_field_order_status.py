...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bhp_lab_core_order', 'status',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('bhp_lab_core_order', 'status')
    ...
    models = {
        ...
        'lab_aliquot.aliquot': {
            ...
            'aliquot_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 7, 0, 0)'}),
