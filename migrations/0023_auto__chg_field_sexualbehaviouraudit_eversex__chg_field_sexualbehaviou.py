...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SexualBehaviourAudit.eversex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'eversex', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SexualBehaviourAudit.moresex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'moresex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviourAudit.firstsex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'firstsex', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'SexualBehaviourAudit.alcohol_sex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'alcohol_sex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviourAudit.condom'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'condom', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviourAudit.lastsex_calc'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lastsex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'SexualBehaviourAudit.lastyearpartners'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lastyearpartners', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'SexualBehaviour.eversex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'eversex', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SexualBehaviour.moresex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'moresex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviour.firstsex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'firstsex', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'SexualBehaviour.alcohol_sex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'alcohol_sex', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviour.condom'
        db.alter_column('bcpp_subject_sexualbehaviour', 'condom', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SexualBehaviour.lastsex_calc'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lastsex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'SexualBehaviour.lastyearpartners'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lastyearpartners', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))


    def backwards(self, orm):
        
        # Changing field 'SexualBehaviourAudit.eversex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'eversex', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'SexualBehaviourAudit.moresex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'moresex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviourAudit.firstsex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'firstsex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviourAudit.alcohol_sex'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'alcohol_sex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviourAudit.condom'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'condom', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviourAudit.lastsex_calc'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lastsex_calc', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=25))

        # Changing field 'SexualBehaviourAudit.lastyearpartners'
        db.alter_column('bcpp_subject_sexualbehaviour_audit', 'lastyearpartners', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviour.eversex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'eversex', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'SexualBehaviour.moresex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'moresex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviour.firstsex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'firstsex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviour.alcohol_sex'
        db.alter_column('bcpp_subject_sexualbehaviour', 'alcohol_sex', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviour.condom'
        db.alter_column('bcpp_subject_sexualbehaviour', 'condom', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))

        # Changing field 'SexualBehaviour.lastsex_calc'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lastsex_calc', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=25))

        # Changing field 'SexualBehaviour.lastyearpartners'
        db.alter_column('bcpp_subject_sexualbehaviour', 'lastyearpartners', self.gf('django.db.models.fields.CharField')(default=0, max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 10, 26, 21, 442312)'}),
        ...
        'bcpp_subject.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 10, 26, 21, 557235)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 10, 26, 21, 146951)'}),
