...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DispatchContainer'
        db.rename_table('bhp_dispatch_dispatch', 'bhp_dispatch_dispatchcontainer')
        # Changing field 'DispatchItem.dispatch'
        db.alter_column('bhp_dispatch_dispatchitem', 'dispatch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_dispatch.DispatchContainer']))
    ...
    models = {
        ...
        'bhp_dispatch.dispatchitem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'dispatch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bhp_dispatch.DispatchContainer']"}),
            'dispatch_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
