...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataNote.registered_subject'
        db.add_column('bhp_data_manager_datanote', 'registered_subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='-', to=orm['bhp_registration.RegisteredSubject']),
                      keep_default=False)


        # Changing field 'DataNote.comment'
        db.alter_column('bhp_data_manager_datanote', 'comment', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Comment.comment'
        db.alter_column('bhp_data_manager_comment', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500))
        # Deleting field 'DataNote.registered_subject'
        db.delete_column('bhp_data_manager_datanote', 'registered_subject_id')


        # Changing field 'DataNote.comment'
        db.alter_column('bhp_data_manager_datanote', 'comment', self.gf('django.db.models.fields.TextField')(max_length=500))
