...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectRequisitionInspector.requisition_datetime'
        db.add_column('bcpp_inspector_subjectrequisitioninspector', 'requisition_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectRequisitionInspector.requisition_datetime'
        db.delete_column('bcpp_inspector_subjectrequisitioninspector', 'requisition_datetime')
