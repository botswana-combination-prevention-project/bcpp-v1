...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectRequisitionAudit._audit_subject_identifier'
        db.add_column('bcpp_lab_subjectrequisition_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectRequisitionAudit._audit_subject_identifier'
        db.delete_column('bcpp_lab_subjectrequisition_audit', '_audit_subject_identifier')
    ...
    models = {
        ...
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)'}),
