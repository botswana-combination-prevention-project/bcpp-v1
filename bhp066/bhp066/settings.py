...
INSTALLED_APPS = (
    ...
    'dajax',
    'south',
    'edc.core.audit_trail',
    'edc.core.bhp_templates',
    'edc.core.bhp_static',
    'edc.core.bhp_crypto',
    'edc.core.bhp_string',
    'edc.core.bhp_lock',
    'edc.core.bhp_appointment',
    'edc.core.bhp_appointment_helper',
    'edc.core.bhp_userprofile',
    'edc.core.bhp_poll_mysql',
    'edc.core.bhp_model_selector',
    'edc.core.bhp_templatetags',
    'edc.core.bhp_base_model',
    'edc.core.bhp_base_test',
    'edc.core.bhp_variables',
    'edc.core.bhp_actg_reference',
    'edc.core.bhp_adverse',
    'edc.core.bhp_map',
    'edc.core.bhp_code_lists',
    'edc.core.bhp_common',
    'edc.core.bhp_identifier',
    'edc.core.bhp_content_type_map',
    'edc.core.bhp_search',
    'edc.core.bhp_section',
    'edc.core.bhp_consent',
    'edc.core.bhp_locator',
    'edc.core.bhp_off_study',
    'edc.core.bhp_registration',
    'edc.core.bhp_botswana',
    'edc.core.bhp_data_manager',
    'edc.core.bhp_base_admin',
    'edc.core.bhp_base_form',
    ...
    'edc.core.bhp_sync',
    'edc.core.bhp_device',
    'edc.core.bhp_lab_tracker',
    'edc.core.bhp_visit',
    'edc.core.bhp_visit_tracking',
    'edc.core.bhp_appointment',
    'edc.core.bhp_subject',
    'edc.core.bhp_subject_config',
    'edc.core.bhp_supplemental_fields',
    'edc.core.bhp_nmap',
    'edc.core.bhp_data_manager',
    'edc.core.bhp_entry',
    'edc.core.bhp_lab_entry',
    'edc.core.bhp_context',
    'edc.core.bhp_using',
    'edc.core.bhp_contact',
    'edc.core.bhp_dashboard',
    'edc.core.bhp_dashboard_registered_subject',
    'edc.core.bhp_export_data',
    'edc.core.bhp_model_describer',
    'edc.core.bhp_subject_summary',
    'edc.core.bhp_entry_rules',
    'edc.core.bhp_dispatch',
    'edc.core.bhp_inspector',
    'edc.core.bhp_netbook',
