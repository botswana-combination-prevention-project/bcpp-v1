...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferredTo'
        db.create_table('bcpp_list_referredto', (
        ...
        db.send_create_signal('bcpp_list', ['ReferredTo'])

        # Adding model 'ReferredFor'
        db.create_table('bcpp_list_referredfor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_list', ['ReferredFor'])


    def backwards(self, orm):
        # Deleting model 'ReferredTo'
        db.delete_table('bcpp_list_referredto')

        # Deleting model 'ReferredFor'
        db.delete_table('bcpp_list_referredfor')
