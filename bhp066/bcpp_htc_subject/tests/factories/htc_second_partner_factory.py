...
from bcpp_htc_subject.models import HtcSecondPartner
...
class HtcSecondPartnerFactory(BaseUuidModelFactory):
    ...
    second_partner_rel = (('spouse', 'Spouse (husband/wife)'), ('cohabiting', 'Cohabitating partner'), ('boy_girl_friend', 'Boyfriend/Girlfriend'), ('casual', 'Casual (known) sex partner'), ('partner_unknown', 'One time partner (previously unknown)'), ('sex_worker', 'Commercial sex worker'), ('OTHER', 'Other, specify'), ('declined', 'Decline to answer'))[0][0]
