...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectRequisitionInspector.revision'
        db.add_column(u'bcpp_inspector_subjectrequisitioninspector', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectRequisitionInspector.revision'
        db.delete_column(u'bcpp_inspector_subjectrequisitioninspector', 'revision')
