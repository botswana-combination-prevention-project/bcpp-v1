...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRequisitionInspector.revision'
        db.alter_column(u'bcpp_inspector_subjectrequisitioninspector', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'SubjectRequisitionInspector.revision'
        db.alter_column(u'bcpp_inspector_subjectrequisitioninspector', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
