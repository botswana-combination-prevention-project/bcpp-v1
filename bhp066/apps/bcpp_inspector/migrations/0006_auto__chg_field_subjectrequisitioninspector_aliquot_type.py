...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRequisitionInspector.aliquot_type'
        db.alter_column('bcpp_inspector_subjectrequisitioninspector', 'aliquot_type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'SubjectRequisitionInspector.aliquot_type'
        db.alter_column('bcpp_inspector_subjectrequisitioninspector', 'aliquot_type', self.gf('django.db.models.fields.CharField')(max_length=10))

    models = {
        'bcpp_inspector.subjectrequisitioninspector': {
            'Meta': {'object_name': 'SubjectRequisitionInspector'},
            'aliquot_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
