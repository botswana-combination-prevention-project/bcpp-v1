...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClinicPackingList'
        db.create_table(u'bcpp_clinic_lab_clinicpackinglist', (
            ...
            ('list_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 19, 0, 0))),
        ...
        db.send_create_signal('bcpp_clinic_lab', ['ClinicPackingList'])

        # Adding model 'ClinicRequisitionAudit'
        db.create_table(u'bcpp_clinic_lab_clinicrequisition_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_clinicrequisition', to=orm['lab_clinic_api.AliquotType'])),
            ('panel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_clinicrequisition', to=orm['lab_clinic_api.Panel'])),
            ...
            ('packing_list', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='_audit_clinicrequisition', null=True, to=orm['bcpp_clinic_lab.ClinicPackingList'])),
        ...
        db.send_create_signal('bcpp_clinic_lab', ['ClinicRequisitionAudit'])

        # Adding model 'ClinicRequisition'
        db.create_table(u'bcpp_clinic_lab_clinicrequisition', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('packing_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_clinic_lab.ClinicPackingList'], null=True, blank=True)),
            ('subject_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('community', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
        ))
        db.send_create_signal('bcpp_clinic_lab', ['ClinicRequisition'])

        # Adding M2M table for field test_code on 'ClinicRequisition'
        m2m_table_name = db.shorten_name(u'bcpp_clinic_lab_clinicrequisition_test_code')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clinicrequisition', models.ForeignKey(orm['bcpp_clinic_lab.clinicrequisition'], null=False)),
        ...
        # Adding model 'ClinicPackingListItem'
        db.create_table(u'bcpp_clinic_lab_clinicpackinglistitem', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('packing_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_clinic_lab.ClinicPackingList'], null=True)),
        ))
        db.send_create_signal('bcpp_clinic_lab', ['ClinicPackingListItem'])


    def backwards(self, orm):
        # Deleting model 'ClinicPackingList'
        db.delete_table(u'bcpp_clinic_lab_clinicpackinglist')

        # Deleting model 'ClinicRequisitionAudit'
        db.delete_table(u'bcpp_clinic_lab_clinicrequisition_audit')

        # Deleting model 'ClinicRequisition'
        db.delete_table(u'bcpp_clinic_lab_clinicrequisition')

        # Removing M2M table for field test_code on 'ClinicRequisition'
        db.delete_table(db.shorten_name(u'bcpp_clinic_lab_clinicrequisition_test_code'))

        # Deleting model 'ClinicPackingListItem'
        db.delete_table(u'bcpp_clinic_lab_clinicpackinglistitem')
    ...
    models = {
        ...
        'bcpp_clinic_lab.clinicpackinglist': {
            'Meta': {'object_name': 'ClinicPackingList'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
        ...
        'bcpp_clinic_lab.clinicpackinglistitem': {
            'Meta': {'object_name': 'ClinicPackingListItem'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            ...
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_clinic_lab.ClinicPackingList']", 'null': 'True'}),
        ...
        'bcpp_clinic_lab.clinicrequisition': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_clinic_lab.ClinicPackingList']", 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_clinic_lab.clinicrequisitionaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ClinicRequisitionAudit', 'db_table': "u'bcpp_clinic_lab_clinicrequisition_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'aliquot_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_clinicrequisition'", 'to': "orm['lab_clinic_api.AliquotType']"}),
            ...
            'item_type': ('django.db.models.fields.CharField', [], {'default': "'tube'", 'max_length': '25'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'packing_list': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'_audit_clinicrequisition'", 'null': 'True', 'to': "orm['bcpp_clinic_lab.ClinicPackingList']"}),
            'panel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_clinicrequisition'", 'to': "orm['lab_clinic_api.Panel']"}),
            'priority': ('django.db.models.fields.CharField', [], {'default': "'normal'", 'max_length': '25'}),
            'protocol': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'reason_not_drawn': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'requisition_datetime': ('django.db.models.fields.DateTimeField', [], {}),
