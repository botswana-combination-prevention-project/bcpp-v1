...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClinicPackingList.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicpackinglist', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ClinicPackingListItem.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicpackinglistitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ClinicRequisitionAudit.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ClinicRequisition.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'ClinicPackingList.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicpackinglist', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ClinicPackingListItem.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicpackinglistitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ClinicRequisitionAudit.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ClinicRequisition.revision'
        db.alter_column(u'bcpp_clinic_lab_clinicrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'bcpp_clinic_lab.clinicpackinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
