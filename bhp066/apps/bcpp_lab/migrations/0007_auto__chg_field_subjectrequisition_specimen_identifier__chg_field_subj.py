...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRequisition.specimen_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True))

        # Changing field 'SubjectRequisition.requisition_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Changing field 'SubjectRequisitionAudit.specimen_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SubjectRequisitionAudit.requisition_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'SubjectRequisition.specimen_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25, null=True))

        # Changing field 'SubjectRequisition.requisition_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))

        # Changing field 'SubjectRequisitionAudit.specimen_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'specimen_identifier', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SubjectRequisitionAudit.requisition_identifier'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'requisition_identifier', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    models = {
        ...
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)'}),
