...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRequisition.revision'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'SubjectRequisitionAudit.revision'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PackingList.revision'
        db.alter_column(u'bcpp_lab_packinglist', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'PackingListItem.revision'
        db.alter_column(u'bcpp_lab_packinglistitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'SubjectRequisition.revision'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SubjectRequisitionAudit.revision'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PackingList.revision'
        db.alter_column(u'bcpp_lab_packinglist', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PackingListItem.revision'
        db.alter_column(u'bcpp_lab_packinglistitem', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 7, 0, 0)'}),
