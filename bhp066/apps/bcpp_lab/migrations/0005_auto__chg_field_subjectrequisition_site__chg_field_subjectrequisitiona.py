...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRequisition.site'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_variables.StudySite'], null=True))

        # Changing field 'SubjectRequisitionAudit.site'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bhp_variables.StudySite']))

    def backwards(self, orm):

        # Changing field 'SubjectRequisition.site'
        db.alter_column(u'bcpp_lab_subjectrequisition', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_variables.StudySite']))

        # Changing field 'SubjectRequisitionAudit.site'
        db.alter_column(u'bcpp_lab_subjectrequisition_audit', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_variables.StudySite']))
    ...
    models = {
        ...
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 23, 0, 0)'}),
