...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectRequisition.revision'
        db.add_column(u'bcpp_lab_subjectrequisition', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectRequisitionAudit.revision'
        db.add_column(u'bcpp_lab_subjectrequisition_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingList.revision'
        db.add_column(u'bcpp_lab_packinglist', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackingListItem.revision'
        db.add_column(u'bcpp_lab_packinglistitem', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectRequisition.revision'
        db.delete_column(u'bcpp_lab_subjectrequisition', 'revision')

        # Deleting field 'SubjectRequisitionAudit.revision'
        db.delete_column(u'bcpp_lab_subjectrequisition_audit', 'revision')

        # Deleting field 'PackingList.revision'
        db.delete_column(u'bcpp_lab_packinglist', 'revision')

        # Deleting field 'PackingListItem.revision'
        db.delete_column(u'bcpp_lab_packinglistitem', 'revision')
