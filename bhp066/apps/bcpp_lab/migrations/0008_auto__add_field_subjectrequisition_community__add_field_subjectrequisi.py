...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectRequisition.community'
        db.add_column(u'bcpp_lab_subjectrequisition', 'community',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'SubjectRequisitionAudit.community'
        db.add_column(u'bcpp_lab_subjectrequisition_audit', 'community',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectRequisition.community'
        db.delete_column(u'bcpp_lab_subjectrequisition', 'community')

        # Deleting field 'SubjectRequisitionAudit.community'
        db.delete_column(u'bcpp_lab_subjectrequisition_audit', 'community')
    ...
    models = {
        ...
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 13, 0, 0)'}),
