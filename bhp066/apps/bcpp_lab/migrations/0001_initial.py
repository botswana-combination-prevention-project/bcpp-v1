...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_lab_packinglist', (
            ...
            ('list_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 29, 0, 0))),
        ...
        db.create_table(u'bcpp_lab_subjectrequisition_audit', (
            ...
            ('aliquot_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectrequisition', to=orm['lab_clinic_api.AliquotType'])),
            ('panel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectrequisition', to=orm['lab_clinic_api.Panel'])),
    ...
    models = {
        'bcpp_lab.packinglist': {
            ...
            'list_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 29, 0, 0)'}),
