...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'bcpp_household_member_enrolmentchecklist', 'community_resident', 'study_resident')

        db.rename_column(u'bcpp_household_member_enrolmentchecklist_audit', 'community_resident', 'study_resident')
