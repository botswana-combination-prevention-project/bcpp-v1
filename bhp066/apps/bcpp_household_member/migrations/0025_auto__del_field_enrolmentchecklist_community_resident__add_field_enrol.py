...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'bcpp_household_member_enrollmentchecklist', 'community_resident', 'study_resident')

        db.rename_column(u'bcpp_household_member_enrollmentchecklist_audit', 'community_resident', 'study_resident')
