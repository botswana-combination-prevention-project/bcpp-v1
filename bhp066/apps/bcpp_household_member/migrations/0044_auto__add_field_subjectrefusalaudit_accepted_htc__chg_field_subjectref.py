...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_household_member_subjectrefusal_audit', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        db.alter_column(u'bcpp_household_member_subjectrefusal', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubjectRefusalAudit.subject_refusal_status'
        db.alter_column(u'bcpp_household_member_subjectrefusal_audit', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Deleting field 'SubjectRefusal.accepted_htc'
        db.delete_column(u'bcpp_household_member_subjectrefusal', 'accepted_htc')


        # Changing field 'SubjectRefusal.subject_refusal_status'
        db.alter_column(u'bcpp_household_member_subjectrefusal', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
