...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdMember.eligiblity_confirmed'
        db.delete_column(u'bcpp_household_member_householdmember', 'eligiblity_confirmed')
        ...
        # Adding field 'HouseholdMember.is_eligible_subject'
        db.add_column(u'bcpp_household_member_householdmember', 'is_eligible_subject',
        ...
        # Adding field 'HouseholdMemberAudit.is_eligible_subject'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'is_eligible_subject',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HouseholdMember.eligiblity_confirmed'
        db.add_column(u'bcpp_household_member_householdmember', 'eligiblity_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMember.reason_not_eligible'
        db.add_column(u'bcpp_household_member_householdmember', 'reason_not_eligible',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)

        # Deleting field 'HouseholdMember.is_eligible_subject'
        db.delete_column(u'bcpp_household_member_householdmember', 'is_eligible_subject')

        # Adding field 'HouseholdMemberAudit.reason_not_eligible'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'reason_not_eligible',
                      self.gf('django.db.models.fields.CharField')(max_length=78L, null=True),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.eligiblity_confirmed'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'eligiblity_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'HouseholdMemberAudit.is_eligible_subject'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'is_eligible_subject')
