...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EnrolmentChecklistAudit.reason_not_eligible'
        db.alter_column('bcpp_household_member_enrolmentchecklist_audit', 'reason_not_eligible', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'EnrolmentChecklist.reason_not_eligible'
        db.alter_column('bcpp_household_member_enrolmentchecklist', 'reason_not_eligible', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EnrolmentChecklistAudit.reason_not_eligible'
        raise RuntimeError("Cannot reverse this migration. 'EnrolmentChecklistAudit.reason_not_eligible' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EnrolmentChecklist.reason_not_eligible'
        raise RuntimeError("Cannot reverse this migration. 'EnrolmentChecklist.reason_not_eligible' and its values cannot be restored.")
