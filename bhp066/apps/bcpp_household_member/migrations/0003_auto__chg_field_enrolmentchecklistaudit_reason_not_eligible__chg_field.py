...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EnrollmentChecklistAudit.reason_not_eligible'
        db.alter_column('bcpp_household_member_enrollmentchecklist_audit', 'reason_not_eligible', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'EnrollmentChecklist.reason_not_eligible'
        db.alter_column('bcpp_household_member_enrollmentchecklist', 'reason_not_eligible', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EnrollmentChecklistAudit.reason_not_eligible'
        raise RuntimeError("Cannot reverse this migration. 'EnrollmentChecklistAudit.reason_not_eligible' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EnrollmentChecklist.reason_not_eligible'
        raise RuntimeError("Cannot reverse this migration. 'EnrollmentChecklist.reason_not_eligible' and its values cannot be restored.")
