...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'SubjectHtcAudit.tracking_identifier'
        #db.add_column(u'bcpp_household_member_subjecthtc_audit', 'tracking_identifier',
        #              self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
        #              keep_default=False)


        # Changing field 'SubjectHtcAudit.accepted'
        #db.alter_column(u'bcpp_household_member_subjecthtc_audit', 'accepted', self.gf('django.db.models.fields.CharField')(default='No', max_length=25))
        # Adding field 'HouseholdMember.refused_htc'
        db.add_column(u'bcpp_household_member_householdmember', 'refused_htc',
        ...
        # Adding field 'SubjectHtc.tracking_identifier'
        #db.add_column(u'bcpp_household_member_subjecthtc', 'tracking_identifier',
        #              self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
        #              keep_default=False)


        # Changing field 'SubjectHtc.accepted'
        db.alter_column(u'bcpp_household_member_subjecthtc', 'accepted', self.gf('django.db.models.fields.CharField')(default='No', max_length=25))
        db.alter_column(u'bcpp_household_member_subjecthtc_audit', 'accepted', self.gf('django.db.models.fields.CharField')(default='No', max_length=25))
        # Adding field 'HouseholdMemberAudit.refused_htc'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'refused_htc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EnrollmentChecklist.update_values'
#         db.add_column(u'bcpp_household_member_enrollmentchecklist', 'update_values',
#                       self.gf('django.db.models.fields.BooleanField')(default=False),
#                       keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubjectHtcAudit.tracking_identifier'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'tracking_identifier')


        # Changing field 'SubjectHtcAudit.accepted'
        db.alter_column(u'bcpp_household_member_subjecthtc_audit', 'accepted', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Deleting field 'HouseholdMember.refused_htc'
        db.delete_column(u'bcpp_household_member_householdmember', 'refused_htc')
        ...
        # Deleting field 'SubjectHtc.tracking_identifier'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'tracking_identifier')


        # Changing field 'SubjectHtc.accepted'
        db.alter_column(u'bcpp_household_member_subjecthtc', 'accepted', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
        # Deleting field 'HouseholdMemberAudit.refused_htc'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'refused_htc')

        # Deleting field 'EnrollmentChecklist.update_values'
        db.delete_column(u'bcpp_household_member_enrollmentchecklist', 'update_values')
    ...
    models = {
        ...
        'bcpp_household_member.enrollmentchecklist': {
            ...
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'update_values': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 21, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
