...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_household_member_baselinehouseholdsurvey_audit', (
            ...
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_baselinehouseholdsurvey', to=orm['bcpp_household_member.HouseholdMember'])),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_baselinehouseholdsurvey', to=orm['bhp_registration.RegisteredSubject'])),
            ('household_structure', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_baselinehouseholdsurvey', to=orm['bcpp_household.HouseholdStructure'])),
        ))
        db.send_create_signal('bcpp_household_member', ['BaselineHouseholdSurveyAudit'])

        # Adding model 'BaselineHouseholdSurvey'
        db.create_table('bcpp_household_member_baselinehouseholdsurvey', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_household_member', ['BaselineHouseholdSurvey'])

        # Adding M2M table for field electrical_appliances on 'BaselineHouseholdSurvey'
        db.create_table('bcpp_household_member_baselinehouseholdsurvey_electrical_app68d1', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baselinehouseholdsurvey', models.ForeignKey(orm['bcpp_household_member.baselinehouseholdsurvey'], null=False)),
            ('electricalappliances', models.ForeignKey(orm['bcpp_list.electricalappliances'], null=False))
        ))
        db.create_unique('bcpp_household_member_baselinehouseholdsurvey_electrical_app68d1', ['baselinehouseholdsurvey_id', 'electricalappliances_id'])

        # Adding M2M table for field transport_mode on 'BaselineHouseholdSurvey'
        db.create_table('bcpp_household_member_baselinehouseholdsurvey_transport_mode', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baselinehouseholdsurvey', models.ForeignKey(orm['bcpp_household_member.baselinehouseholdsurvey'], null=False)),
            ('transportmode', models.ForeignKey(orm['bcpp_list.transportmode'], null=False))
        ))
        db.create_unique('bcpp_household_member_baselinehouseholdsurvey_transport_mode', ['baselinehouseholdsurvey_id', 'transportmode_id'])

        # Deleting field 'HtcDataAudit.religion_other'
        db.delete_column('bcpp_household_member_htcdata_audit', 'religion_other')
        ...
        # Deleting field 'HtcData.religion_other'
        db.delete_column('bcpp_household_member_htcdata', 'religion_other')
        ...
        db.delete_table('bcpp_household_member_htcdata_religion')

        # Adding M2M table for field rel on 'HtcData'
        db.create_table('bcpp_household_member_htcdata_rel', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('bcpp_household_member_htcdata_rel', ['htcdata_id', 'religion_id'])


    def backwards(self, orm):
        # Deleting model 'BaselineHouseholdSurveyAudit'
        db.delete_table('bcpp_household_member_baselinehouseholdsurvey_audit')

        # Deleting model 'BaselineHouseholdSurvey'
        db.delete_table('bcpp_household_member_baselinehouseholdsurvey')

        # Removing M2M table for field electrical_appliances on 'BaselineHouseholdSurvey'
        db.delete_table('bcpp_household_member_baselinehouseholdsurvey_electrical_app68d1')

        # Removing M2M table for field transport_mode on 'BaselineHouseholdSurvey'
        db.delete_table('bcpp_household_member_baselinehouseholdsurvey_transport_mode')

        # Adding field 'HtcDataAudit.religion_other'
        db.add_column('bcpp_household_member_htcdata_audit', 'religion_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)
        ...
        # Adding field 'HtcData.religion_other'
        db.add_column('bcpp_household_member_htcdata', 'religion_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)
        ...
        db.create_table('bcpp_household_member_htcdata_religion', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('htcdata', models.ForeignKey(orm['bcpp_household_member.htcdata'], null=False)),
            ('religion', models.ForeignKey(orm['bcpp_list.religion'], null=False))
        ))
        db.create_unique('bcpp_household_member_htcdata_religion', ['htcdata_id', 'religion_id'])

        # Removing M2M table for field rel on 'HtcData'
        db.delete_table('bcpp_household_member_htcdata_rel')
    ...
    models = {
        ...
        'bcpp_household_member.baselinehouseholdsurvey': {
        ...
        'bcpp_household_member.baselinehouseholdsurveyaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'BaselineHouseholdSurveyAudit', 'db_table': "'bcpp_household_member_baselinehouseholdsurvey_audit'"},
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_baselinehouseholdsurvey'", 'to': "orm['bcpp_household_member.HouseholdMember']"}),
            'household_structure': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_baselinehouseholdsurvey'", 'to': "orm['bcpp_household.HouseholdStructure']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'living_rooms': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_baselinehouseholdsurvey'", 'to': "orm['bhp_registration.RegisteredSubject']"}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'sheep_owned': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'smaller_meals': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'toilet_facility': ('django.db.models.fields.CharField', [], {'max_length': '35'}),
        ...
        'bcpp_household_member.htcdata': {
            ...
            'registered_subject': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bhp_registration.RegisteredSubject']", 'unique': 'True'}),
            'rel': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['bcpp_list.Religion']", 'symmetrical': 'False'}),
            'rel_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
