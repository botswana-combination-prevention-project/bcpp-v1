...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubjectHtcAudit.outcome'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'outcome')

        # Adding field 'SubjectHtcAudit.accepted'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'accepted',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'SubjectHtcAudit.refusal_reason'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'refusal_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectHtcAudit.hiv_result'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'hiv_result',
                      self.gf('django.db.models.fields.CharField')(default='UNK', max_length=10),
                      keep_default=False)

        # Adding field 'SubjectHtcAudit.referred'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'referred',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Adding field 'SubjectHtcAudit.referral_clinic'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'referral_clinic',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SubjectHtc.outcome'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'outcome')

        # Adding field 'SubjectHtc.accepted'
        db.add_column(u'bcpp_household_member_subjecthtc', 'accepted',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'SubjectHtc.refusal_reason'
        db.add_column(u'bcpp_household_member_subjecthtc', 'refusal_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectHtc.hiv_result'
        db.add_column(u'bcpp_household_member_subjecthtc', 'hiv_result',
                      self.gf('django.db.models.fields.CharField')(default='UNK', max_length=10),
                      keep_default=False)

        # Adding field 'SubjectHtc.referred'
        db.add_column(u'bcpp_household_member_subjecthtc', 'referred',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=10),
                      keep_default=False)

        # Adding field 'SubjectHtc.referral_clinic'
        db.add_column(u'bcpp_household_member_subjecthtc', 'referral_clinic',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubjectHtcAudit.outcome'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', 'outcome',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=25),
                      keep_default=False)

        # Deleting field 'SubjectHtcAudit.accepted'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'accepted')

        # Deleting field 'SubjectHtcAudit.refusal_reason'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'refusal_reason')

        # Deleting field 'SubjectHtcAudit.hiv_result'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'hiv_result')

        # Deleting field 'SubjectHtcAudit.referred'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'referred')

        # Deleting field 'SubjectHtcAudit.referral_clinic'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', 'referral_clinic')

        # Adding field 'SubjectHtc.outcome'
        db.add_column(u'bcpp_household_member_subjecthtc', 'outcome',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=25),
                      keep_default=False)

        # Deleting field 'SubjectHtc.accepted'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'accepted')

        # Deleting field 'SubjectHtc.refusal_reason'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'refusal_reason')

        # Deleting field 'SubjectHtc.hiv_result'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'hiv_result')

        # Deleting field 'SubjectHtc.referred'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'referred')

        # Deleting field 'SubjectHtc.referral_clinic'
        db.delete_column(u'bcpp_household_member_subjecthtc', 'referral_clinic')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
