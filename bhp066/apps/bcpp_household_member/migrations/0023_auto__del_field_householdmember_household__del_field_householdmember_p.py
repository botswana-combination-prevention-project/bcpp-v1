...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'bcpp_household_member_householdmember', 'present', 'present_today')

        db.rename_column(u'bcpp_household_member_householdmember_audit', 'present', 'present_today')

        # Deleting field 'HouseholdMember.household'
        db.delete_column(u'bcpp_household_member_householdmember', 'household_id')

        # Deleting field 'HouseholdMember.plot'
        db.delete_column(u'bcpp_household_member_householdmember', 'plot_id')

        # Deleting field 'HouseholdMember.nights_out'
        db.delete_column(u'bcpp_household_member_householdmember', 'nights_out')

        # Deleting field 'HouseholdMember.survey'
        db.delete_column(u'bcpp_household_member_householdmember', 'survey_id')

        # Deleting field 'HouseholdMember.lives_in_household'
        db.delete_column(u'bcpp_household_member_householdmember', 'lives_in_household')

        # Adding field 'HouseholdMember.study_resident'
        db.add_column(u'bcpp_household_member_householdmember', 'study_resident',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=17),
                      keep_default=False)

        # Deleting field 'HouseholdMemberAudit.household'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'household_id')

        # Deleting field 'HouseholdMemberAudit.plot'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'plot_id')

        # Deleting field 'HouseholdMemberAudit.nights_out'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'nights_out')

        # Deleting field 'HouseholdMemberAudit.survey'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'survey_id')

        # Deleting field 'HouseholdMemberAudit.lives_in_household'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'lives_in_household')

        # Adding field 'HouseholdMemberAudit.study_resident'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'study_resident',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=17),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_household_member.householdmember': {
            ...
            'is_eligible_subject': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
