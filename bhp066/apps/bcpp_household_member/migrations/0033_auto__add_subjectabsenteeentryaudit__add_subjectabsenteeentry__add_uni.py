...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bcpp_subject_subjectentry_audit', (
        ...
        db.create_table('bcpp_subject_subjectentry', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.create_unique('bcpp_subject_subjectentry', ['subject_absentee_id', 'report_datetime'])
        ...
        db.create_table('bcpp_subject_subjectabsenteeentry_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 18, 0, 0))),
        ...
        db.create_unique('bcpp_subject_subjectabsenteeentry', ['registered_subject_id', 'survey_id'])

        # Deleting field 'HouseholdMember.contact_log'
        db.delete_column(u'bcpp_household_member_householdmember', 'contact_log_id')

        # Deleting field 'HouseholdMemberAudit.contact_log'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'contact_log_id')


    def backwards(self, orm):
        # Removing unique constraint on 'SubjectAbsentee', fields ['registered_subject', 'survey']
        db.delete_unique('bcpp_subject_subjectabsenteeentry', ['registered_subject_id', 'survey_id'])

        # Removing unique constraint on 'SubjectAbsenteeEntry', fields ['subject_absentee', 'report_datetime']
        db.delete_unique('bcpp_subject_subjectentry', ['subject_absentee_id', 'report_datetime'])

        # Deleting model 'SubjectAbsenteeEntryAudit'
        db.delete_table('bcpp_subject_subjectentry_audit')

        # Deleting model 'SubjectAbsenteeEntry'
        db.delete_table('bcpp_subject_subjectentry')
        ...
        # Adding field 'HouseholdMember.contact_log'
        db.add_column(u'bcpp_household_member_householdmember', 'contact_log',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household_member.ContactLog'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.contact_log'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'contact_log',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_householdmember', null=True, to=orm['bcpp_household_member.ContactLog']),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            'Meta': {'unique_together': "(('registered_subject', 'survey'),)", 'object_name': 'SubjectAbsentee', 'db_table': "'bcpp_subject_subjectabsenteeentry'"},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_member': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_household_member.HouseholdMember']", 'unique': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_household_member.subjectabsenteeaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectAbsenteeAudit', 'db_table': "'bcpp_subject_subjectabsenteeentry_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_household_member.subjectabsenteeentry': {
            'Meta': {'unique_together': "(('subject_absentee', 'report_datetime'),)", 'object_name': 'SubjectAbsenteeEntry', 'db_table': "'bcpp_subject_subjectentry'"},
        ...
        'bcpp_household_member.subjectabsenteeentryaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'SubjectAbsenteeEntryAudit', 'db_table': "'bcpp_subject_subjectentry_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
