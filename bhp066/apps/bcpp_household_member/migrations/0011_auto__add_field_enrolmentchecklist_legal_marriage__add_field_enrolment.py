...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnrollmentChecklist.legal_marriage'
        db.add_column('bcpp_household_member_enrollmentchecklist', 'legal_marriage',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'EnrollmentChecklist.marriage_certificate'
        db.add_column('bcpp_household_member_enrollmentchecklist', 'marriage_certificate',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrollmentChecklist.marriage_certificate_no'
        db.add_column('bcpp_household_member_enrollmentchecklist', 'marriage_certificate_no',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrollmentChecklistAudit.legal_marriage'
        db.add_column('bcpp_household_member_enrollmentchecklist_audit', 'legal_marriage',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'EnrollmentChecklistAudit.marriage_certificate'
        db.add_column('bcpp_household_member_enrollmentchecklist_audit', 'marriage_certificate',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EnrollmentChecklistAudit.marriage_certificate_no'
        db.add_column('bcpp_household_member_enrollmentchecklist_audit', 'marriage_certificate_no',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnrollmentChecklist.legal_marriage'
        db.delete_column('bcpp_household_member_enrollmentchecklist', 'legal_marriage')

        # Deleting field 'EnrollmentChecklist.marriage_certificate'
        db.delete_column('bcpp_household_member_enrollmentchecklist', 'marriage_certificate')

        # Deleting field 'EnrollmentChecklist.marriage_certificate_no'
        db.delete_column('bcpp_household_member_enrollmentchecklist', 'marriage_certificate_no')

        # Deleting field 'EnrollmentChecklistAudit.legal_marriage'
        db.delete_column('bcpp_household_member_enrollmentchecklist_audit', 'legal_marriage')

        # Deleting field 'EnrollmentChecklistAudit.marriage_certificate'
        db.delete_column('bcpp_household_member_enrollmentchecklist_audit', 'marriage_certificate')

        # Deleting field 'EnrollmentChecklistAudit.marriage_certificate_no'
        db.delete_column('bcpp_household_member_enrollmentchecklist_audit', 'marriage_certificate_no')
    ...
    models = {
        ...
        'bcpp_household_member.enrollmentchecklist': {
            ...
            'legal_marriage': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
