...
#             ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 24, 0, 0))),
...
#             ('outcome', self.gf('django.db.models.fields.CharField')(max_length=25)),
...
#         db.send_create_signal('bcpp_household_member', ['SubjectHtc'])
        ...
        # Adding field 'HouseholdMember.htc'
#         db.add_column(u'bcpp_household_member_householdmember', 'htc',
#                       self.gf('django.db.models.fields.BooleanField')(default=False),
#                       keep_default=False)
# 
#         # Adding field 'HouseholdMemberAudit.htc'
#         db.add_column(u'bcpp_household_member_householdmember_audit', 'htc',
#                       self.gf('django.db.models.fields.BooleanField')(default=False),
#                       keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HouseholdMember.htc'
        db.delete_column(u'bcpp_household_member_householdmember', 'htc')

        # Deleting field 'HouseholdMemberAudit.htc'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'htc')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        ...
        'bcpp_household_member.subjecthtc': {
            ...
            'outcome': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 24, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
