...
#         db.send_create_signal('bcpp_household_member', ['ContactLogItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('bcpp_household_member_contactlog')

        # Deleting model 'ContactLogItem'
        db.delete_table('bcpp_household_member_contactlogitem')


        # Changing field 'HouseholdMember.contact_log'
        db.alter_column('bcpp_household_member_householdmember', 'contact_log_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household.ContactLog'], unique=True, null=True))

        # Changing field 'HouseholdMemberAudit.contact_log'
        db.alter_column('bcpp_household_member_householdmember_audit', 'contact_log_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bcpp_household.ContactLog']))
