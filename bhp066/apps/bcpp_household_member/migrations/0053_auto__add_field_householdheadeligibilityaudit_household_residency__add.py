...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdHeadEligibilityAudit.household_residency'
        db.add_column(u'bcpp_household_member_householdheadeligibility_audit', 'household_residency',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3),
                      keep_default=False)

        # Adding field 'HouseholdHeadEligibility.household_residency'
        db.add_column(u'bcpp_household_member_householdheadeligibility', 'household_residency',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3),
                      keep_default=False)

        # Adding field 'HouseholdMember.absent'
        db.add_column(u'bcpp_household_member_householdmember', 'absent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.absent'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'absent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdHeadEligibilityAudit.household_residency'
        db.delete_column(u'bcpp_household_member_householdheadeligibility_audit', 'household_residency')

        # Deleting field 'HouseholdHeadEligibility.household_residency'
        db.delete_column(u'bcpp_household_member_householdheadeligibility', 'household_residency')

        # Deleting field 'HouseholdMember.absent'
        db.delete_column(u'bcpp_household_member_householdmember', 'absent')

        # Deleting field 'HouseholdMemberAudit.absent'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'absent')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 28, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
