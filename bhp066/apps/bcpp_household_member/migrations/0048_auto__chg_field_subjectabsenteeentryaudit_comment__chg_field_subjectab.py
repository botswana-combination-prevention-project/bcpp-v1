...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectAbsenteeEntryAudit.comment'
        db.alter_column(u'bcpp_household_member_subjectabsenteeentry_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'SubjectAbsenteeEntry.comment'
        db.alter_column(u'bcpp_household_member_subjectabsenteeentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'SubjectUndecidedEntryAudit.comment'
        db.alter_column(u'bcpp_household_member_subjectundecidedentry_audit', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'SubjectUndecidedEntry.comment'
        db.alter_column(u'bcpp_household_member_subjectundecidedentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
        # Deleting field 'HouseholdHeadEligibility.verball_script'

        # Adding field 'HouseholdMember.reported'
        db.add_column(u'bcpp_household_member_householdmember', 'reported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMember.refused'
        db.add_column(u'bcpp_household_member_householdmember', 'refused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'HouseholdMemberAudit.member_status_partial'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'member_status_partial')

        # Adding field 'HouseholdMemberAudit.reported'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'reported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.refused'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'refused',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubjectAbsenteeEntryAudit.comment'
        db.alter_column(u'bcpp_household_member_subjectabsenteeentry_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Changing field 'SubjectAbsenteeEntry.comment'
        db.alter_column(u'bcpp_household_member_subjectabsenteeentry', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))

        # Changing field 'SubjectUndecidedEntryAudit.comment'
        db.alter_column(u'bcpp_household_member_subjectundecidedentry_audit', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))
        # Adding field 'HouseholdHeadEligibilityAudit.verball_script'
        db.add_column(u'bcpp_household_member_householdheadeligibility_audit', 'verball_script',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Deleting field 'HouseholdHeadEligibilityAudit.verbal_script'
        db.delete_column(u'bcpp_household_member_householdheadeligibility_audit', 'verbal_script')


        # Changing field 'SubjectUndecidedEntry.comment'
        db.alter_column(u'bcpp_household_member_subjectundecidedentry', 'comment', self.gf('django.db.models.fields.TextField')(max_length=250, null=True))
        # Adding field 'HouseholdHeadEligibility.verball_script'
        db.add_column(u'bcpp_household_member_householdheadeligibility', 'verball_script',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Deleting field 'HouseholdHeadEligibility.verbal_script'
        db.delete_column(u'bcpp_household_member_householdheadeligibility', 'verbal_script')

        # Deleting field 'EnrolmentChecklist.is_eligible'
        db.delete_column(u'bcpp_household_member_enrolmentchecklist', 'is_eligible')
        ...
        # Adding field 'HouseholdMember.member_status_full'
        db.add_column(u'bcpp_household_member_householdmember', 'member_status_full',
                      self.gf('django.db.models.fields.CharField')(default='NOT_REPORTED', max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'HouseholdMember.member_status_partial'
        db.add_column(u'bcpp_household_member_householdmember', 'member_status_partial',
                      self.gf('django.db.models.fields.CharField')(default='NOT_REPORTED', max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'HouseholdMember.member_status'
        db.delete_column(u'bcpp_household_member_householdmember', 'member_status')

        # Deleting field 'HouseholdMember.eligible_htc'
        db.delete_column(u'bcpp_household_member_householdmember', 'eligible_htc')

        # Deleting field 'HouseholdMember.reported'
        db.delete_column(u'bcpp_household_member_householdmember', 'reported')

        # Deleting field 'HouseholdMember.refused'
        db.delete_column(u'bcpp_household_member_householdmember', 'refused')

        # Deleting field 'HouseholdMember.is_consented'
        db.delete_column(u'bcpp_household_member_householdmember', 'is_consented')

        # Adding field 'HouseholdMemberAudit.member_status_full'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'member_status_full',
                      self.gf('django.db.models.fields.CharField')(default='NOT_REPORTED', max_length=25, null=True, db_index=True),
                      keep_default=False)
        ...
        # Adding field 'HouseholdMemberAudit.member_status_partial'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'member_status_partial',
                      self.gf('django.db.models.fields.CharField')(default='NOT_REPORTED', max_length=25, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'HouseholdMemberAudit.member_status'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'member_status')

        # Deleting field 'HouseholdMemberAudit.eligible_htc'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'eligible_htc')

        # Deleting field 'HouseholdMemberAudit.reported'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'reported')

        # Deleting field 'HouseholdMemberAudit.refused'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'refused')

        # Deleting field 'HouseholdMemberAudit.is_consented'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'is_consented')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_household_member.subjectrefusal': {
            ...
            'accepted_htc': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
