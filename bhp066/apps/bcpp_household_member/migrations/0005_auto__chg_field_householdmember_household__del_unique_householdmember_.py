...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HouseholdMember.household'
        db.alter_column('bcpp_household_member_householdmember', 'household_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household.Household'], unique=True, null=True))
        # Adding unique constraint on 'HouseholdMember', fields ['household']
        db.create_unique('bcpp_household_member_householdmember', ['household_id'])
