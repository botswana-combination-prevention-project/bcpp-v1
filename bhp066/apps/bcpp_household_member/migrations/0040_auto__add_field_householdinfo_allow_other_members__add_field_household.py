...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdInfo.allow_other_members'
        db.add_column(u'bcpp_household_member_householdinfo', 'allow_other_members',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdInfoAudit.allow_other_members'
        db.add_column(u'bcpp_household_member_householdinfo_audit', 'allow_other_members',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdInfo.allow_other_members'
        db.delete_column(u'bcpp_household_member_householdinfo', 'allow_other_members')

        # Deleting field 'HouseholdInfoAudit.allow_other_members'
        db.delete_column(u'bcpp_household_member_householdinfo_audit', 'allow_other_members')
    ...
    models = {
        ...
        'bcpp_household_member.householdinfo': {
            ...
            'allow_other_members': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 20, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
