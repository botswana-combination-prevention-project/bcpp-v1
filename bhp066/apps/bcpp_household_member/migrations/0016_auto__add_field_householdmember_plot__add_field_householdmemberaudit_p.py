...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdMember.plot'
        db.add_column('bcpp_household_member_householdmember', 'plot',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_household.Plot'], null=True),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.plot'
        db.add_column('bcpp_household_member_householdmember_audit', 'plot',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_householdmember', null=True, to=orm['bcpp_household.Plot']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdMember.plot'
        db.delete_column('bcpp_household_member_householdmember', 'plot_id')

        # Deleting field 'HouseholdMemberAudit.plot'
        db.delete_column('bcpp_household_member_householdmember_audit', 'plot_id')
