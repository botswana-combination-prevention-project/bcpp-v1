...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bcpp_household_member_enrolmentchecklist', 'marriage_certificate_no')

        # Adding field 'EnrolmentChecklist.guardian'
        db.add_column(u'bcpp_household_member_enrolmentchecklist', 'guardian',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=10),
                      keep_default=False)

        # Adding field 'EnrolmentChecklist.household_residency'
        db.add_column(u'bcpp_household_member_enrolmentchecklist', 'household_residency',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=3),
                      keep_default=False)

        # Adding field 'EnrolmentChecklist.literacy'
        db.add_column(u'bcpp_household_member_enrolmentchecklist', 'literacy',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bcpp_household_member_enrolmentchecklist', 'marriage_certificate_no',
                      self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EnrolmentChecklist.guardian'
        db.delete_column(u'bcpp_household_member_enrolmentchecklist', 'guardian')

        # Deleting field 'EnrolmentChecklist.household_residency'
        db.delete_column(u'bcpp_household_member_enrolmentchecklist', 'household_residency')

        # Deleting field 'EnrolmentChecklist.literacy'
        db.delete_column(u'bcpp_household_member_enrolmentchecklist', 'literacy')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
