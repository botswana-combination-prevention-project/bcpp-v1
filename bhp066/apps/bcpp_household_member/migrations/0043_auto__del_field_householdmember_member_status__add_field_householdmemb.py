...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'HouseholdMember.member_status'
        db.rename_column(u'bcpp_household_member_householdmember', 'member_status', 'member_status_full')
        ...
        # Rename field 'HouseholdMemberAudit.member_status'
        db.rename_column(u'bcpp_household_member_householdmember_audit', 'member_status', 'member_status_full')
    ...
    def backwards(self, orm):
        ...
        # Rename field 'HouseholdMember.member_status_full'
        db.rename_column(u'bcpp_household_member_householdmember', 'member_status_full', 'member_status')

        # Deleting field 'HouseholdMember.member_status_partial'
        db.delete_column(u'bcpp_household_member_householdmember', 'member_status_partial')

        # Rename field 'HouseholdMemberAudit.member_status_full'
        db.rename_column(u'bcpp_household_member_householdmember_audit', 'member_status_full', 'member_status')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
