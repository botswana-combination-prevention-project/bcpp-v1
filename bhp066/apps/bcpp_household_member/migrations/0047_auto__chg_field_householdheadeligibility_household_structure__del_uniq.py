...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'HouseholdHeadEligibility', fields ['household_structure']
        db.delete_unique(u'bcpp_household_member_householdheadeligibility', ['household_structure_id'])


        # Changing field 'HouseholdHeadEligibility.household_structure'
        db.alter_column(u'bcpp_household_member_householdheadeligibility', 'household_structure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_household.HouseholdStructure']))

    def backwards(self, orm):

        # Changing field 'HouseholdHeadEligibility.household_structure'
        db.alter_column(u'bcpp_household_member_householdheadeligibility', 'household_structure_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household.HouseholdStructure'], unique=True))
        # Adding unique constraint on 'HouseholdHeadEligibility', fields ['household_structure']
        db.create_unique(u'bcpp_household_member_householdheadeligibility', ['household_structure_id'])
    ...
    models = {
        ...
        'bcpp_household_member.householdheadeligibility': {
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'verball_script': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
