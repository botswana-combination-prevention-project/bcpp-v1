...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name('bcpp_household_member_baselinehouseholdsurvey_transport_mode'))
 
        # Removing M2M table for field electrical_appliances on 'BaselineHouseholdSurvey'
        db.delete_table(db.shorten_name('bcpp_household_member_baselinehouseholdsurvey_electrical_appliances'))

        # Adding model 'HouseholdInfo'
        db.create_table('bcpp_household_member_householdinfo', (
        ...
        m2m_table_name = db.shorten_name('bcpp_household_member_householdinfo_electrical_appliances')
        ...
        m2m_table_name = db.shorten_name('bcpp_household_member_householdinfo_transport_mode')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('householdinfo', models.ForeignKey(orm['bcpp_household_member.householdinfo'], null=False)),
        ...
        db.create_table('bcpp_household_member_householdinfo_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_householdinfo', to=orm['bhp_registration.RegisteredSubject'])),
        ))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('bcpp_household_member_baselinehouseholdsurvey_transport_mode')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        m2m_table_name = db.shorten_name('bcpp_household_member_baselinehouseholdsurvey_electrical_appliances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baselinehouseholdsurvey', models.ForeignKey(orm['bcpp_household_member.baselinehouseholdsurvey'], null=False)),
            ('electricalappliances', models.ForeignKey(orm['bcpp_list.electricalappliances'], null=False))
        ...
        db.delete_table('bcpp_household_member_householdinfo')

        # Removing M2M table for field electrical_appliances on 'HouseholdInfo'
        db.delete_table(db.shorten_name('bcpp_household_member_householdinfo_electrical_appliances'))

        # Removing M2M table for field transport_mode on 'HouseholdInfo'
        db.delete_table(db.shorten_name('bcpp_household_member_householdinfo_transport_mode'))

        # Deleting model 'HouseholdInfoAudit'
        db.delete_table('bcpp_household_member_householdinfo_audit')
