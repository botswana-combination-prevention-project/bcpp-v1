...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdMember.auto_filled'
        db.add_column(u'bcpp_household_member_householdmember', 'auto_filled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMember.updated_after_auto_filled'
        db.add_column(u'bcpp_household_member_householdmember', 'updated_after_auto_filled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.auto_filled'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'auto_filled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit.updated_after_auto_filled'
        db.add_column(u'bcpp_household_member_householdmember_audit', 'updated_after_auto_filled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdMember.auto_filled'
        db.delete_column(u'bcpp_household_member_householdmember', 'auto_filled')

        # Deleting field 'HouseholdMember.updated_after_auto_filled'
        db.delete_column(u'bcpp_household_member_householdmember', 'updated_after_auto_filled')

        # Deleting field 'HouseholdMemberAudit.auto_filled'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'auto_filled')

        # Deleting field 'HouseholdMemberAudit.updated_after_auto_filled'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'updated_after_auto_filled')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 20, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
