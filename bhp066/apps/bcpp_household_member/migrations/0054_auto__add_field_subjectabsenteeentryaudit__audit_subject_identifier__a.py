...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bcpp_household_member_subjectabsenteeentry_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectUndecidedEntryAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjectundecidedentry_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectMovedAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjectmoved_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdHeadEligibilityAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_householdheadeligibility_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectUndecidedAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjectundecided_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectHtcAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjecthtc_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectRefusalAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjectrefusal_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdInfoAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_householdinfo_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectAbsenteeAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_subjectabsentee_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdMemberAudit._audit_subject_identifier'
        db.add_column(u'bcpp_household_member_householdmember_audit', '_audit_subject_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'bcpp_household_member_subjectabsenteeentry_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectUndecidedEntryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjectundecidedentry_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectMovedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjectmoved_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdHeadEligibilityAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_householdheadeligibility_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectUndecidedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjectundecided_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectHtcAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjecthtc_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectRefusalAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjectrefusal_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdInfoAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_householdinfo_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectAbsenteeAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_subjectabsentee_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdMemberAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_member_householdmember_audit', '_audit_subject_identifier')
    ...
    models = {
        ...
        'bcpp_household_member.subjecthtc': {
            ...
            'accepted': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hiv_result': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_member': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_household_member.HouseholdMember']", 'unique': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
