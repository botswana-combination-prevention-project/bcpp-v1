...
#                       keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'HouseholdMember.eligible_rbd_subject'
        db.delete_column(u'bcpp_household_member_householdmember', 'eligible_rbd_subject')

        # Deleting field 'HouseholdMemberAudit.eligible_rbd_subject'
        db.delete_column(u'bcpp_household_member_householdmember_audit', 'eligible_rbd_subject')
    ...
    models = {
        ...
        'bcpp_household_member.subjectabsentee': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 19, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
