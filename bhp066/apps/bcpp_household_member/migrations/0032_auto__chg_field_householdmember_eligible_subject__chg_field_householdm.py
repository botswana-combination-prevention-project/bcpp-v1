...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseholdMember.eligible_subject'
        db.alter_column(u'bcpp_household_member_householdmember', 'eligible_subject', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'HouseholdMemberAudit.eligible_subject'
        db.alter_column(u'bcpp_household_member_householdmember_audit', 'eligible_subject', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'HouseholdMember.eligible_subject'
        db.alter_column(u'bcpp_household_member_householdmember', 'eligible_subject', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'HouseholdMemberAudit.eligible_subject'
        db.alter_column(u'bcpp_household_member_householdmember_audit', 'eligible_subject', self.gf('django.db.models.fields.BooleanField')())
