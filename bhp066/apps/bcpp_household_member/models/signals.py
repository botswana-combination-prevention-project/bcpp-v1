...
from ..constants import BHS_ELIGIBLE
...
#!!!!!SAVING a foreign key of a model is post delete is BAD. chances are you are dealing with an old instance.
#!!!!!Avoid saving on post delete. Do all your saves before the delete().
    ...
    if not raw:
        if isinstance(instance, EnrollmentChecklist):
            ...
            if instance.is_eligible:
                ...
                instance.household_member.member_status = BHS_ELIGIBLE
