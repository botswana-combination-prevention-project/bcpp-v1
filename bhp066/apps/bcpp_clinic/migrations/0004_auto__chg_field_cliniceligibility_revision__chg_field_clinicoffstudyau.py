...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClinicMainAudit.revision'
        db.alter_column(u'bcpp_clinic_clinicmain_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
        ...
        # Changing field 'ClinicMain.revision'
        db.alter_column(u'bcpp_clinic_clinicmain', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ClinicMainAudit.revision'
        db.alter_column(u'bcpp_clinic_clinicmain_audit', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        ...
        # Changing field 'ClinicMain.revision'
        db.alter_column(u'bcpp_clinic_clinicmain', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        'bcpp_clinic.cliniceligibility': {
            ...
            'registration_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 8, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'bcpp_clinic.clinicmain': {
            'Meta': {'object_name': 'ClinicMain'},
        ...
        'bcpp_clinic.clinicmainaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ClinicMainAudit', 'db_table': "u'bcpp_clinic_clinicmain_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'cd4_count': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
            'clinic_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_clinicmain'", 'to': "orm['bcpp_clinic.ClinicVisit']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
