...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_clinic_viralloadresult', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 9, 15, 0, 0))),
        ...
        db.send_create_signal('bcpp_clinic', ['ViralLoadResult'])

        # Adding model 'ViralLoadResultAudit'
        db.create_table(u'bcpp_clinic_viralloadresult_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('clinic_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_viralloadresult', to=orm['bcpp_clinic.ClinicVisit'])),
        ))
        db.send_create_signal('bcpp_clinic', ['ViralLoadResultAudit'])

        # Adding field 'ClinicConsent.clinic_eligibility'
        db.add_column(u'bcpp_clinic_clinicconsent', 'clinic_eligibility',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['bcpp_clinic_enrollment.ClinicEligibility'], unique=True),
                      keep_default=False)

        # Adding field 'ClinicConsentAudit.clinic_eligibility'
        db.add_column(u'bcpp_clinic_clinicconsent_audit', 'clinic_eligibility',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='_audit_clinicconsent', to=orm['bcpp_clinic_enrollment.ClinicEligibility']),
                      keep_default=False)

    def backwards(self, orm):
        pass
        # Deleting model 'ViralLoadResult'
#         db.delete_table(u'bcpp_clinic_viralloadresult')
#
#         # Deleting model 'ViralLoadResultAudit'
#         db.delete_table(u'bcpp_clinic_viralloadresult_audit')
#
#         # Deleting field 'ClinicConsent.clinic_eligibility'
#         db.delete_column(u'bcpp_clinic_clinicconsent', 'clinic_eligibility_id')
#
#         # Deleting field 'ClinicConsentAudit.clinic_eligibility'
#         db.delete_column(u'bcpp_clinic_clinicconsent_audit', 'clinic_eligibility_id')
    models = {
        ...
        'bcpp_clinic.clinicconsent': {
            ...
            'clinic_eligibility': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_clinic_enrollment.ClinicEligibility']", 'unique': 'True'}),
        ...
        'bcpp_clinic.clinicconsentaudit': {
            ...
            'assessment_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
            'clinic_eligibility': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_clinicconsent'", 'to': "orm['bcpp_clinic_enrollment.ClinicEligibility']"}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'community': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'confirm_identity': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True'}),
            'consent_copy': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
        ...
        'bcpp_clinic.clinicquestionnaire': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'htc_and_or_pims': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'knows_last_cd4': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'on_arv': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'other_identifiers': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_clinic.clinicsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 15, 0, 0)'}),
        ...
        'bcpp_clinic.viralloadresultaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'ViralLoadResultAudit', 'db_table': "u'bcpp_clinic_viralloadresult_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_subject_identifier': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'clinic_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_viralloadresult'", 'to': "orm['bcpp_clinic.ClinicVisit']"}),
            'clinician_initials': ('django.db.models.fields.CharField', [], {'default': "'--'", 'max_length': '3'}),
            'collection_datetime': ('django.db.models.fields.DateTimeField', [], {}),
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'bcpp_clinic_enrollment.cliniceligibility': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'silverapple'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'inability_to_participate': ('django.db.models.fields.CharField', [], {'max_length': '17', 'null': 'True'}),
            ...
            'legal_marriage': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'part_time_resident': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['registration.RegisteredSubject']", 'null': 'True'}),
            'registration_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
