...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_clinic_dailylog', (
            ...
            ('report_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 11, 18, 0, 0), unique=True)),
            ...
            ('idcc_booked', self.gf('django.db.models.fields.IntegerField')()),
        ...
        # Adding field 'ViralLoadTracking.clinician_initials'
        db.add_column(u'bcpp_clinic_viralloadtracking', 'clinician_initials',
                      self.gf('django.db.models.fields.CharField')(default='--', max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionnaireAudit.registration_type_other'
        db.add_column(u'bcpp_clinic_questionnaire_audit', 'registration_type_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'Questionnaire.registration_type_other'
        db.add_column(u'bcpp_clinic_questionnaire', 'registration_type_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'ViralLoadTrackingAudit.clinician_initials'
        db.add_column(u'bcpp_clinic_viralloadtracking_audit', 'clinician_initials',
                      self.gf('django.db.models.fields.CharField')(default='--', max_length=3, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ViralLoadTracking.clinician_initials'
        db.delete_column(u'bcpp_clinic_viralloadtracking', 'clinician_initials')

        # Deleting field 'QuestionnaireAudit.registration_type_other'
        db.delete_column(u'bcpp_clinic_questionnaire_audit', 'registration_type_other')

        # Deleting field 'Questionnaire.registration_type_other'
        db.delete_column(u'bcpp_clinic_questionnaire', 'registration_type_other')

        # Deleting field 'ViralLoadTrackingAudit.clinician_initials'
        db.delete_column(u'bcpp_clinic_viralloadtracking_audit', 'clinician_initials')
    ...
    models = {
        ...
        'bcpp_clinic.clinicenrollmentloss': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_clinic.clinicsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
        ...
        'bcpp_clinic.dailylog': {
            ...
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'mac.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'idcc_booked': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'report_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)', 'unique': 'True'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
