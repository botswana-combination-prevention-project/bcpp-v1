...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClinicQuestionnaireAudit.other_identifiers'
        db.add_column(u'bcpp_clinic_clinicquestionnaire_audit', 'other_identifiers',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=25),
                      keep_default=False)

        # Adding field 'ClinicQuestionnaireAudit.htc_and_or_pims'
        db.add_column(u'bcpp_clinic_clinicquestionnaire_audit', 'htc_and_or_pims',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=50),
                      keep_default=False)

        # Adding field 'ClinicQuestionnaire.other_identifiers'
        db.add_column(u'bcpp_clinic_clinicquestionnaire', 'other_identifiers',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=25),
                      keep_default=False)

        # Adding field 'ClinicQuestionnaire.htc_and_or_pims'
        db.add_column(u'bcpp_clinic_clinicquestionnaire', 'htc_and_or_pims',
                      self.gf('django.db.models.fields.CharField')(default='Htc', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClinicQuestionnaireAudit.other_identifiers'
        db.delete_column(u'bcpp_clinic_clinicquestionnaire_audit', 'other_identifiers')

        # Deleting field 'ClinicQuestionnaireAudit.htc_and_or_pims'
        db.delete_column(u'bcpp_clinic_clinicquestionnaire_audit', 'htc_and_or_pims')

        # Deleting field 'ClinicQuestionnaire.other_identifiers'
        db.delete_column(u'bcpp_clinic_clinicquestionnaire', 'other_identifiers')

        # Deleting field 'ClinicQuestionnaire.htc_and_or_pims'
        db.delete_column(u'bcpp_clinic_clinicquestionnaire', 'htc_and_or_pims')
    ...
    models = {
        ...
        'bcpp_clinic.clinicquestionnaire': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'htc_and_or_pims': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_clinic.clinicsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
