...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DailyLog.idcc_booked'
        db.delete_column(u'bcpp_clinic_dailylog', 'idcc_booked')

        # Adding field 'DailyLog.idcc_scheduled'
        db.add_column(u'bcpp_clinic_dailylog', 'idcc_scheduled',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DailyLog.idcc_booked'
        raise RuntimeError("Cannot reverse this migration. 'DailyLog.idcc_booked' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'DailyLog.idcc_booked'
        db.add_column(u'bcpp_clinic_dailylog', 'idcc_booked',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'DailyLog.idcc_scheduled'
        db.delete_column(u'bcpp_clinic_dailylog', 'idcc_scheduled')
