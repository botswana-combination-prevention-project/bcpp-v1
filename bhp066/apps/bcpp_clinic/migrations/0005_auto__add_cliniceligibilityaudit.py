...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_clinic_cliniceligibility_audit', (
            ...
            ('registration_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 23, 0, 0))),
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_cliniceligibility', to=orm['registration.RegisteredSubject'])),
        ))
