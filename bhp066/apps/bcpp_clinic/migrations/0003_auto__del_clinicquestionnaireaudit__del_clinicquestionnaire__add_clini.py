...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'bcpp_clinic_clinicquestionnaire_audit')

        # Deleting model 'ClinicQuestionnaire'
        db.delete_table(u'bcpp_clinic_clinicquestionnaire')

        # Adding model 'ClinicMainAudit'
        db.create_table(u'bcpp_clinic_clinicmain_audit', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 6, 0, 0))),
            ...
            ('clinic_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_clinicmain', to=orm['bcpp_clinic.ClinicVisit'])),
        ))
        db.send_create_signal('bcpp_clinic', ['ClinicMainAudit'])

        # Adding model 'ClinicMain'
        db.create_table(u'bcpp_clinic_clinicmain', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_clinic', ['ClinicMain'])


    def backwards(self, orm):
        # Adding model 'ClinicQuestionnaireAudit'
        db.create_table(u'bcpp_clinic_clinicquestionnaire_audit', (
            ('on_arv', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ...
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('clinic_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_clinicquestionnaire', to=orm['bcpp_clinic.ClinicVisit'])),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 26, 0, 0))),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_clinic', ['ClinicQuestionnaireAudit'])

        # Adding model 'ClinicQuestionnaire'
        db.create_table(u'bcpp_clinic_clinicquestionnaire', (
            ('on_arv', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('hostname_created', self.gf('django.db.models.fields.CharField')(default='silverapple', max_length=50, blank=True, db_index=True)),
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='silverapple', max_length=50, blank=True, db_index=True)),
            ('clinic_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_clinic.ClinicVisit'], unique=True)),
        ...
        db.send_create_signal('bcpp_clinic', ['ClinicQuestionnaire'])

        # Deleting model 'ClinicMainAudit'
        db.delete_table(u'bcpp_clinic_clinicmain_audit')

        # Deleting model 'ClinicMain'
        db.delete_table(u'bcpp_clinic_clinicmain')
    ...
    models = {
        ...
        'bcpp_clinic.cliniceligibility': {
            ...
            'registration_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'bcpp_clinic.clinicmain': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
