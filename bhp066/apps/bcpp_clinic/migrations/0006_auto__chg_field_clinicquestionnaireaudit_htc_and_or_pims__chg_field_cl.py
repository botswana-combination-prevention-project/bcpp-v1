...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClinicQuestionnaireAudit.htc_and_or_pims'
        db.alter_column(u'bcpp_clinic_clinicquestionnaire_audit', 'htc_and_or_pims', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ClinicQuestionnaire.htc_and_or_pims'
        db.alter_column(u'bcpp_clinic_clinicquestionnaire', 'htc_and_or_pims', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'ClinicQuestionnaireAudit.htc_and_or_pims'
        db.alter_column(u'bcpp_clinic_clinicquestionnaire_audit', 'htc_and_or_pims', self.gf('django.db.models.fields.CharField')(default='XX', max_length=50))

        # Changing field 'ClinicQuestionnaire.htc_and_or_pims'
        db.alter_column(u'bcpp_clinic_clinicquestionnaire', 'htc_and_or_pims', self.gf('django.db.models.fields.CharField')(default='XX', max_length=50))
    ...
    models = {
        ...
        'bcpp_clinic.clinicquestionnaire': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_clinic.clinicsubjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
