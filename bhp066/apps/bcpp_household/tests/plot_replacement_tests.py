...
class PlotReplacementTests(TestCase):
    ...
    def test_replacement_plot1(self):
        ...
        producer_name = ProducerFactory()
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [plot])
    ...
    def test_replacement_plot2(self):
        ...
        producer_name = ProducerFactory()
        replacement_helper = ReplacementHelper()
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [])
    ...
    def test_refusal_household1(self):
        ...
        replacement_helper = ReplacementHelper()
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [])
        self.assertEquals(replacement_helper.replaceable_households(self.survey1, producer_name), [household])
    ...
    def test_refusal_household4(self):
        ...
        replacement_helper = ReplacementHelper()
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [])
        self.assertEquals(replacement_helper.replaceable_households(self.survey1, producer_name), [household1])
    ...
    def test_refusal_household5(self):
        ...
        replacement_helper = ReplacementHelper()
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [])
        self.assertEquals(replacement_helper.replaceable_households(self.survey1, producer_name), [])
    ...
    def test_household_replacement1(self):
        ...
        producer_name = ProducerFactory()
        replacement_helper = ReplacementHelper()
        replaceble_household = replacement_helper.replaceable_households(self.survey1, producer_name)
        self.assertEquals(replacement_helper.replaceable_households(self.survey1, producer_name), [household])
    ...
    def test_household_replacement2(self):
        ...
        replacement_helper = ReplacementHelper()
        replaceble_household = replacement_helper.replaceable_households(self.survey1, producer_name)
        self.assertEquals((replacement_helper.replaceable_households(self.survey1, producer_name)).sort(), ([household1, household2, household3]).sort())
    ...
    def test_plot_replacement1(self):
        ...
        producer_name = ProducerFactory()
        replacement_helper = ReplacementHelper()
        replaceble_plots = replacement_helper.replaceable_plots(producer_name)
        self.assertEquals(replacement_helper.replaceable_plots(producer_name), [plot])
