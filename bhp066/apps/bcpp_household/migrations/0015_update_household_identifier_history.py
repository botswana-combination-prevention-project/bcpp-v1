...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        HouseholdIdentifierHistory.objects.exclude(identifier__startswith='070').delete()
        for household_identifier_history in HouseholdIdentifierHistory.objects.all():
            ...
            household_identifier_history.plot_identifier = household_identifier_history.identifier.split('{0}-'.format(household_sequence))[0]
            household_identifier_history.save()
