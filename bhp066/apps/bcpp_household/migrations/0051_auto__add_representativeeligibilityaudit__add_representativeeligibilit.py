...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ReplacementHistory', fields ['replaced_item', 'replacing_item']
        db.create_unique(u'bcpp_household_replacementhistory', ['replaced_item', 'replacing_item'])

        # Deleting field 'Household.reason_not_enumerated'
        db.delete_column(u'bcpp_household_household', 'reason_not_enumerated')

        # Deleting field 'Household.enumerated'
        db.delete_column(u'bcpp_household_household', 'enumerated')
        ...
        # Deleting field 'HouseholdAudit.enumerated'
        db.delete_column(u'bcpp_household_household_audit', 'enumerated')


    def backwards(self, orm):
        # Removing unique constraint on 'ReplacementHistory', fields ['replaced_item', 'replacing_item']
        db.delete_unique(u'bcpp_household_replacementhistory', ['replaced_item', 'replacing_item'])
        ...
        # Deleting field 'HouseholdRefusalAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_householdrefusal_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdAssessmentAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_householdassessment_audit', '_audit_subject_identifier')

        # Adding field 'Household.reason_not_enumerated'
        db.add_column(u'bcpp_household_household', 'reason_not_enumerated',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Household.enumerated'
        db.add_column(u'bcpp_household_household', 'enumerated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PlotLogEntryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_plotlogentry_audit', '_audit_subject_identifier')

        # Adding field 'HouseholdAudit.reason_not_enumerated'
        db.add_column(u'bcpp_household_household_audit', 'reason_not_enumerated',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.enumerated'
        db.add_column(u'bcpp_household_household_audit', 'enumerated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Deleting field 'ReplacementHistoryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_replacementhistory_audit', '_audit_subject_identifier')
        ...
        # Deleting field 'PlotLogAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_plotlog_audit', '_audit_subject_identifier')

        # Deleting field 'HouseholdRefusalHistoryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_household_householdrefusalhistory_audit', '_audit_subject_identifier')
