...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plot.selected'
        db.add_column(u'bcpp_household_plot', 'selected',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'PlotAudit.selected'
        db.add_column(u'bcpp_household_plot_audit', 'selected',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plot.selected'
        db.delete_column(u'bcpp_household_plot', 'selected')

        # Deleting field 'PlotAudit.selected'
        db.delete_column(u'bcpp_household_plot_audit', 'selected')
