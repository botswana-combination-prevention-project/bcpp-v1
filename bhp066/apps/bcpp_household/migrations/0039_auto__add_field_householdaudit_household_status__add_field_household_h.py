...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'HouseholdAudit.household_status'
        db.delete_column(u'bcpp_household_household_audit', 'household_status')

        # Deleting field 'Household.household_status'
        db.delete_column(u'bcpp_household_household', 'household_status')
