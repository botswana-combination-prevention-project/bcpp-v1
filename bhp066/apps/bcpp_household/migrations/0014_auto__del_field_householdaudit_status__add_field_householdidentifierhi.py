...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdAudit.status'
        db.delete_column(u'bcpp_household_household_audit', 'status')

        # Adding field 'HouseholdIdentifierHistory.plot_identifier'
        db.add_column(u'bcpp_household_householdidentifierhistory', 'plot_identifier',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=25),
                      keep_default=False)

        # Adding field 'HouseholdIdentifierHistory.household_sequence'
        db.add_column(u'bcpp_household_householdidentifierhistory', 'household_sequence',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Household.status'
        db.delete_column(u'bcpp_household_household', 'status')


    def backwards(self, orm):
        # Adding field 'HouseholdAudit.status'
        db.add_column(u'bcpp_household_household_audit', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True),
                      keep_default=False)

        # Deleting field 'HouseholdIdentifierHistory.plot_identifier'
        db.delete_column(u'bcpp_household_householdidentifierhistory', 'plot_identifier')

        # Deleting field 'HouseholdIdentifierHistory.household_sequence'
        db.delete_column(u'bcpp_household_householdidentifierhistory', 'household_sequence')

        # Adding field 'Household.status'
        db.add_column(u'bcpp_household_household', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True),
                      keep_default=False)
