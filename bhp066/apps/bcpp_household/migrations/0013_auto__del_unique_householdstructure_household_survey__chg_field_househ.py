...
#         db.delete_unique(u'bcpp_household_householdstructure', ['household_id', 'survey_id'])
        ...
        db.alter_column(u'bcpp_household_household_audit', 'community', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HouseholdAudit.household_sequence'
        db.alter_column(u'bcpp_household_household_audit', 'household_sequence', self.gf('django.db.models.fields.IntegerField')(null=True))
...
#         db.delete_index(u'bcpp_household_household_audit', ['household_identifier'])
        ...
        db.alter_column(u'bcpp_household_household', 'community', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Household.household_sequence'
        db.alter_column(u'bcpp_household_household', 'household_sequence', self.gf('django.db.models.fields.IntegerField')(null=True))
