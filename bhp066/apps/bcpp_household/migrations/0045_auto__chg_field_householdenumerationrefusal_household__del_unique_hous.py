...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_household_householdenumerationrefusal', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_household.Household'], null=True))

        # Changing field 'HouseholdEnumerationRefusalAudit.household'
        db.alter_column(u'bcpp_household_householdenumerationrefusal_audit', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bcpp_household.Household']))

    def backwards(self, orm):

        # Changing field 'HouseholdEnumerationRefusal.household'
        db.alter_column(u'bcpp_household_householdenumerationrefusal', 'household_id', self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['bcpp_household.Household'], unique=True))
        ...
        # Changing field 'HouseholdEnumerationRefusalAudit.household'
        db.alter_column(u'bcpp_household_householdenumerationrefusal_audit', 'household_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['bcpp_household.Household']))
    ...
    models = {
        ...
        'bcpp_household.householdenumerationrefusalaudit': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'ckgathi'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'ckgathi'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_householdenumerationrefusal'", 'null': 'True', 'to': "orm['bcpp_household.Household']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'reason_other': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
