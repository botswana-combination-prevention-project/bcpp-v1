...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bcpp_household_household_audit', 'is_randomised')

        # Deleting field 'Household.is_randomised'
        db.delete_column(u'bcpp_household_household', 'is_randomised')


    def backwards(self, orm):
        # Adding field 'HouseholdAudit.is_randomised'
        db.add_column(u'bcpp_household_household_audit', 'is_randomised',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Household.is_randomised'
        db.add_column(u'bcpp_household_household', 'is_randomised',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
