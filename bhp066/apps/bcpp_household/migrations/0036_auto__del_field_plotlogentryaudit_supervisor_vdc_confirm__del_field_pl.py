...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlotLogEntryAudit.supervisor_vdc_confirm'
        db.delete_column(u'bcpp_household_plotlogentry_audit', 'supervisor_vdc_confirm')

        # Deleting field 'PlotLogEntryAudit.rarely_present'
        db.delete_column(u'bcpp_household_plotlogentry_audit', 'rarely_present')
        ...
        # Adding field 'HouseholdLogEntry.supervisor_vdc_confirm'
        db.add_column(u'bcpp_household_householdlogentry', 'supervisor_vdc_confirm',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlotLogEntry.supervisor_vdc_confirm'
        db.delete_column(u'bcpp_household_plotlogentry', 'supervisor_vdc_confirm')

        # Deleting field 'PlotLogEntry.rarely_present'
        db.delete_column(u'bcpp_household_plotlogentry', 'rarely_present')
        ...
        # Adding field 'HouseholdLogEntryAudit.supervisor_vdc_confirm'
        db.add_column(u'bcpp_household_householdlogentry_audit', 'supervisor_vdc_confirm',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PlotLogEntryAudit.supervisor_vdc_confirm'
        db.add_column(u'bcpp_household_plotlogentry_audit', 'supervisor_vdc_confirm',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=3, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'PlotLogEntryAudit.rarely_present'
        db.add_column(u'bcpp_household_plotlogentry_audit', 'rarely_present',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, db_index=True),
                      keep_default=False)
        ...
        # Deleting field 'HouseholdLogEntry.supervisor_vdc_confirm'
        db.delete_column(u'bcpp_household_householdlogentry', 'supervisor_vdc_confirm')

        # Adding field 'PlotLogEntry.supervisor_vdc_confirm'
        db.add_column(u'bcpp_household_plotlogentry', 'supervisor_vdc_confirm',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=3, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'PlotLogEntry.rarely_present'
        db.add_column(u'bcpp_household_plotlogentry', 'rarely_present',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, db_index=True),
                      keep_default=False)
        ...
        # Deleting field 'HouseholdLogEntryAudit.supervisor_vdc_confirm'
        db.delete_column(u'bcpp_household_householdlogentry_audit', 'supervisor_vdc_confirm')
