...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plot.uploaded_map'
        db.delete_column(u'bcpp_household_plot', 'uploaded_map')

        # Adding field 'Plot.uploaded_map_16'
        db.add_column(u'bcpp_household_plot', 'uploaded_map_16',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.uploaded_map_17'
        db.add_column(u'bcpp_household_plot', 'uploaded_map_17',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.uploaded_map_18'
        db.add_column(u'bcpp_household_plot', 'uploaded_map_18',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlotAudit.uploaded_map'
        db.delete_column(u'bcpp_household_plot_audit', 'uploaded_map')

        # Adding field 'PlotAudit.uploaded_map_16'
        db.add_column(u'bcpp_household_plot_audit', 'uploaded_map_16',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotAudit.uploaded_map_17'
        db.add_column(u'bcpp_household_plot_audit', 'uploaded_map_17',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotAudit.uploaded_map_18'
        db.add_column(u'bcpp_household_plot_audit', 'uploaded_map_18',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plot.uploaded_map'
        db.add_column(u'bcpp_household_plot', 'uploaded_map',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Plot.uploaded_map_16'
        db.delete_column(u'bcpp_household_plot', 'uploaded_map_16')

        # Deleting field 'Plot.uploaded_map_17'
        db.delete_column(u'bcpp_household_plot', 'uploaded_map_17')

        # Deleting field 'Plot.uploaded_map_18'
        db.delete_column(u'bcpp_household_plot', 'uploaded_map_18')

        # Adding field 'PlotAudit.uploaded_map'
        db.add_column(u'bcpp_household_plot_audit', 'uploaded_map',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlotAudit.uploaded_map_16'
        db.delete_column(u'bcpp_household_plot_audit', 'uploaded_map_16')

        # Deleting field 'PlotAudit.uploaded_map_17'
        db.delete_column(u'bcpp_household_plot_audit', 'uploaded_map_17')

        # Deleting field 'PlotAudit.uploaded_map_18'
        db.delete_column(u'bcpp_household_plot_audit', 'uploaded_map_18')
    ...
    models = {
        ...
        'bcpp_household.plot': {
            ...
            'uploaded_map_16': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'uploaded_map_17': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'uploaded_map_18': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
