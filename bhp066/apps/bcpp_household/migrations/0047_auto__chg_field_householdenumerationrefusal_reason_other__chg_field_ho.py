...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseholdEnumerationRefusal.reason_other'
        db.alter_column(u'bcpp_household_householdenumerationrefusal', 'reason_other', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'HouseholdEnumerationRefusalAudit.reason_other'
        db.alter_column(u'bcpp_household_householdenumerationrefusal_audit', 'reason_other', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'HouseholdEnumerationRefusal.reason_other'
        db.alter_column(u'bcpp_household_householdenumerationrefusal', 'reason_other', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'HouseholdEnumerationRefusalAudit.reason_other'
        db.alter_column(u'bcpp_household_householdenumerationrefusal_audit', 'reason_other', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
