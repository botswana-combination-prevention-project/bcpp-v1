...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plot.gps_target_lat'
        db.alter_column(u'bcpp_household_plot', 'gps_target_lat', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Plot.gps_target_lon'
        db.alter_column(u'bcpp_household_plot', 'gps_target_lon', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Plot.gps_lat'
        db.alter_column(u'bcpp_household_plot', 'gps_lat', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'Plot.gps_lon'
        db.alter_column(u'bcpp_household_plot', 'gps_lon', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'PlotAudit.gps_target_lat'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_target_lat', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'PlotAudit.gps_target_lon'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_target_lon', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'PlotAudit.gps_lat'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_lat', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'PlotAudit.gps_lon'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_lon', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

    def backwards(self, orm):

        # Changing field 'Plot.gps_target_lat'
        db.alter_column(u'bcpp_household_plot', 'gps_target_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Plot.gps_target_lon'
        db.alter_column(u'bcpp_household_plot', 'gps_target_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Plot.gps_lat'
        db.alter_column(u'bcpp_household_plot', 'gps_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Plot.gps_lon'
        db.alter_column(u'bcpp_household_plot', 'gps_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotAudit.gps_target_lat'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_target_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotAudit.gps_target_lon'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_target_lon', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotAudit.gps_lat'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotAudit.gps_lon'
        db.alter_column(u'bcpp_household_plot_audit', 'gps_lon', self.gf('django.db.models.fields.FloatField')(null=True))
