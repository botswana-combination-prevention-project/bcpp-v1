...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Household.reason_not_enumerate'
        db.add_column(u'bcpp_household_household', 'reason_not_enumerate',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.reason_not_enumerate'
        db.add_column(u'bcpp_household_household_audit', 'reason_not_enumerate',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Household.reason_not_enumerate'
        db.delete_column(u'bcpp_household_household', 'reason_not_enumerate')

        # Deleting field 'HouseholdAudit.reason_not_enumerate'
        db.delete_column(u'bcpp_household_household_audit', 'reason_not_enumerate')
    ...
    models = {
        ...
        'bcpp_household.household': {
            ...
            'reason_not_enumerate': ('django.db.models.fields.CharField', [], {'default': "'Yes'", 'max_length': '25', 'blank': 'True'}),
