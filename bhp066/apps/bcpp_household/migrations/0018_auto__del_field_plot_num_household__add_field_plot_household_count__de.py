...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plot.num_household'
        db.rename_column(u'bcpp_household_plot', 'num_household', 'household_count')

        # Deleting field 'PlotAudit.num_household'
        db.rename_column(u'bcpp_household_plot_audit', 'num_household', 'household_count')
