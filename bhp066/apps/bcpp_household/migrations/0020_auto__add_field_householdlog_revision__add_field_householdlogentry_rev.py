...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HouseholdLog.revision'
        db.add_column(u'bcpp_household_householdlog', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdLogEntry.revision'
        db.add_column(u'bcpp_household_householdlogentry', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdStructure.revision'
        db.add_column(u'bcpp_household_householdstructure', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdLogEntryAudit.revision'
        db.add_column(u'bcpp_household_householdlogentry_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.revision'
        db.add_column(u'bcpp_household_plot', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotIdentifierHistory.revision'
        db.add_column(u'bcpp_household_plotidentifierhistory', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdStructureAudit.revision'
        db.add_column(u'bcpp_household_householdstructure_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdAudit.revision'
        db.add_column(u'bcpp_household_household_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdIdentifierHistory.revision'
        db.add_column(u'bcpp_household_householdidentifierhistory', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdLogAudit.revision'
        db.add_column(u'bcpp_household_householdlog_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Household.revision'
        db.add_column(u'bcpp_household_household', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotAudit.revision'
        db.add_column(u'bcpp_household_plot_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HouseholdLog.revision'
        db.delete_column(u'bcpp_household_householdlog', 'revision')

        # Deleting field 'HouseholdLogEntry.revision'
        db.delete_column(u'bcpp_household_householdlogentry', 'revision')

        # Deleting field 'HouseholdStructure.revision'
        db.delete_column(u'bcpp_household_householdstructure', 'revision')

        # Deleting field 'HouseholdLogEntryAudit.revision'
        db.delete_column(u'bcpp_household_householdlogentry_audit', 'revision')

        # Deleting field 'Plot.revision'
        db.delete_column(u'bcpp_household_plot', 'revision')

        # Deleting field 'PlotIdentifierHistory.revision'
        db.delete_column(u'bcpp_household_plotidentifierhistory', 'revision')

        # Deleting field 'HouseholdStructureAudit.revision'
        db.delete_column(u'bcpp_household_householdstructure_audit', 'revision')

        # Deleting field 'HouseholdAudit.revision'
        db.delete_column(u'bcpp_household_household_audit', 'revision')

        # Deleting field 'HouseholdIdentifierHistory.revision'
        db.delete_column(u'bcpp_household_householdidentifierhistory', 'revision')

        # Deleting field 'HouseholdLogAudit.revision'
        db.delete_column(u'bcpp_household_householdlog_audit', 'revision')

        # Deleting field 'Household.revision'
        db.delete_column(u'bcpp_household_household', 'revision')

        # Deleting field 'PlotAudit.revision'
        db.delete_column(u'bcpp_household_plot_audit', 'revision')
