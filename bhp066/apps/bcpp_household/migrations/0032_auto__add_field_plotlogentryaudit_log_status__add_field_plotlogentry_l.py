...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlotLogEntryAudit.log_status'
        db.add_column(u'bcpp_household_plotlogentry_audit', 'log_status',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotLogEntry.log_status'
        db.add_column(u'bcpp_household_plotlogentry', 'log_status',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlotLogEntryAudit.log_status'
        db.delete_column(u'bcpp_household_plotlogentry_audit', 'log_status')

        # Deleting field 'PlotLogEntry.log_status'
        db.delete_column(u'bcpp_household_plotlogentry', 'log_status')
