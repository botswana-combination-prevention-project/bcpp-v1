...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plot.availability_datetime'
        db.delete_column(u'bcpp_household_plot', 'availability_datetime')

        # Adding field 'Plot.time_of_week'
        db.add_column(u'bcpp_household_plot', 'time_of_week',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.time_of_day'
        db.add_column(u'bcpp_household_plot', 'time_of_day',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PlotAudit.availability_datetime'
        db.delete_column(u'bcpp_household_plot_audit', 'availability_datetime')

        # Adding field 'PlotAudit.time_of_week'
        db.add_column(u'bcpp_household_plot_audit', 'time_of_week',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlotAudit.time_of_day'
        db.add_column(u'bcpp_household_plot_audit', 'time_of_day',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Plot.availability_datetime'
        db.add_column(u'bcpp_household_plot', 'availability_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Plot.time_of_week'
        db.delete_column(u'bcpp_household_plot', 'time_of_week')

        # Deleting field 'Plot.time_of_day'
        db.delete_column(u'bcpp_household_plot', 'time_of_day')

        # Adding field 'PlotAudit.availability_datetime'
        db.add_column(u'bcpp_household_plot_audit', 'availability_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'PlotAudit.time_of_week'
        db.delete_column(u'bcpp_household_plot_audit', 'time_of_week')

        # Deleting field 'PlotAudit.time_of_day'
        db.delete_column(u'bcpp_household_plot_audit', 'time_of_day')
