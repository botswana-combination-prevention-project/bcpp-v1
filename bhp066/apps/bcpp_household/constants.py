...
RARELY_NEVER_OCCUPIED = 'rarely_occupied_or_never_occupied'  # NOT replaced
SEASONALLY_NEARLY_ALWAYS_OCCUPIED = 'seasonally_occupied_or_nearly_always_present'  # replace
