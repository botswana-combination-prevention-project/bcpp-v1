...
class HouseholdDashboardPage(BasePage):
    ...
    check_eligibility = (By.XPATH, ".//*[@id='tile_wrapper']/table[2]/tbody/tr/td[10]/a")
    subject_dashboard = (By.XPATH, ".//*[@id='tile_wrapper']/table[2]/tbody/tr/td[10]/ol/li[2]/a")
    subject_dashboard1 = (By.XPATH, ".//*[@id='tile_wrapper']/table[2]/tbody/tr/td[10]/a")
    ...
    def click_subject_consent(self):
        try:
            ...
            self.browser.find_element(*HouseholdDashboardPage.subject_dashboard1).click()

    def click_check_eligibility_link(self):
        try:
            self.browser.find_element(*HouseholdDashboardPage.check_eligibility).click()
            return True
        except NoSuchElementException:
    ...
    @property
    def is_fill_hod_eligibility_checklist_link(self):
        try:
            return self.browser.find_element(*HouseholdDashboardPage.hod_eligibility_checklist_link).is_displayed()
        except NoSuchElementException:
            return False
