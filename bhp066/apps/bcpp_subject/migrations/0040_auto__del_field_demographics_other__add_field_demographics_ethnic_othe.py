...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bcpp_subject_demographics', 'other')

        # Adding field 'Demographics.ethnic_other'
        db.add_column(u'bcpp_subject_demographics', 'ethnic_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.consent_signature'
        db.add_column(u'bcpp_subject_subjectconsent_audit', 'consent_signature',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.consent_signature'
        db.add_column(u'bcpp_subject_subjectconsent', 'consent_signature',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Deleting field 'DemographicsAudit.other'
        db.delete_column(u'bcpp_subject_demographics_audit', 'other')

        # Adding field 'DemographicsAudit.ethnic_other'
        db.add_column(u'bcpp_subject_demographics_audit', 'ethnic_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bcpp_subject_demographics', 'other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Deleting field 'Demographics.ethnic_other'
        db.delete_column(u'bcpp_subject_demographics', 'ethnic_other')

        # Deleting field 'SubjectConsentAudit.consent_signature'
        db.delete_column(u'bcpp_subject_subjectconsent_audit', 'consent_signature')

        # Deleting field 'SubjectConsent.consent_signature'
        db.delete_column(u'bcpp_subject_subjectconsent', 'consent_signature')

        # Adding field 'DemographicsAudit.other'
        db.add_column(u'bcpp_subject_demographics_audit', 'other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Deleting field 'DemographicsAudit.ethnic_other'
        db.delete_column(u'bcpp_subject_demographics_audit', 'ethnic_other')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 4, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 4, 0, 0)'}),
