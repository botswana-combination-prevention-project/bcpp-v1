...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_subject_hivresultdocumentation', 'result_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'HivTestReviewAudit.hiv_test_date'
        db.alter_column(u'bcpp_subject_hivtestreview_audit', 'hiv_test_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'HivTestReview.hiv_test_date'
        db.alter_column(u'bcpp_subject_hivtestreview', 'hiv_test_date', self.gf('django.db.models.fields.DateField')())
        ...
        db.alter_column(u'bcpp_subject_hivresultdocumentation_audit', 'result_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'HivResultDocumentation.result_date'
        db.alter_column(u'bcpp_subject_hivresultdocumentation', 'result_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'HivTestReviewAudit.hiv_test_date'
        db.alter_column(u'bcpp_subject_hivtestreview_audit', 'hiv_test_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'HivTestReview.hiv_test_date'
        db.alter_column(u'bcpp_subject_hivtestreview', 'hiv_test_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'HivMedicalCareAudit.first_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'HivMedicalCareAudit.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'HivMedicalCare.first_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'HivMedicalCare.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateTimeField')(max_length=25, null=True))

        # Changing field 'HivResultDocumentationAudit.result_date'
        db.alter_column(u'bcpp_subject_hivresultdocumentation_audit', 'result_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)'}),
        ...
        'bcpp_subject.pregnancy': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'last_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'lnmp': ('django.db.models.fields.DateTimeField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'preg_arv': ('django.db.models.fields.CharField', [], {'max_length': '95', 'null': 'True', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)'}),
            'subject_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_subject.SubjectVisit']", 'unique': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)'}),
