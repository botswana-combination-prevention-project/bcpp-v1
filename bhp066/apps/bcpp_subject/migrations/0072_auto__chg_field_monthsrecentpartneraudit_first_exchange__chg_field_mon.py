...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))

        # Changing field 'MonthsSecondPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))

        # Changing field 'MonthsThirdPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))

        # Changing field 'MonthsThirdPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))

        # Changing field 'MonthsRecentPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))

        # Changing field 'MonthsSecondPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_exchange', self.gf('django.db.models.fields.CharField')(default='18-29', max_length=40))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
