...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubjectVisitAudit.household_member'
        db.add_column('bcpp_subject_subjectvisit_audit', 'household_member',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='-', related_name='_audit_subjectvisit', to=orm['bcpp_household_member.HouseholdMember']),
                      keep_default=False)

        # Adding field 'SubjectVisit.household_member'
        db.add_column('bcpp_subject_subjectvisit', 'household_member',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='-', to=orm['bcpp_household_member.HouseholdMember'], unique=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubjectVisitAudit.household_member'
        db.delete_column('bcpp_subject_subjectvisit_audit', 'household_member_id')

        # Deleting field 'SubjectVisit.household_member'
        db.delete_column('bcpp_subject_subjectvisit', 'household_member_id')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)'}),
