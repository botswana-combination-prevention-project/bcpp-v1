...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRefusal.subject_refusal_status'
        db.alter_column('bcpp_subject_subjectrefusal', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SubjectRefusal.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Education.monthly_income'
        db.alter_column('bcpp_subject_education', 'monthly_income', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Education.job_description'
        db.alter_column('bcpp_subject_education', 'job_description', self.gf('django.db.models.fields.CharField')(max_length=65, null=True))

        # Changing field 'SubjectRefusalAudit.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SubjectRefusalAudit.subject_refusal_status'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'EducationAudit.monthly_income'
        db.alter_column('bcpp_subject_education_audit', 'monthly_income', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'EducationAudit.job_description'
        db.alter_column('bcpp_subject_education_audit', 'job_description', self.gf('django.db.models.fields.CharField')(max_length=65, null=True))

    def backwards(self, orm):

        # Changing field 'SubjectRefusal.subject_refusal_status'
        db.alter_column('bcpp_subject_subjectrefusal', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectRefusal.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Education.monthly_income'
        db.alter_column('bcpp_subject_education', 'monthly_income', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'Education.job_description'
        db.alter_column('bcpp_subject_education', 'job_description', self.gf('django.db.models.fields.CharField')(default=0, max_length=65))
        ...
        # Changing field 'SubjectRefusalAudit.subject_refusal_status'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'subject_refusal_status', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'EducationAudit.monthly_income'
        db.alter_column('bcpp_subject_education_audit', 'monthly_income', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'EducationAudit.job_description'
        db.alter_column('bcpp_subject_education_audit', 'job_description', self.gf('django.db.models.fields.CharField')(default=0, max_length=65))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 6, 0, 0)'}),
        ...
        'bcpp_subject.subjectrefusal': {
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'why_no_hivtest': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
