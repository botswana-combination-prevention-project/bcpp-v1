...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bcpp_subject_residencymobility', 'forteen_nights')

        # Adding field 'ResidencyMobility.permanent_resident'
        db.add_column(u'bcpp_subject_residencymobility', 'permanent_resident',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)

        # Deleting field 'ResidencyMobilityAudit.forteen_nights'
        db.delete_column(u'bcpp_subject_residencymobility_audit', 'forteen_nights')

        # Adding field 'ResidencyMobilityAudit.permanent_resident'
        db.add_column(u'bcpp_subject_residencymobility_audit', 'permanent_resident',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'bcpp_subject_subjectabsenteereport', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 8, 0, 0))),
        ...
        db.add_column(u'bcpp_subject_residencymobility', 'forteen_nights',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Deleting field 'ResidencyMobility.permanent_resident'
        db.delete_column(u'bcpp_subject_residencymobility', 'permanent_resident')

        # Adding field 'ResidencyMobilityAudit.forteen_nights'
        db.add_column(u'bcpp_subject_residencymobility_audit', 'forteen_nights',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Deleting field 'ResidencyMobilityAudit.permanent_resident'
        db.delete_column(u'bcpp_subject_residencymobility_audit', 'permanent_resident')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 10, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 10, 0, 0)'}),
