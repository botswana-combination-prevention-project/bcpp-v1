...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ParticipationAudit.description'
        db.delete_column(u'bcpp_subject_participation_audit', 'description')

        # Adding field 'ParticipationAudit.participation_type'
        db.add_column(u'bcpp_subject_participation_audit', 'participation_type',
                      self.gf('django.db.models.fields.CharField')(default='Non', max_length=30),
                      keep_default=False)

        # Deleting field 'Participation.description'
        db.delete_column(u'bcpp_subject_participation', 'description')

        # Adding field 'Participation.participation_type'
        db.add_column(u'bcpp_subject_participation', 'participation_type',
                      self.gf('django.db.models.fields.CharField')(default='Non', max_length=30),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
