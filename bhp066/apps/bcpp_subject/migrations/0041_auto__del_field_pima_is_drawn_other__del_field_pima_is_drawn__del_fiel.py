...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'HivMedicalCareAudit.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))
        ...
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

        # Changing field 'HivMedicalCare.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateField')(max_length=25, null=True))

    def backwards(self, orm):
        # Adding field 'Pima.is_drawn_other'
        db.add_column(u'bcpp_subject_pima', 'is_drawn_other',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pima.is_drawn'
        db.add_column(u'bcpp_subject_pima', 'is_drawn',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'Pima.draw_time'
        db.add_column(u'bcpp_subject_pima', 'draw_time',
                      self.gf('django.db.models.fields.TimeField')(default=0),
                      keep_default=False)

        # Deleting field 'Pima.pima_today'
        db.delete_column(u'bcpp_subject_pima', 'pima_today')

        # Deleting field 'Pima.pima_today_other'
        db.delete_column(u'bcpp_subject_pima', 'pima_today_other')


        # Changing field 'Pima.cd4_value'
        db.alter_column(u'bcpp_subject_pima', 'cd4_value', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2))

        # Changing field 'Pima.pima_id'
        db.alter_column(u'bcpp_subject_pima', 'pima_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=9))
        # Adding field 'PimaAudit.is_drawn_other'
        db.add_column(u'bcpp_subject_pima_audit', 'is_drawn_other',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PimaAudit.is_drawn'
        db.add_column(u'bcpp_subject_pima_audit', 'is_drawn',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=3),
                      keep_default=False)

        # Adding field 'PimaAudit.draw_time'
        db.add_column(u'bcpp_subject_pima_audit', 'draw_time',
                      self.gf('django.db.models.fields.TimeField')(default=0),
                      keep_default=False)

        # Deleting field 'PimaAudit.pima_today'
        db.delete_column(u'bcpp_subject_pima_audit', 'pima_today')

        # Deleting field 'PimaAudit.pima_today_other'
        db.delete_column(u'bcpp_subject_pima_audit', 'pima_today_other')


        # Changing field 'PimaAudit.cd4_value'
        db.alter_column(u'bcpp_subject_pima_audit', 'cd4_value', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=2))

        # Changing field 'PimaAudit.pima_id'
        db.alter_column(u'bcpp_subject_pima_audit', 'pima_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=9))
        # Deleting field 'HivCareAdherence.therapy_evidence'
        db.delete_column(u'bcpp_subject_hivcareadherence', 'therapy_evidence')


        # Changing field 'HivMedicalCareAudit.first_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateField')(default=0, max_length=25))

        # Changing field 'HivMedicalCareAudit.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare_audit', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateField')(default=0, max_length=25))
        ...
        # Changing field 'HivMedicalCare.first_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'first_hiv_care_pos', self.gf('django.db.models.fields.DateField')(default=0, max_length=25))

        # Changing field 'HivMedicalCare.last_hiv_care_pos'
        db.alter_column(u'bcpp_subject_hivmedicalcare', 'last_hiv_care_pos', self.gf('django.db.models.fields.DateField')(default=0, max_length=25))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 0)'}),
        ...
        'bcpp_subject.pima': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'pima_id': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 7, 0, 0)'}),
