...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BloodDrawAudit.last_cd4_count'
        db.add_column('bcpp_subject_blooddraw_audit', 'last_cd4_count',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'BloodDrawAudit.last_cd4_drawn_date'
        db.add_column('bcpp_subject_blooddraw_audit', 'last_cd4_drawn_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BloodDraw.last_cd4_count'
        db.add_column('bcpp_subject_blooddraw', 'last_cd4_count',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'BloodDraw.last_cd4_drawn_date'
        db.add_column('bcpp_subject_blooddraw', 'last_cd4_drawn_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BloodDrawAudit.last_cd4_count'
        db.delete_column('bcpp_subject_blooddraw_audit', 'last_cd4_count')

        # Deleting field 'BloodDrawAudit.last_cd4_drawn_date'
        db.delete_column('bcpp_subject_blooddraw_audit', 'last_cd4_drawn_date')

        # Deleting field 'BloodDraw.last_cd4_count'
        db.delete_column('bcpp_subject_blooddraw', 'last_cd4_count')

        # Deleting field 'BloodDraw.last_cd4_drawn_date'
        db.delete_column('bcpp_subject_blooddraw', 'last_cd4_drawn_date')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 8, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 8, 0, 0)'}),
