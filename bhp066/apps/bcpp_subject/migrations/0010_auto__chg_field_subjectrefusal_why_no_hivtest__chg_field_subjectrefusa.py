...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SubjectRefusalAudit.why_no_hivtest'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
