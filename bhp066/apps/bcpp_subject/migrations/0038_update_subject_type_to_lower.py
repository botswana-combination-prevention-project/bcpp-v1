...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        RegisteredSubject = orm['bhp_registration.RegisteredSubject']
        for rs in RegisteredSubject.objects.all():
            if rs.subject_type:
                print rs.subject_identifier
                rs.subject_type = rs.subject_type.lower()
                rs.save()
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
