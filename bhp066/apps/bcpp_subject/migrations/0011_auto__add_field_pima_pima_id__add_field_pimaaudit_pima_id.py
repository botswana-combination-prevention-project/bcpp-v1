...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pima.pima_id'
        db.add_column('bcpp_subject_pima', 'pima_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=9),
                      keep_default=False)

        # Adding field 'PimaAudit.pima_id'
        db.add_column('bcpp_subject_pima_audit', 'pima_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pima.pima_id'
        db.delete_column('bcpp_subject_pima', 'pima_id')

        # Deleting field 'PimaAudit.pima_id'
        db.delete_column('bcpp_subject_pima_audit', 'pima_id')
