...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommunityEngagement.problems_engagement_other'
        db.alter_column(u'bcpp_subject_communityengagement', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'CommunityEngagement.vote_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'vote_engagement', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CommunityEngagement.solve_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'solve_engagement', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'CommunityEngagement.community_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'community_engagement', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'CommunityEngagementAudit.problems_engagement_other'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'CommunityEngagementAudit.vote_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'vote_engagement', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CommunityEngagementAudit.solve_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'solve_engagement', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'CommunityEngagementAudit.community_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'community_engagement', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'CommunityEngagement.problems_engagement_other'
        db.alter_column(u'bcpp_subject_communityengagement', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'CommunityEngagement.vote_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'vote_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'CommunityEngagement.solve_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'solve_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'CommunityEngagement.community_engagement'
        db.alter_column(u'bcpp_subject_communityengagement', 'community_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'CommunityEngagementAudit.problems_engagement_other'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'problems_engagement_other', self.gf('django.db.models.fields.CharField')(default='', max_length=35))

        # Changing field 'CommunityEngagementAudit.vote_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'vote_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'CommunityEngagementAudit.solve_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'solve_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'CommunityEngagementAudit.community_engagement'
        db.alter_column(u'bcpp_subject_communityengagement_audit', 'community_engagement', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 0)'}),
