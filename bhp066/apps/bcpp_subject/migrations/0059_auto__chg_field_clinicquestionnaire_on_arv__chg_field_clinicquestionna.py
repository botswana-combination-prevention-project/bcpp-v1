...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClinicQuestionnaire.on_arv'
        db.alter_column(u'bcpp_subject_clinicquestionnaire', 'on_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'ClinicQuestionnaireAudit.on_arv'
        db.alter_column(u'bcpp_subject_clinicquestionnaire_audit', 'on_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'ClinicQuestionnaire.on_arv'
        db.alter_column(u'bcpp_subject_clinicquestionnaire', 'on_arv', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'ClinicQuestionnaireAudit.on_arv'
        db.alter_column(u'bcpp_subject_clinicquestionnaire_audit', 'on_arv', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))
