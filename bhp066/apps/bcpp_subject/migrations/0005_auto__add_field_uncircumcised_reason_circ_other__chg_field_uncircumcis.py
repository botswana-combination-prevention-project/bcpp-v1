...
#                       keep_default=False)
        ...
        db.alter_column('bcpp_subject_uncircumcised_audit', 'service_facilities', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'UncircumcisedAudit.circumcision_week'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'circumcision_week', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'UncircumcisedAudit.future_reasons_smc'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'future_reasons_smc', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'UncircumcisedAudit.circumcision_year'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'circumcision_year', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'UncircumcisedAudit.circumcision_day'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'circumcision_day', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'UncircumcisedAudit.reason_circ'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'reason_circ', self.gf('django.db.models.fields.CharField')(max_length=65, null=True))

        # Changing field 'UncircumcisedAudit.aware_free'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'aware_free', self.gf('django.db.models.fields.CharField')(max_length=85, null=True))

        # Changing field 'UncircumcisedAudit.future_circ'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'future_circ', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):
        # Deleting field 'Uncircumcised.reason_circ_other'
        db.delete_column('bcpp_subject_uncircumcised', 'reason_circ_other')
        ...
        # Changing field 'Uncircumcised.aware_free'
        db.alter_column('bcpp_subject_uncircumcised', 'aware_free', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
        ...
        # Changing field 'Uncircumcised.future_circ'
        db.alter_column('bcpp_subject_uncircumcised', 'future_circ', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'HivTestingHistory.other_record'
        db.alter_column('bcpp_subject_hivtestinghistory', 'other_record', self.gf('django.db.models.fields.CharField')(default=0, max_length=3))

        # Changing field 'HivTestingHistoryAudit.other_record'
        db.alter_column('bcpp_subject_hivtestinghistory_audit', 'other_record', self.gf('django.db.models.fields.CharField')(default=0, max_length=3))
        # Deleting field 'UncircumcisedAudit.reason_circ_other'
        db.delete_column('bcpp_subject_uncircumcised_audit', 'reason_circ_other')
        ...
        # Changing field 'UncircumcisedAudit.aware_free'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'aware_free', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'UncircumcisedAudit.future_circ'
        db.alter_column('bcpp_subject_uncircumcised_audit', 'future_circ', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 2, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 2, 0, 0)'}),
