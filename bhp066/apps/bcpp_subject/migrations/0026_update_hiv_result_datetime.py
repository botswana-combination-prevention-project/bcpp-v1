...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for hiv_result in orm['bcpp_subject.HivResult'].objects.all():
            if not hiv_result.hiv_result_datetime:
                hiv_result.hiv_result_datetime = hiv_result.report_datetime
                hiv_result.save()
