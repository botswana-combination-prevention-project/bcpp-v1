...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Circumcised.age_unit_circ'
        db.alter_column(u'bcpp_subject_circumcised', 'age_unit_circ', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SubjectConsentAudit.dob'
        db.alter_column(u'bcpp_subject_subjectconsent_audit', 'dob', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'SubjectConsent.dob'
        db.alter_column(u'bcpp_subject_subjectconsent', 'dob', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CircumcisedAudit.age_unit_circ'
        db.alter_column(u'bcpp_subject_circumcised_audit', 'age_unit_circ', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Circumcised.age_unit_circ'
        db.alter_column(u'bcpp_subject_circumcised', 'age_unit_circ', self.gf('django.db.models.fields.CharField')(default='Years', max_length=25))

        # Changing field 'SubjectConsentAudit.dob'
        db.alter_column(u'bcpp_subject_subjectconsent_audit', 'dob', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'SubjectConsent.dob'
        db.alter_column(u'bcpp_subject_subjectconsent', 'dob', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True))

        # Changing field 'CircumcisedAudit.age_unit_circ'
        db.alter_column(u'bcpp_subject_circumcised_audit', 'age_unit_circ', self.gf('django.db.models.fields.CharField')(default='Year', max_length=25))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 6, 0, 0)'}),
