...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
       # Adding field 'SubjectLocatorAudit.exported'
        db.add_column(u'bcpp_subject_subjectlocator_audit', 'exported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SubjectLocatorAudit.exported_datetime'
        db.add_column(u'bcpp_subject_subjectlocator_audit', 'exported_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'SubjectLocatorAudit.export_uuid'
        db.add_column(u'bcpp_subject_subjectlocator_audit', 'export_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)
        
        db.add_column(u'bcpp_subject_subjectlocator', 'exported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SubjectLocatorAudit.exported_datetime'
        db.add_column(u'bcpp_subject_subjectlocator', 'exported_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'SubjectLocatorAudit.export_uuid'
        db.add_column(u'bcpp_subject_subjectlocator', 'export_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)
       
#         # Changing field 'MonthsRecentPartnerAudit.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsRecentPartnerAudit.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsRecentPartnerAudit.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
#         # Deleting field 'SubjectReferral.last_cd4_test_date'
#         db.delete_column(u'bcpp_subject_subjectreferral', 'last_cd4_test_date')
# 
#         # Deleting field 'SubjectReferral.last_cd4_result'
#         db.delete_column(u'bcpp_subject_subjectreferral', 'last_cd4_result')
# 
#         # Deleting field 'SubjectReferral.referred_from_bhs'
#         db.delete_column(u'bcpp_subject_subjectreferral', 'referred_from_bhs')
# 
...
# 
#         # Deleting field 'SubjectReferral.vl_sample_datetime_drawn'
#         db.delete_column(u'bcpp_subject_subjectreferral', 'vl_sample_datetime_drawn')
# 
#         # Adding field 'SubjectReferral.citizen_spouse'
#         db.add_column(u'bcpp_subject_subjectreferral', 'citizen_spouse',
#                       self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.verbal_hiv_result'
#         db.add_column(u'bcpp_subject_subjectreferral', 'verbal_hiv_result',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.direct_hiv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral', 'direct_hiv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.indirect_hiv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral', 'indirect_hiv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.arv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral', 'arv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.arv_clinic'
#         db.add_column(u'bcpp_subject_subjectreferral', 'arv_clinic',
#                       self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.next_arv_clinic_appointment_date'
#         db.add_column(u'bcpp_subject_subjectreferral', 'next_arv_clinic_appointment_date',
#                       self.gf('django.db.models.fields.DateField')(default=None, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.vl_sample_drawn_datetime'
#         db.add_column(u'bcpp_subject_subjectreferral', 'vl_sample_drawn_datetime',
#                       self.gf('django.db.models.fields.DateTimeField')(null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferral.tb_symptoms'
#         db.add_column(u'bcpp_subject_subjectreferral', 'tb_symptoms',
#                       self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
#                       keep_default=False)
# 
#         # Changing field 'MonthsSecondPartnerAudit.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsSecondPartnerAudit.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsSecondPartnerAudit.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
#         # Deleting field 'SubjectReferralAudit.last_cd4_test_date'
#         db.delete_column(u'bcpp_subject_subjectreferral_audit', 'last_cd4_test_date')
# 
#         # Deleting field 'SubjectReferralAudit.last_cd4_result'
#         db.delete_column(u'bcpp_subject_subjectreferral_audit', 'last_cd4_result')
# 
#         # Deleting field 'SubjectReferralAudit.referred_from_bhs'
#         db.delete_column(u'bcpp_subject_subjectreferral_audit', 'referred_from_bhs')
# 
...
# 
#         # Deleting field 'SubjectReferralAudit.vl_sample_datetime_drawn'
#         db.delete_column(u'bcpp_subject_subjectreferral_audit', 'vl_sample_datetime_drawn')
# 
#         # Adding field 'SubjectReferralAudit.citizen_spouse'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'citizen_spouse',
#                       self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.verbal_hiv_result'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'verbal_hiv_result',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.direct_hiv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'direct_hiv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.indirect_hiv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'indirect_hiv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.arv_documentation'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'arv_documentation',
#                       self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.arv_clinic'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'arv_clinic',
#                       self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.next_arv_clinic_appointment_date'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'next_arv_clinic_appointment_date',
#                       self.gf('django.db.models.fields.DateField')(default=None, null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.vl_sample_drawn_datetime'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'vl_sample_drawn_datetime',
#                       self.gf('django.db.models.fields.DateTimeField')(null=True),
#                       keep_default=False)
# 
#         # Adding field 'SubjectReferralAudit.tb_symptoms'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'tb_symptoms',
#                       self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
#                       keep_default=False)
# 
#         # Changing field 'MonthsThirdPartnerAudit.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsThirdPartnerAudit.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsThirdPartnerAudit.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsThirdPartner.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsThirdPartner.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsThirdPartner.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Deleting field 'HivCareAdherence.arv_naive'
#         db.delete_column(u'bcpp_subject_hivcareadherence', 'arv_naive')
# 
#         # Adding field 'HivCareAdherence.ever_taken_arv'
#         db.add_column(u'bcpp_subject_hivcareadherence', 'ever_taken_arv',
#                       self.gf('django.db.models.fields.CharField')(default='No', max_length=25),
#                       keep_default=False)
# 
# 
#         # Changing field 'MonthsRecentPartner.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsRecentPartner.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsRecentPartner.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
#         # Adding field 'PregnancyAudit._audit_subject_identifier'
# 
# 
#         # Changing field 'MonthsSecondPartner.third_last_sex_calc'
#         db.alter_column(u'bcpp_subject_monthssecondpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsSecondPartner.first_first_sex_calc'
#         db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Changing field 'MonthsSecondPartner.first_sex_freq'
#         db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
# 
#         # Deleting field 'HivCareAdherenceAudit.arv_naive'
#         db.delete_column(u'bcpp_subject_hivcareadherence_audit', 'arv_naive')
# 
#         # Adding field 'HivCareAdherenceAudit.ever_taken_arv'
#         db.add_column(u'bcpp_subject_hivcareadherence_audit', 'ever_taken_arv',
#                       self.gf('django.db.models.fields.CharField')(default='No', max_length=25),
#                       keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeartAttackAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_heartattack_audit', '_audit_subject_identifier')

        # Deleting field 'HicEnrollmentAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hicenrollment_audit', '_audit_subject_identifier')

        # Deleting field 'HivHealthCareCostsAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivhealthcarecosts_audit', '_audit_subject_identifier')

        # Deleting field 'PositiveParticipantAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_positiveparticipant_audit', '_audit_subject_identifier')

        # Deleting field 'OutpatientCareAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_outpatientcare_audit', '_audit_subject_identifier')

        # Deleting field 'RbdDemographicsAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_rbddemographics_audit', '_audit_subject_identifier')

        # Deleting field 'NonPregnancyAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_nonpregnancy_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectOffStudyAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectoffstudy_audit', '_audit_subject_identifier')

        # Deleting field 'HivUntestedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivuntested_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectDeathAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectdeath_audit', '_audit_subject_identifier')

        # Deleting field 'LabourMarketWagesAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_labourmarketwages_audit', '_audit_subject_identifier')

        # Deleting field 'MonthsRecentPartnerAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_monthsrecentpartner_audit', '_audit_subject_identifier')


        # Changing field 'MonthsRecentPartnerAudit.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsRecentPartnerAudit.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsRecentPartnerAudit.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Adding field 'SubjectReferral.last_cd4_test_date'
        db.add_column(u'bcpp_subject_subjectreferral', 'last_cd4_test_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'SubjectReferral.last_cd4_result'
        db.add_column(u'bcpp_subject_subjectreferral', 'last_cd4_result',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectReferral.referred_from_bhs'
        db.add_column(u'bcpp_subject_subjectreferral', 'referred_from_bhs',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'SubjectReferral.vl_sample_datetime_drawn'
        db.add_column(u'bcpp_subject_subjectreferral', 'vl_sample_datetime_drawn',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'SubjectReferral.citizen_spouse'
        db.delete_column(u'bcpp_subject_subjectreferral', 'citizen_spouse')

        # Deleting field 'SubjectReferral.verbal_hiv_result'
        db.delete_column(u'bcpp_subject_subjectreferral', 'verbal_hiv_result')

        # Deleting field 'SubjectReferral.direct_hiv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral', 'direct_hiv_documentation')

        # Deleting field 'SubjectReferral.indirect_hiv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral', 'indirect_hiv_documentation')

        # Deleting field 'SubjectReferral.arv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral', 'arv_documentation')

        # Deleting field 'SubjectReferral.arv_clinic'
        db.delete_column(u'bcpp_subject_subjectreferral', 'arv_clinic')

        # Deleting field 'SubjectReferral.next_arv_clinic_appointment_date'
        db.delete_column(u'bcpp_subject_subjectreferral', 'next_arv_clinic_appointment_date')

        # Deleting field 'SubjectReferral.vl_sample_drawn_datetime'
        db.delete_column(u'bcpp_subject_subjectreferral', 'vl_sample_drawn_datetime')

        # Deleting field 'SubjectReferral.tb_symptoms'
        db.delete_column(u'bcpp_subject_subjectreferral', 'tb_symptoms')

        # Deleting field 'SubjectConsentAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectconsent_audit', '_audit_subject_identifier')

        # Deleting field 'TubercolosisAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_tubercolosis_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectLocatorAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectlocator_audit', '_audit_subject_identifier')

        # Deleting field 'HivResultAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivresult_audit', '_audit_subject_identifier')

        # Deleting field 'MonthsSecondPartnerAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_monthssecondpartner_audit', '_audit_subject_identifier')


        # Changing field 'MonthsSecondPartnerAudit.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsSecondPartnerAudit.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsSecondPartnerAudit.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Adding field 'SubjectReferralAudit.last_cd4_test_date'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'last_cd4_test_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'SubjectReferralAudit.last_cd4_result'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'last_cd4_result',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectReferralAudit.referred_from_bhs'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'referred_from_bhs',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'SubjectReferralAudit.vl_sample_datetime_drawn'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'vl_sample_datetime_drawn',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'SubjectReferralAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectReferralAudit.citizen_spouse'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'citizen_spouse')

        # Deleting field 'SubjectReferralAudit.verbal_hiv_result'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'verbal_hiv_result')

        # Deleting field 'SubjectReferralAudit.direct_hiv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'direct_hiv_documentation')

        # Deleting field 'SubjectReferralAudit.indirect_hiv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'indirect_hiv_documentation')

        # Deleting field 'SubjectReferralAudit.arv_documentation'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'arv_documentation')

        # Deleting field 'SubjectReferralAudit.arv_clinic'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'arv_clinic')

        # Deleting field 'SubjectReferralAudit.next_arv_clinic_appointment_date'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'next_arv_clinic_appointment_date')

        # Deleting field 'SubjectReferralAudit.vl_sample_drawn_datetime'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'vl_sample_drawn_datetime')

        # Deleting field 'SubjectReferralAudit.tb_symptoms'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'tb_symptoms')

        # Deleting field 'PimaAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_pima_audit', '_audit_subject_identifier')

        # Deleting field 'ParticipationAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_participation_audit', '_audit_subject_identifier')

        # Deleting field 'StigmaOpinionAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_stigmaopinion_audit', '_audit_subject_identifier')

        # Deleting field 'MonthsThirdPartnerAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_monthsthirdpartner_audit', '_audit_subject_identifier')


        # Changing field 'MonthsThirdPartnerAudit.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsThirdPartnerAudit.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsThirdPartnerAudit.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Deleting field 'HivTestReviewAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivtestreview_audit', '_audit_subject_identifier')

        # Deleting field 'HivMedicalCareAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivmedicalcare_audit', '_audit_subject_identifier')

        # Deleting field 'HospitalAdmissionAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hospitaladmission_audit', '_audit_subject_identifier')

        # Deleting field 'SubjectVisitAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_subjectvisit_audit', '_audit_subject_identifier')


        # Changing field 'MonthsThirdPartner.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsThirdPartner.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsThirdPartner.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Deleting field 'FutureHivTestingAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_futurehivtesting_audit', '_audit_subject_identifier')

        # Deleting field 'CircumcisedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_circumcised_audit', '_audit_subject_identifier')

        # Deleting field 'ResourceUtilizationAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_resourceutilization_audit', '_audit_subject_identifier')

        # Deleting field 'AccessToCareAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_accesstocare_audit', '_audit_subject_identifier')

        # Deleting field 'StigmaAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_stigma_audit', '_audit_subject_identifier')

        # Deleting field 'CancerAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_cancer_audit', '_audit_subject_identifier')

        # Adding field 'HivCareAdherence.arv_naive'
        db.add_column(u'bcpp_subject_hivcareadherence', 'arv_naive',
                      self.gf('django.db.models.fields.CharField')(default='No', max_length=25),
                      keep_default=False)

        # Deleting field 'HivCareAdherence.ever_taken_arv'
        db.delete_column(u'bcpp_subject_hivcareadherence', 'ever_taken_arv')


        # Changing field 'MonthsRecentPartner.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default='No', max_length=2))

        # Changing field 'MonthsRecentPartner.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsRecentPartner.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Deleting field 'PregnancyAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_pregnancy_audit', '_audit_subject_identifier')

        # Deleting field 'CircumcisionAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_circumcision_audit', '_audit_subject_identifier')

        # Deleting field 'CeaEnrollmentChecklistAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_ceaenrollmentchecklist_audit', '_audit_subject_identifier')

        # Deleting field 'StiAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_sti_audit', '_audit_subject_identifier')

        # Deleting field 'ReproductiveHealthAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_reproductivehealth_audit', '_audit_subject_identifier')

        # Deleting field 'GrantAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_grant_audit', '_audit_subject_identifier')

        # Deleting field 'ResidencyMobilityAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_residencymobility_audit', '_audit_subject_identifier')


        # Changing field 'MonthsSecondPartner.third_last_sex_calc'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'third_last_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsSecondPartner.first_first_sex_calc'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_first_sex_calc', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))

        # Changing field 'MonthsSecondPartner.first_sex_freq'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_sex_freq', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=2))
        # Deleting field 'ClinicQuestionnaireAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_clinicquestionnaire_audit', '_audit_subject_identifier')

        # Deleting field 'SubstanceUseAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_substanceuse_audit', '_audit_subject_identifier')

        # Adding field 'HivCareAdherenceAudit.arv_naive'
        db.add_column(u'bcpp_subject_hivcareadherence_audit', 'arv_naive',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=25),
                      keep_default=False)

        # Deleting field 'HivCareAdherenceAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivcareadherence_audit', '_audit_subject_identifier')

        # Deleting field 'HivCareAdherenceAudit.ever_taken_arv'
        db.delete_column(u'bcpp_subject_hivcareadherence_audit', 'ever_taken_arv')

        # Deleting field 'CommunityEngagementAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_communityengagement_audit', '_audit_subject_identifier')

        # Deleting field 'SexualBehaviourAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_sexualbehaviour_audit', '_audit_subject_identifier')

        # Deleting field 'QualityOfLifeAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_qualityoflife_audit', '_audit_subject_identifier')

        # Deleting field 'HivResultDocumentationAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivresultdocumentation_audit', '_audit_subject_identifier')

        # Deleting field 'DemographicsAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_demographics_audit', '_audit_subject_identifier')

        # Deleting field 'HivTestingHistoryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivtestinghistory_audit', '_audit_subject_identifier')

        # Deleting field 'Cd4HistoryAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_cd4history_audit', '_audit_subject_identifier')

        # Deleting field 'HivTestedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_hivtested_audit', '_audit_subject_identifier')

        # Deleting field 'UncircumcisedAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_uncircumcised_audit', '_audit_subject_identifier')

        # Deleting field 'EducationAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_education_audit', '_audit_subject_identifier')

        # Deleting field 'MedicalDiagnosesAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_medicaldiagnoses_audit', '_audit_subject_identifier')

        # Deleting field 'TbSymptomsAudit._audit_subject_identifier'
        db.delete_column(u'bcpp_subject_tbsymptoms_audit', '_audit_subject_identifier')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'arv_documentation': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'direct_hiv_documentation': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            ...
            'indirect_hiv_documentation': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'intend_residency': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
