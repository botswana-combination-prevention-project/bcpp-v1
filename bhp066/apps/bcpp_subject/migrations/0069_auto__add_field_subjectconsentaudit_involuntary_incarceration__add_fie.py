...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubjectConsentRbd.involuntary_incarceration'
        db.add_column(u'bcpp_subject_subjectconsentrbd', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'SubjectConsentRbdAudit.involuntary_incarceration'
        db.add_column(u'bcpp_subject_subjectconsentrbd_audit', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubjectConsentRbd.involuntary_incarceration'
        db.delete_column(u'bcpp_subject_subjectconsentrbd', 'involuntary_incarceration')

        # Deleting field 'SubjectConsentRbdAudit.involuntary_incarceration'
        db.delete_column(u'bcpp_subject_subjectconsentrbd_audit', 'involuntary_incarceration')
    ...
    models = {
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)'}),
