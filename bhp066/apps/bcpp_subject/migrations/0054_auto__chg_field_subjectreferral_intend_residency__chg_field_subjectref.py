...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectReferral.intend_residency'
        db.alter_column(u'bcpp_subject_subjectreferral', 'intend_residency', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'SubjectReferral.permanent_resident'
        db.alter_column(u'bcpp_subject_subjectreferral', 'permanent_resident', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'SubjectReferralAudit.intend_residency'
        db.alter_column(u'bcpp_subject_subjectreferral_audit', 'intend_residency', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'SubjectReferralAudit.permanent_resident'
        db.alter_column(u'bcpp_subject_subjectreferral_audit', 'permanent_resident', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'SubjectReferral.intend_residency'
        db.alter_column(u'bcpp_subject_subjectreferral', 'intend_residency', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubjectReferral.permanent_resident'
        db.alter_column(u'bcpp_subject_subjectreferral', 'permanent_resident', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubjectReferralAudit.intend_residency'
        db.alter_column(u'bcpp_subject_subjectreferral_audit', 'intend_residency', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubjectReferralAudit.permanent_resident'
        db.alter_column(u'bcpp_subject_subjectreferral_audit', 'permanent_resident', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 1, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 1, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 1, 0, 0)'}),
