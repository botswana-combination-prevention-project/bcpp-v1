...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivHealthCareCostsAudit.place_care_received'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts_audit', 'place_care_received', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'HivHealthCareCostsAudit.care_regularity'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts_audit', 'care_regularity', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'HivHealthCareCostsAudit.doctor_visits'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts_audit', 'doctor_visits', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))


        # Changing field 'OutpatientCareAudit.travel_time'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'OutpatientCareAudit.cost_cover'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'cost_cover', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'OutpatientCareAudit.care_reason'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'care_reason', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'OutpatientCareAudit.waiting_hours'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'OutpatientCareAudit.transport_expense'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'transport_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'OutpatientCareAudit.outpatient_expense'
        db.alter_column(u'bcpp_subject_outpatientcare_audit', 'outpatient_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'ResourceUtilization.medical_cover'
        db.alter_column(u'bcpp_subject_resourceutilization', 'medical_cover', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'ResourceUtilization.money_spent'
        db.alter_column(u'bcpp_subject_resourceutilization', 'money_spent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HospitalAdmissionAudit.reason_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'reason_hospitalized', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'HospitalAdmissionAudit.facility_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'facility_hospitalized', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'HospitalAdmissionAudit.travel_hours'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'travel_hours', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'HospitalAdmissionAudit.healthcare_expense'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'healthcare_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HospitalAdmissionAudit.total_expenses'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'total_expenses', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HospitalAdmissionAudit.nights_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'nights_hospitalized', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'HospitalAdmissionAudit.hospitalization_costs'
        db.alter_column(u'bcpp_subject_hospitaladmission_audit', 'hospitalization_costs', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'ResourceUtilizationAudit.medical_cover'
        db.alter_column(u'bcpp_subject_resourceutilization_audit', 'medical_cover', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'ResourceUtilizationAudit.money_spent'
        db.alter_column(u'bcpp_subject_resourceutilization_audit', 'money_spent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HivCareAdherence.medical_care'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'medical_care', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivCareAdherence.on_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'on_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivCareAdherence.ever_taken_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'ever_taken_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivHealthCareCosts.place_care_received'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts', 'place_care_received', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'HivHealthCareCosts.care_regularity'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts', 'care_regularity', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'HivHealthCareCosts.doctor_visits'
        db.alter_column(u'bcpp_subject_hivhealthcarecosts', 'doctor_visits', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'OutpatientCare.travel_time'
        db.alter_column(u'bcpp_subject_outpatientcare', 'travel_time', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'OutpatientCare.cost_cover'
        db.alter_column(u'bcpp_subject_outpatientcare', 'cost_cover', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'OutpatientCare.care_reason'
        db.alter_column(u'bcpp_subject_outpatientcare', 'care_reason', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'OutpatientCare.waiting_hours'
        db.alter_column(u'bcpp_subject_outpatientcare', 'waiting_hours', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'OutpatientCare.transport_expense'
        db.alter_column(u'bcpp_subject_outpatientcare', 'transport_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'OutpatientCare.outpatient_expense'
        db.alter_column(u'bcpp_subject_outpatientcare', 'outpatient_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HivCareAdherenceAudit.medical_care'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'medical_care', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivCareAdherenceAudit.on_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'on_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HivCareAdherenceAudit.ever_taken_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'ever_taken_arv', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HospitalAdmission.reason_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'reason_hospitalized', self.gf('django.db.models.fields.CharField')(max_length=95, null=True))

        # Changing field 'HospitalAdmission.healthcare_expense'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'healthcare_expense', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'HospitalAdmission.facility_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'facility_hospitalized', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'HospitalAdmission.hospitalization_costs'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'hospitalization_costs', self.gf('django.db.models.fields.CharField')(max_length=17, null=True))

        # Changing field 'HospitalAdmission.travel_hours'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'travel_hours', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'HospitalAdmission.nights_hospitalized'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'nights_hospitalized', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'HospitalAdmission.total_expenses'
        db.alter_column(u'bcpp_subject_hospitaladmission', 'total_expenses', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
    ...
    models = {
        'appointment.appointment': {
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'digawana.bhp.org.bw'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'digawana.bhp.org.bw'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 11, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 11, 0, 0)'}),
