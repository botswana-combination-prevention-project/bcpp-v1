...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectReferral.new_pos'
        db.add_column(u'bcpp_subject_subjectreferral', 'new_pos',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectReferral.last_hiv_result'
        db.add_column(u'bcpp_subject_subjectreferral', 'last_hiv_result',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectReferral.last_hiv_test_date'
        db.add_column(u'bcpp_subject_subjectreferral', 'last_hiv_test_date',
        ...
        # Adding field 'SubjectReferralAudit.new_pos'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'new_pos',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubjectReferralAudit.last_hiv_result'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'last_hiv_result',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'SubjectReferralAudit.last_hiv_test_date'
        db.add_column(u'bcpp_subject_subjectreferral_audit', 'last_hiv_test_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SubjectReferral.new_pos'
        db.delete_column(u'bcpp_subject_subjectreferral', 'new_pos')

        # Deleting field 'SubjectReferral.last_hiv_result'
        db.delete_column(u'bcpp_subject_subjectreferral', 'last_hiv_result')

        # Deleting field 'SubjectReferral.last_hiv_test_date'
        db.delete_column(u'bcpp_subject_subjectreferral', 'last_hiv_test_date')
        ...
        # Changing field 'SubjectReferral.cd4_result'
        db.alter_column(u'bcpp_subject_subjectreferral', 'cd4_result', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'SubjectReferralAudit.new_pos'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'new_pos')

        # Deleting field 'SubjectReferralAudit.last_hiv_result'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'last_hiv_result')

        # Deleting field 'SubjectReferralAudit.last_hiv_test_date'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'last_hiv_test_date')
        ...
        # Changing field 'SubjectReferralAudit.cd4_result'
        db.alter_column(u'bcpp_subject_subjectreferral_audit', 'cd4_result', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)'}),
