...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pregnancy.anc_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Pregnancy.last_birth'
        db.alter_column('bcpp_subject_pregnancy', 'last_birth', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'NonPregnancyAudit.anc_last_pregnancy'
        db.alter_column('bcpp_subject_nonpregnancy_audit', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'NonPregnancyAudit.last_birth'
        db.alter_column('bcpp_subject_nonpregnancy_audit', 'last_birth', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'PregnancyAudit.anc_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy_audit', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'PregnancyAudit.last_birth'
        db.alter_column('bcpp_subject_pregnancy_audit', 'last_birth', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'NonPregnancy.anc_last_pregnancy'
        db.alter_column('bcpp_subject_nonpregnancy', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'NonPregnancy.last_birth'
        db.alter_column('bcpp_subject_nonpregnancy', 'last_birth', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Pregnancy.anc_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'Pregnancy.last_birth'
        db.alter_column('bcpp_subject_pregnancy', 'last_birth', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'NonPregnancyAudit.anc_last_pregnancy'
        db.alter_column('bcpp_subject_nonpregnancy_audit', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'NonPregnancyAudit.last_birth'
        db.alter_column('bcpp_subject_nonpregnancy_audit', 'last_birth', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'PregnancyAudit.anc_last_pregnancy'
        db.alter_column('bcpp_subject_pregnancy_audit', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'PregnancyAudit.last_birth'
        db.alter_column('bcpp_subject_pregnancy_audit', 'last_birth', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'NonPregnancy.anc_last_pregnancy'
        db.alter_column('bcpp_subject_nonpregnancy', 'anc_last_pregnancy', self.gf('django.db.models.fields.CharField')(default=0, max_length=25))

        # Changing field 'NonPregnancy.last_birth'
        db.alter_column('bcpp_subject_nonpregnancy', 'last_birth', self.gf('django.db.models.fields.DateField')(default=0))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 12, 0, 0)'}),
