...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SubjectVisit', fields ['household_member']
        db.delete_unique('bcpp_subject_subjectvisit', ['household_member_id'])


        # Changing field 'SubjectVisit.household_member'
        db.alter_column('bcpp_subject_subjectvisit', 'household_member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_household_member.HouseholdMember']))

    def backwards(self, orm):

        # Changing field 'SubjectVisit.household_member'
        db.alter_column('bcpp_subject_subjectvisit', 'household_member_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_household_member.HouseholdMember'], unique=True))
        # Adding unique constraint on 'SubjectVisit', fields ['household_member']
        db.create_unique('bcpp_subject_subjectvisit', ['household_member_id'])
