...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthsRecentPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MonthsSecondPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MonthsThirdPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MonthsThirdPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MonthsRecentPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'MonthsSecondPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'MonthsRecentPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MonthsSecondPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MonthsThirdPartnerAudit.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MonthsThirdPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MonthsRecentPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'MonthsSecondPartner.partner_hiv_test'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'partner_hiv_test', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)'}),
