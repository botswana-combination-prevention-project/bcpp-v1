...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('bcpp_subject_subjectconsent_audit', 'language',
                      self.gf('django.db.models.fields.CharField')(default='not specified', max_length=25),
                      keep_default=False)

        # Adding field 'SubjectConsent.language'
        db.add_column('bcpp_subject_subjectconsent', 'language',
                      self.gf('django.db.models.fields.CharField')(default='not specified', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectConsentAudit.language'
        db.delete_column('bcpp_subject_subjectconsent_audit', 'language')

        # Deleting field 'SubjectConsent.language'
        db.delete_column('bcpp_subject_subjectconsent', 'language')
