...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SubjectConsent', fields ['survey']
        db.delete_unique('bcpp_subject_subjectconsent', ['survey_id'])


        # Changing field 'SubjectConsent.survey'
        db.alter_column('bcpp_subject_subjectconsent', 'survey_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_survey.Survey']))

    def backwards(self, orm):

        # Changing field 'SubjectConsent.survey'
        db.alter_column('bcpp_subject_subjectconsent', 'survey_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_survey.Survey'], unique=True))
        # Adding unique constraint on 'SubjectConsent', fields ['survey']
        db.create_unique('bcpp_subject_subjectconsent', ['survey_id'])
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
