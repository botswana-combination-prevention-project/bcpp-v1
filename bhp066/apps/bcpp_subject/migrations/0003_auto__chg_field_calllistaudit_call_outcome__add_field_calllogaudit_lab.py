...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CallListAudit.call_outcome'
        db.alter_column(u'bcpp_subject_calllist_audit', 'call_outcome', self.gf('django.db.models.fields.TextField')(max_length=150, null=True))
        # Adding field 'CallLogAudit.label'
        db.add_column(u'bcpp_subject_calllog_audit', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)

        # Adding field 'CallLog.label'
        db.add_column(u'bcpp_subject_calllog', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True),
                      keep_default=False)


        # Changing field 'CallLogEntryAudit.call_again'
        db.alter_column(u'bcpp_subject_calllogentry_audit', 'call_again', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'CallLogEntry.call_again'
        db.alter_column(u'bcpp_subject_calllogentry', 'call_again', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'CallList.call_outcome'
        db.alter_column(u'bcpp_subject_calllist', 'call_outcome', self.gf('django.db.models.fields.TextField')(max_length=150, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CallListAudit.call_outcome'
        raise RuntimeError("Cannot reverse this migration. 'CallListAudit.call_outcome' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CallListAudit.call_outcome'
        db.alter_column(u'bcpp_subject_calllist_audit', 'call_outcome', self.gf('django.db.models.fields.CharField')(max_length=150))
        # Deleting field 'CallLogAudit.label'
        db.delete_column(u'bcpp_subject_calllog_audit', 'label')

        # Deleting field 'CallLog.label'
        db.delete_column(u'bcpp_subject_calllog', 'label')


        # Changing field 'CallLogEntryAudit.call_again'
        db.alter_column(u'bcpp_subject_calllogentry_audit', 'call_again', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CallLogEntry.call_again'
        db.alter_column(u'bcpp_subject_calllogentry', 'call_again', self.gf('django.db.models.fields.BooleanField')())

        # User chose to not deal with backwards NULL issues for 'CallList.call_outcome'
        raise RuntimeError("Cannot reverse this migration. 'CallList.call_outcome' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CallList.call_outcome'
        db.alter_column(u'bcpp_subject_calllist', 'call_outcome', self.gf('django.db.models.fields.CharField')(max_length=150))
