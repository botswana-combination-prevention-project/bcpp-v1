...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivTestingHistory.has_tested'
        db.alter_column('bcpp_subject_hivtestinghistory', 'has_tested', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'HivTestingHistoryAudit.has_tested'
        db.alter_column('bcpp_subject_hivtestinghistory_audit', 'has_tested', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'HivTestingHistory.has_tested'
        db.alter_column('bcpp_subject_hivtestinghistory', 'has_tested', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'HivTestingHistoryAudit.has_tested'
        db.alter_column('bcpp_subject_hivtestinghistory_audit', 'has_tested', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 3, 0, 0)'}),
