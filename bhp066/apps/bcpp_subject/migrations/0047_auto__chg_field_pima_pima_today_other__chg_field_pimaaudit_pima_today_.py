...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pima.pima_today_other'
        db.alter_column(u'bcpp_subject_pima', 'pima_today_other', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'PimaAudit.pima_today_other'
        db.alter_column(u'bcpp_subject_pima_audit', 'pima_today_other', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Pima.pima_today_other'
        db.alter_column(u'bcpp_subject_pima', 'pima_today_other', self.gf('django.db.models.fields.CharField')(default='xx', max_length=50))

        # Changing field 'PimaAudit.pima_today_other'
        db.alter_column(u'bcpp_subject_pima_audit', 'pima_today_other', self.gf('django.db.models.fields.CharField')(default='xx', max_length=50))
