...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectRefusal.age'
        db.alter_column('bcpp_subject_subjectrefusal', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SubjectRefusal.length_residence'
        db.alter_column('bcpp_subject_subjectrefusal', 'length_residence', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectRefusal.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectRefusal.why_no_hivtest'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SubjectRefusalAudit.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectRefusalAudit.why_no_hivtest'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'SubjectRefusalAudit.length_residence'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'length_residence', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'SubjectRefusalAudit.age'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SubjectRefusal.age'
        raise RuntimeError("Cannot reverse this migration. 'SubjectRefusal.age' and its values cannot be restored.")

        # Changing field 'SubjectRefusal.length_residence'
        db.alter_column('bcpp_subject_subjectrefusal', 'length_residence', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'SubjectRefusal.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'SubjectRefusal.why_no_hivtest'
        db.alter_column('bcpp_subject_subjectrefusal', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'SubjectRefusalAudit.why_no_participate'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_participate', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'SubjectRefusalAudit.why_no_hivtest'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'why_no_hivtest', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'SubjectRefusalAudit.length_residence'
        db.alter_column('bcpp_subject_subjectrefusal_audit', 'length_residence', self.gf('django.db.models.fields.CharField')(max_length=15))

        # User chose to not deal with backwards NULL issues for 'SubjectRefusalAudit.age'
        raise RuntimeError("Cannot reverse this migration. 'SubjectRefusalAudit.age' and its values cannot be restored.")
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
        ...
        'bcpp_subject.subjectrefusal': {
            ...
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'why_no_hivtest': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'why_no_participate': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
