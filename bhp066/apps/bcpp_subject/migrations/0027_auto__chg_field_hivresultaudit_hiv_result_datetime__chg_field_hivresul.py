...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HivResultAudit.hiv_result_datetime'
        db.alter_column('bcpp_subject_hivresult_audit', 'hiv_result_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 18, 0, 0)))

        # Changing field 'HivResult.hiv_result_datetime'
        db.alter_column('bcpp_subject_hivresult', 'hiv_result_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 18, 0, 0)))

    def backwards(self, orm):

        # Changing field 'HivResultAudit.hiv_result_datetime'
        db.alter_column('bcpp_subject_hivresult_audit', 'hiv_result_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HivResult.hiv_result_datetime'
        db.alter_column('bcpp_subject_hivresult', 'hiv_result_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)'}),
