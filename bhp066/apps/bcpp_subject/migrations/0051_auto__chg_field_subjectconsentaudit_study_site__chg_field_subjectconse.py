...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bcpp_subject_subjectconsent_audit', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['bhp_variables.StudySite']))

        # Changing field 'SubjectConsent.study_site'
        db.alter_column(u'bcpp_subject_subjectconsent', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bhp_variables.StudySite'], null=True))

    def backwards(self, orm):

        # Changing field 'SubjectConsentAudit.study_site'
        db.alter_column(u'bcpp_subject_subjectconsent_audit', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_variables.StudySite']))

        # Changing field 'SubjectConsent.study_site'
        db.alter_column(u'bcpp_subject_subjectconsent', 'study_site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bhp_variables.StudySite']))
