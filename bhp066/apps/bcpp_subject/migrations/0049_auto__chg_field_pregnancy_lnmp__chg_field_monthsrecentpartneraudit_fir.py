...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pregnancy.lnmp'
        db.alter_column(u'bcpp_subject_pregnancy', 'lnmp', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MonthsRecentPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'MonthsSecondPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'MonthsThirdPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'MonthsThirdPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))
        # Adding field 'HivCareAdherence.no_medical_care_other'
        db.add_column(u'bcpp_subject_hivcareadherence', 'no_medical_care_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


        # Changing field 'HivCareAdherence.first_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'first_arv', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivCareAdherence.arv_stop_date'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'arv_stop_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivCareAdherence.first_positive'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'first_positive', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MonthsRecentPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))

        # Changing field 'PregnancyAudit.lnmp'
        db.alter_column(u'bcpp_subject_pregnancy_audit', 'lnmp', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MonthsSecondPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True))
        # Adding field 'HivCareAdherenceAudit.no_medical_care_other'
        db.add_column(u'bcpp_subject_hivcareadherence_audit', 'no_medical_care_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


        # Changing field 'HivCareAdherenceAudit.first_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'first_arv', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivCareAdherenceAudit.arv_stop_date'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'arv_stop_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HivCareAdherenceAudit.first_positive'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'first_positive', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Pregnancy.lnmp'
        db.alter_column(u'bcpp_subject_pregnancy', 'lnmp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'MonthsRecentPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthsrecentpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'MonthsSecondPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'MonthsThirdPartnerAudit.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner_audit', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'MonthsThirdPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsthirdpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
        # Deleting field 'HivCareAdherence.no_medical_care_other'
        db.delete_column(u'bcpp_subject_hivcareadherence', 'no_medical_care_other')


        # Changing field 'HivCareAdherence.first_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'first_arv', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HivCareAdherence.arv_stop_date'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'arv_stop_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HivCareAdherence.first_positive'
        db.alter_column(u'bcpp_subject_hivcareadherence', 'first_positive', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'MonthsRecentPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthsrecentpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

        # Changing field 'PregnancyAudit.lnmp'
        db.alter_column(u'bcpp_subject_pregnancy_audit', 'lnmp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'MonthsSecondPartner.first_exchange'
        db.alter_column(u'bcpp_subject_monthssecondpartner', 'first_exchange', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))
        # Deleting field 'HivCareAdherenceAudit.no_medical_care_other'
        db.delete_column(u'bcpp_subject_hivcareadherence_audit', 'no_medical_care_other')


        # Changing field 'HivCareAdherenceAudit.first_arv'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'first_arv', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HivCareAdherenceAudit.arv_stop_date'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'arv_stop_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HivCareAdherenceAudit.first_positive'
        db.alter_column(u'bcpp_subject_hivcareadherence_audit', 'first_positive', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 19, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 19, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferralaudit': {
            ...
            'next_appt_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'referral_result': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_subjectreferral'", 'null': 'True', 'to': "orm['registration.RegisteredSubject']"}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 19, 0, 0)'}),
            'subject_referral_reason': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'subject_referral_reason_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
