...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HeartAttackAudit.dx_heart_attack_other'
        db.add_column('bcpp_subject_heartattack_audit', 'dx_heart_attack_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'HeartAttack.dx_heart_attack_other'
        db.add_column('bcpp_subject_heartattack', 'dx_heart_attack_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HeartAttackAudit.dx_heart_attack_other'
        db.delete_column('bcpp_subject_heartattack_audit', 'dx_heart_attack_other')

        # Deleting field 'HeartAttack.dx_heart_attack_other'
        db.delete_column('bcpp_subject_heartattack', 'dx_heart_attack_other')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 14, 0, 0)'}),
