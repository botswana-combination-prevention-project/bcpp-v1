...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Demographics.ethnic'
        db.delete_column('bcpp_subject_demographics', 'ethnic')

        # Adding M2M table for field ethnic on 'Demographics'
        m2m_table_name = db.shorten_name('bcpp_subject_demographics_ethnic')
    ...
    def backwards(self, orm):
        # Adding field 'Demographics.ethnic'
        db.add_column('bcpp_subject_demographics', 'ethnic',
        ...
        # Adding field 'DemographicsAudit.ethnic'
        db.add_column('bcpp_subject_demographics_audit', 'ethnic',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=35),
                      keep_default=False)
