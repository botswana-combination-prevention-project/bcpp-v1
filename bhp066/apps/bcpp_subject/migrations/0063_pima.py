...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pima.cd4_datetime'
        db.add_column(u'bcpp_subject_pima', 'cd4_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PimaAudit.cd4_datetime'
        db.add_column(u'bcpp_subject_pima_audit', 'cd4_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 30, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 30, 0, 0)'}),
