...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BloodDrawAudit.draw_date'
        db.alter_column('bcpp_subject_blooddraw_audit', 'draw_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'BloodDraw.draw_date'
        db.alter_column('bcpp_subject_blooddraw', 'draw_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'BloodDrawAudit.draw_date'
        db.alter_column('bcpp_subject_blooddraw_audit', 'draw_date', self.gf('django.db.models.fields.DateTimeField')(default=0))

        # Changing field 'BloodDraw.draw_date'
        db.alter_column('bcpp_subject_blooddraw', 'draw_date', self.gf('django.db.models.fields.DateTimeField')(default=0))
