...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HivTestedAudit.where_hiv_test_other'
        db.add_column('bcpp_subject_hivtested_audit', 'where_hiv_test_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)

        # Adding field 'HivTested.where_hiv_test_other'
        db.add_column('bcpp_subject_hivtested', 'where_hiv_test_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HivTestedAudit.where_hiv_test_other'
        db.delete_column('bcpp_subject_hivtested_audit', 'where_hiv_test_other')

        # Deleting field 'HivTested.where_hiv_test_other'
        db.delete_column('bcpp_subject_hivtested', 'where_hiv_test_other')
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
