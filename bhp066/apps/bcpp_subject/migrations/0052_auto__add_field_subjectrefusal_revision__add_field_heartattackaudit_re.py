...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CeaEnrollmentChecklist.revision'
        db.add_column(u'bcpp_subject_ceaenrollmentchecklist', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'CeaEnrollmentChecklistAudit.revision'
        db.add_column(u'bcpp_subject_ceaenrollmentchecklist_audit', 'revision',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
