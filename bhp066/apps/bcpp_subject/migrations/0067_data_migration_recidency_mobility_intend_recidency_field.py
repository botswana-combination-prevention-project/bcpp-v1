...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ResidencyMobility = orm['bcpp_subject.ResidencyMobility']
        for obj in ResidencyMobility.objects.all():
            if obj.intend_residency == 'Yes' or obj.intend_residency == 'Not Sure':
                obj.intend_residency = 'No'
            else:
                obj.intend_residency = 'Yes'
    ...
    models = {
        ...
        'bcpp_subject.accesstocare': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
