...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CeaEnrollmentChecklist.opportunistic_illness'
        db.alter_column('bcpp_subject_ceaenrollmentchecklist', 'opportunistic_illness', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'CeaEnrollmentChecklistAudit.opportunistic_illness'
        db.alter_column('bcpp_subject_ceaenrollmentchecklist_audit', 'opportunistic_illness', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        db.create_table('bcpp_subject_baselinehouseholdsurvey', (
            ...
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 5, 0, 0))),
        ...
        # Changing field 'CeaEnrollmentChecklist.opportunistic_illness'
        db.alter_column('bcpp_subject_ceaenrollmentchecklist', 'opportunistic_illness', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'CeaEnrollmentChecklistAudit.opportunistic_illness'
        db.alter_column('bcpp_subject_ceaenrollmentchecklist_audit', 'opportunistic_illness', self.gf('django.db.models.fields.CharField')(max_length=3))
