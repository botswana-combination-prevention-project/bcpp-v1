...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubjectConsentRbd'
        db.create_table(u'bcpp_subject_subjectconsentrbd', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentRbd'])

        # Adding unique constraint on 'SubjectConsentRbd', fields ['subject_identifier', 'survey']
        db.create_unique(u'bcpp_subject_subjectconsentrbd', ['subject_identifier', 'survey_id'])

        # Adding model 'SubjectConsentRbdAudit'
        db.create_table(u'bcpp_subject_subjectconsentrbd_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('subject_type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('subject_identifier', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, blank=True)),
            ('study_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentrbd', null=True, to=orm['bhp_variables.StudySite'])),
            ('consent_datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('guardian_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('may_store_samples', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('is_incarcerated', self.gf('django.db.models.fields.CharField')(default='-', max_length=3)),
            ...
            ('identity_type', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('confirm_identity', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True)),
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentrbd', to=orm['bcpp_household_member.HouseholdMember'])),
            ('is_signed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentrbd', to=orm['bcpp_survey.Survey'])),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectconsentrbd', null=True, to=orm['registration.RegisteredSubject'])),
            ('is_minor', self.gf('django.db.models.fields.CharField')(default='-', max_length=10, null=True)),
            ('consent_signature', self.gf('django.db.models.fields.CharField')(max_length=3, null=True)),
            ('community', self.gf('django.db.models.fields.CharField')(max_length=25, null=True)),
            ('_audit_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ...
        db.send_create_signal('bcpp_subject', ['SubjectConsentRbdAudit'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'SubjectConsentRbd', fields ['subject_identifier', 'survey']
        db.delete_unique(u'bcpp_subject_subjectconsentrbd', ['subject_identifier', 'survey_id'])

        # Deleting model 'ClinicQuestionnaireAudit'
        db.delete_table(u'bcpp_subject_clinicquestionnaire_audit')

        # Deleting model 'SubjectConsentRbd'
        db.delete_table(u'bcpp_subject_subjectconsentrbd')

        # Deleting model 'SubjectConsentRbdAudit'
        db.delete_table(u'bcpp_subject_subjectconsentrbd_audit')
    ...
    models = {
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'intend_residency': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'on_art': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'permanent_resident': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
