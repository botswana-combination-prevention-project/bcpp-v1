...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubjectRefusal.sex'
        db.delete_column('bcpp_subject_subjectrefusal', 'sex')

        # Deleting field 'SubjectRefusalAudit.sex'
        db.delete_column('bcpp_subject_subjectrefusal_audit', 'sex')


    def backwards(self, orm):
        # Adding field 'SubjectRefusal.sex'
        db.add_column('bcpp_subject_subjectrefusal', 'sex',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)

        # Adding field 'SubjectRefusalAudit.sex'
        db.add_column('bcpp_subject_subjectrefusal_audit', 'sex',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=15),
                      keep_default=False)
