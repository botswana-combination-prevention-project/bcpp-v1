...
#         db.send_create_signal('bcpp_subject', ['TbSymptomsAudit'])
        ...
        # Adding field 'SubjectReferral.subject_referred'
#         db.add_column(u'bcpp_subject_subjectreferral', 'subject_referred',
#                       self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
#                       keep_default=False)

        # Deleting field 'SubjectConsentAudit.involuntary_incarceration'
        #db.delete_column(u'bcpp_subject_subjectconsent_audit', 'involuntary_incarceration')

        # Deleting field 'SubjectConsentAudit.mentally_incapacitated'
        #db.delete_column(u'bcpp_subject_subjectconsent_audit', 'mentally_incapacitated')

        # Deleting field 'SubjectConsent.involuntary_incarceration'
        #db.delete_column(u'bcpp_subject_subjectconsent', 'involuntary_incarceration')

        # Deleting field 'SubjectConsent.mentally_incapacitated'
        #db.delete_column(u'bcpp_subject_subjectconsent', 'mentally_incapacitated')

        # Adding field 'HivResultAudit.blood_draw_type'
#         db.add_column(u'bcpp_subject_hivresult_audit', 'blood_draw_type',
#                       self.gf('django.db.models.fields.CharField')(default='N/A', max_length=15),
#                       keep_default=False)
# 
#         # Adding field 'HivResultAudit.insufficient_vol'
#         db.add_column(u'bcpp_subject_hivresult_audit', 'insufficient_vol',
#                       self.gf('django.db.models.fields.CharField')(default='N/A', max_length=15),
#                       keep_default=False)

        # Adding field 'SubjectReferralAudit.subject_referred'
#         db.add_column(u'bcpp_subject_subjectreferral_audit', 'subject_referred',
#                       self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
#                       keep_default=False)

        # Adding field 'HivResult.blood_draw_type'
        db.add_column(u'bcpp_subject_hivresult', 'blood_draw_type',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=15),
                      keep_default=False)

        # Adding field 'HivResult.insufficient_vol'
        db.add_column(u'bcpp_subject_hivresult', 'insufficient_vol',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=15),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'bcpp_subject_subjectconsentrbd', (
            ...
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('involuntary_incarceration', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ...
            ('mentally_incapacitated', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
        ...
        db.create_table(u'bcpp_subject_ceaenrolmentchecklist_audit', (
            ...
            ('enrolment_reason', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('_audit_change_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_ceaenrolmentchecklist', to=orm['registration.RegisteredSubject'])),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
        ...
        # Deleting field 'SubjectReferral.subject_referred'
        db.delete_column(u'bcpp_subject_subjectreferral', 'subject_referred')

        # Adding field 'SubjectConsentAudit.involuntary_incarceration'
        db.add_column(u'bcpp_subject_subjectconsent_audit', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'SubjectConsentAudit.mentally_incapacitated'
        db.add_column(u'bcpp_subject_subjectconsent_audit', 'mentally_incapacitated',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.involuntary_incarceration'
        db.add_column(u'bcpp_subject_subjectconsent', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'SubjectConsent.mentally_incapacitated'
        db.add_column(u'bcpp_subject_subjectconsent', 'mentally_incapacitated',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Deleting field 'HivResultAudit.blood_draw_type'
        db.delete_column(u'bcpp_subject_hivresult_audit', 'blood_draw_type')

        # Deleting field 'HivResultAudit.insufficient_vol'
        db.delete_column(u'bcpp_subject_hivresult_audit', 'insufficient_vol')

        # Deleting field 'SubjectReferralAudit.subject_referred'
        db.delete_column(u'bcpp_subject_subjectreferral_audit', 'subject_referred')

        # Deleting field 'HivResult.blood_draw_type'
        db.delete_column(u'bcpp_subject_hivresult', 'blood_draw_type')

        # Deleting field 'HivResult.insufficient_vol'
        db.delete_column(u'bcpp_subject_hivresult', 'insufficient_vol')
    ...
    models = {
        ...
        'bcpp_subject.subjectlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 23, 0, 0)'}),
        ...
        'bcpp_subject.subjectreferral': {
            ...
            'referral_appt_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 23, 0, 0)'}),
