    ...
    visit_definitions = OrderedDict(
        {'T0': {
            ...
            'entries': (
                ...
                EntryTuple(290L, u'bcpp_subject', u'tbsymptoms'),
                EntryTuple(300L, u'bcpp_subject', u'substanceuse'),
                EntryTuple(320L, u'bcpp_subject', u'stigma'),
                EntryTuple(330L, u'bcpp_subject', u'stigmaopinion'),
                EntryTuple(340L, u'bcpp_subject', u'positiveparticipant'),
                EntryTuple(350L, u'bcpp_subject', u'accesstocare'),
                EntryTuple(360L, u'bcpp_subject', u'hivresult'),
                EntryTuple(370L, u'bcpp_subject', u'pima'),
                EntryTuple(380L, u'bcpp_subject', u'subjectreferral'),
                EntryTuple(390L, u'bcpp_subject', u'hicenrollment'),
            )}
        }
    )
