        ...
        {'T0': {
         ...
         'T1': {
            ...
            'entries': (
                ...
                EntryTuple(280L, u'bcpp_subject', u'tubercolosis', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(290L, u'bcpp_subject', u'tbsymptoms', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'qualityoflife', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'resourceutilization', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'outpatientcare', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'hospitaladmission', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'hivhealthcarecosts', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(350L, u'bcpp_subject', u'labourmarketwages', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(360L, u'bcpp_subject', u'hivresult', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(370L, u'bcpp_subject', u'elisahivresult', NOT_REQUIRED, ADDITIONAL),
                EntryTuple(380L, u'bcpp_subject', u'pima', REQUIRED, NOT_ADDITIONAL),
                EntryTuple(390L, u'bcpp_subject', u'subjectreferral', REQUIRED, NOT_ADDITIONAL),
