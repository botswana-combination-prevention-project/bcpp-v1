...
class HivResultForm (BaseSubjectModelForm):
    ...
    def clean(self):
        ...
        if ((cleaned_data.get('hiv_result', None) != 'Declined') or (cleaned_data.get('hiv_result', None) != 'Not performed')) and (cleaned_data.get('why_not_tested', None)):
        ...
        if ((cleaned_data.get('hiv_result', None) != 'Declined') or (cleaned_data.get('hiv_result', None) != 'Not performed')) and not (cleaned_data.get('hiv_result_datetime', None)):
