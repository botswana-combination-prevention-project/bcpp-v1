    ...
    def handle(self, *args, **options):
        ...
        for hic_enrollment in hic_enrollments:
            try:
                ...
                print '    skipping, not in call list {} (permission={})'.format(hic_enrollment, hic_enrollment.hic_permission)
        print 'Done. Update {} rows in CallList for {} Hic Enrollments with call list label {}.'.format(n, total, label)
