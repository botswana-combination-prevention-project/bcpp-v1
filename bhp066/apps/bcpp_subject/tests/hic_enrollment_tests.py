...
class HicEnrollmentTests(TestCase):
    ...
    def test_p1(self):
        ...
        self.assertRaises(TypeError, lambda: HicEnrollmentFactory(subject_visit=subject_visit, dob=subject_consent.dob, consent_datetime=subject_consent.consent_datetime))
        ...
        self.assertRaises(TypeError, lambda: subject_consent.save())
        subject_consent.consent_datetime = datetime.today()
        self.assertRaises(TypeError, lambda: subject_consent.save())
        #try change HivResult
        hiv_result.hiv_result = 'POS'
        self.assertRaises(TypeError, lambda: hiv_result.save())
        #try change residency
        recidency_mobility.intend_residency = 'Yes'
        self.assertRaises(TypeError, lambda: recidency_mobility.save())
        ...
        self.assertRaises(TypeError, lambda: locator.save())