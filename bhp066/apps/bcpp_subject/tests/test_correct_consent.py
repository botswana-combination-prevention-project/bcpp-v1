...
class TestCorrectConsent(TestCase):
    ...
    community = 'lentsweletau'
 
#     @override_settings(
#         SITE_CODE='14', CURRENT_COMMUNITY='otse', CURRENT_SURVEY='bcpp-year-1',
#         CURRENT_COMMUNITY_CHECK=False, CURRENT_MAPPER='otse', DEVICE='99')
    def setUp(self):
        try:
            site_lab_profiles.register(BcppSubjectProfile())
        except AlreadyRegisteredLabProfile:
            pass
        study_site = StudySite.objects.create(site_code='14')
