...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RBDEligibility.initials'
        db.add_column(u'bcpp_rbd_rbdeligibility', 'initials',
                      self.gf('django.db.models.fields.CharField')(default='--', max_length=3, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RBDEligibility.initials'
        db.delete_column(u'bcpp_rbd_rbdeligibility', 'initials')
