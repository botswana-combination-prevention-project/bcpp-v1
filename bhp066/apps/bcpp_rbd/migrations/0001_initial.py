...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RBDVisitAudit'
        db.create_table(u'bcpp_rbd_subjectvisitrbd_audit', (
        ...
        db.send_create_signal('bcpp_rbd', ['RBDVisitAudit'])

        # Adding model 'RBDVisit'
        db.create_table(u'bcpp_rbd_subjectvisitrbd', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_rbd', ['RBDVisit'])

        # Adding model 'RBDLocatorAudit'
        db.create_table(u'bcpp_rbd_subjectlocatorrbd_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectlocatorrbd', null=True, to=orm['bcpp_rbd.RBDVisit'])),
        ...
        db.send_create_signal('bcpp_rbd', ['RBDLocatorAudit'])

        # Adding model 'RBDLocator'
        db.create_table(u'bcpp_rbd_subjectlocatorrbd', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('contact_cell', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_rbd.RBDVisit'], null=True)),
            ('alt_contact_cell_number', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('has_alt_contact', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('alt_contact_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('alt_contact_rel', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
        ...
        db.send_create_signal('bcpp_rbd', ['RBDLocator'])
        ...
        # Adding model 'RBDConsent'
        db.create_table(u'bcpp_rbd_subjectconsentrbdonly', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_rbd', ['RBDConsent'])

        # Adding unique constraint on 'RBDConsent', fields ['subject_identifier', 'survey']
        db.create_unique(u'bcpp_rbd_subjectconsentrbdonly', ['subject_identifier', 'survey_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RBDConsent', fields ['subject_identifier', 'survey']
        db.delete_unique(u'bcpp_rbd_subjectconsentrbdonly', ['subject_identifier', 'survey_id'])

        # Deleting model 'RBDVisitAudit'
        db.delete_table(u'bcpp_rbd_subjectvisitrbd_audit')

        # Deleting model 'RBDVisit'
        db.delete_table(u'bcpp_rbd_subjectvisitrbd')

        # Deleting model 'RBDLocatorAudit'
        db.delete_table(u'bcpp_rbd_subjectlocatorrbd_audit')

        # Deleting model 'RBDLocator'
        db.delete_table(u'bcpp_rbd_subjectlocatorrbd')

        # Deleting model 'RBDConsentAudit'
        db.delete_table(u'bcpp_rbd_subjectconsentrbdonly_audit')

        # Deleting model 'RBDConsent'
        db.delete_table(u'bcpp_rbd_subjectconsentrbdonly')
