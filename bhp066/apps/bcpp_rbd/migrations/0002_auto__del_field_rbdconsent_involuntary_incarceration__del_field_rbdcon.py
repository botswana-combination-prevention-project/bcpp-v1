...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RBDConsent.involuntary_incarceration'
        db.delete_column(u'bcpp_rbd_rbdconsent', 'involuntary_incarceration')

        # Deleting field 'RBDConsent.mentally_incapacitated'
        db.delete_column(u'bcpp_rbd_rbdconsent', 'mentally_incapacitated')

        # Deleting field 'RBDEligibility.mentally_incapacitated'
        db.delete_column(u'bcpp_rbd_rbdeligibility', 'mentally_incapacitated')

        # Deleting field 'RBDEligibility.involuntary_incarceration'
        db.delete_column(u'bcpp_rbd_rbdeligibility', 'involuntary_incarceration')

        # Deleting field 'RBDConsentAudit.involuntary_incarceration'
        db.delete_column(u'bcpp_rbd_rbdconsent_audit', 'involuntary_incarceration')

        # Deleting field 'RBDConsentAudit.mentally_incapacitated'
        db.delete_column(u'bcpp_rbd_rbdconsent_audit', 'mentally_incapacitated')


    def backwards(self, orm):
        # Adding field 'RBDConsent.involuntary_incarceration'
        db.add_column(u'bcpp_rbd_rbdconsent', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'RBDConsent.mentally_incapacitated'
        db.add_column(u'bcpp_rbd_rbdconsent', 'mentally_incapacitated',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'RBDEligibility.mentally_incapacitated'
        db.add_column(u'bcpp_rbd_rbdeligibility', 'mentally_incapacitated',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Adding field 'RBDEligibility.involuntary_incarceration'
        db.add_column(u'bcpp_rbd_rbdeligibility', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(default='Yes', max_length=10),
                      keep_default=False)

        # Adding field 'RBDConsentAudit.involuntary_incarceration'
        db.add_column(u'bcpp_rbd_rbdconsent_audit', 'involuntary_incarceration',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'RBDConsentAudit.mentally_incapacitated'
        db.add_column(u'bcpp_rbd_rbdconsent_audit', 'mentally_incapacitated',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'bcpp_rbd.rbdconsentaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDConsentAudit', 'db_table': "u'bcpp_rbd_rbdconsent_audit'"},
            ...
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdconsent'", 'to': "orm['bcpp_household_member.HouseholdMember']"}),
            ...
            'may_store_samples': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdconsent'", 'null': 'True', 'to': "orm['registration.RegisteredSubject']"}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'study_questions': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
            'study_site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdconsent'", 'null': 'True', 'to': "orm['bhp_variables.StudySite']"}),
            'subject_identifier': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'subject_identifier_as_pk': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'}),
            'subject_type': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True'}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdconsent'", 'to': "orm['bcpp_survey.Survey']"}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'witness_name': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'})
        },
        'bcpp_rbd.rbddemographics': {
            ...
            'rbd_visit': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bcpp_rbd.RBDVisit']", 'unique': 'True'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        'bcpp_rbd.rbddemographicsaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDDemographicsAudit', 'db_table': "u'bcpp_rbd_rbddemographics_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'num_wives': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'rbd_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbddemographics'", 'to': "orm['bcpp_rbd.RBDVisit']"}),
            'religion_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
        ...
        'bcpp_rbd.rbdlocator': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            ...
            'rbd_visit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bcpp_rbd.RBDVisit']", 'null': 'True'}),
        ...
        'bcpp_rbd.rbdlocatoraudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDLocatorAudit', 'db_table': "u'bcpp_rbd_rbdlocator_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'alt_contact_cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            ...
            'other_alt_contact_cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'physical_address': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'rbd_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdlocator'", 'null': 'True', 'to': "orm['bcpp_rbd.RBDVisit']"}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdlocator'", 'null': 'True', 'to': "orm['registration.RegisteredSubject']"}),
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'subject_cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_cell_alt': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_rbd.rbdoffstudy': {
            'Meta': {'object_name': 'RBDOffStudy'},
        ...
        'bcpp_rbd.rbdoffstudyaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDOffStudyAudit', 'db_table': "u'bcpp_rbd_rbdoffstudy_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            ...
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'reason_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'registered_subject': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdoffstudy'", 'to': "orm['registration.RegisteredSubject']"}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        },
        ...
        'bcpp_rbd.rbdvisitaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDVisitAudit', 'db_table': "u'bcpp_rbd_rbdvisit_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'appointment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdvisit'", 'to': "orm['appointment.Appointment']"}),
            'comments': ('django.db.models.fields.TextField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hostname_created': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'hostname_modified': ('django.db.models.fields.CharField', [], {'default': "'One.local'", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'household_member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_rbdvisit'", 'to': "orm['bcpp_household_member.HouseholdMember']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'info_source': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'info_source_other': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
