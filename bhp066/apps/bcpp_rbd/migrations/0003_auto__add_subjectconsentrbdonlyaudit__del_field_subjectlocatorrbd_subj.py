...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'RBDLocator.subject_visit'
        db.rename_column(u'bcpp_rbd_subjectlocatorrbd', 'subject_visit_id', 'rbd_visit_id')

        # Renaming field 'RBDLocatorAudit.subject_visit'
        db.rename_column('bcpp_rbd_subjectlocatorrbd_audit', 'subject_visit_id', 'rbd_visit_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'RBDLocator.subject_visit'
        db.add_column(u'bcpp_rbd_subjectlocatorrbd', 'subject_visit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_rbd.RBDVisit'], null=True),
                      keep_default=False)

        # Deleting field 'RBDLocator.rbd_visit'
        db.delete_column(u'bcpp_rbd_subjectlocatorrbd', 'rbd_visit_id')

        # Adding field 'RBDLocatorAudit.subject_visit'
        db.add_column('bcpp_rbd_subjectlocatorrbd_audit', 'subject_visit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectlocatorrbd', null=True, to=orm['bcpp_rbd.RBDVisit']),
                      keep_default=False)

        # Deleting field 'RBDLocatorAudit.rbd_visit'
        db.delete_column(u'bcpp_rbd_subjectlocatorrbd_audit', 'rbd_visit_id')
