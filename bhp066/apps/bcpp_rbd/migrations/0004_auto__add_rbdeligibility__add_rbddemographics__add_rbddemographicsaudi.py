...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bcpp_rbd_rbdeligibility', (
        ...
        db.send_create_signal('bcpp_rbd', ['RBDEligibility'])

        # Adding model 'RBDDemographics'
        db.create_table(u'bcpp_rbd_rbddemographics', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('rbd_visit', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_rbd.RBDVisit'], unique=True)),
        ...
        db.send_create_signal('bcpp_rbd', ['RBDDemographics'])

        # Adding M2M table for field religion on 'RBDDemographics'
        m2m_table_name = db.shorten_name(u'bcpp_rbd_rbddemographics_religion')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd.rbddemographics'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'bcpp_rbd_rbddemographics_ethnic')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd.rbddemographics'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'bcpp_rbd_rbddemographics_live_with')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd.rbddemographics'], null=False)),
        ...
        db.create_table(u'bcpp_rbd_rbddemographics_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('rbd_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_rbddemographics', to=orm['bcpp_rbd.RBDVisit'])),
        ))
        db.send_create_signal('bcpp_rbd', ['RBDDemographicsAudit'])


    def backwards(self, orm):
        # Deleting model 'RBDEligibility'
        db.delete_table(u'bcpp_rbd_rbdeligibility')

        # Deleting model 'RBDDemographics'
        db.delete_table(u'bcpp_rbd_rbddemographics')

        # Removing M2M table for field religion on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_rbddemographics_religion'))

        # Removing M2M table for field ethnic on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_rbddemographics_ethnic'))

        # Removing M2M table for field live_with on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_rbddemographics_live_with'))

        # Deleting model 'RBDDemographicsAudit'
        db.delete_table(u'bcpp_rbd_rbddemographics_audit')
    ...
    models = {
        ...
        'bcpp_rbd.subjectconsentrbdonlyaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDConsentAudit', 'db_table': "u'bcpp_rbd_subjectconsentrbdonly_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'assessment_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True'}),
        ...
        'bcpp_rbd.subjectlocatorrbdaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDLocatorAudit', 'db_table': "u'bcpp_rbd_subjectlocatorrbd_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'alt_contact_cell': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            ...
            'subject_phone': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_phone_alt': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'rbd_visit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_audit_subjectlocatorrbd'", 'null': 'True', 'to': "orm['bcpp_rbd.RBDVisit']"}),
            'subject_work_phone': ('django.db.models.fields.CharField', [], {'max_length': '78L', 'null': 'True', 'blank': 'True'}),
            'subject_work_place': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'user_created': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'}),
            'user_modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'db_index': 'True'})
        ...
        'bcpp_rbd.subjectvisitrbdaudit': {
            'Meta': {'ordering': "['-_audit_timestamp']", 'object_name': 'RBDVisitAudit', 'db_table': "u'bcpp_rbd_subjectvisitrbd_audit'"},
            '_audit_change_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            '_audit_id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            '_audit_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
