...
from ..forms import RBDVisitForm
from ..models import RBDVisit


class RBDVisitAdmin(BaseAppointmentModelAdmin):

    form = RBDVisitForm
    visit_model_instance_field = 'rbd_visit'
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(RBDVisitAdmin, self).formfield_for_foreignkey(db_field, request, **kwargs)

admin.site.register(RBDVisit, RBDVisitAdmin)
