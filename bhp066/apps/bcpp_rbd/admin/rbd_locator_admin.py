...
from apps.bcpp_rbd.forms import RBDLocatorForm
from apps.bcpp_rbd.models import RBDLocator
...
class RBDLocatorAdmin(RBDVisitModelAdmin):
    ...
    list_display = ('rbd_visit', 'date_signed', "home_visit_permission", "may_follow_up", "may_sms_follow_up", "has_alt_contact", "may_call_work", "may_contact_someone")
admin.site.register(RBDLocator, RBDLocatorAdmin)
