...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RBDSubjectOffStudyAudit'
        db.create_table(u'bcpp_rbd_subject_rbdsubjectoffstudy_audit', (
            ...
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_rbdsubjectoffstudy', to=orm['registration.RegisteredSubject'])),
        ))
        db.send_create_signal('bcpp_rbd_subject', ['RBDSubjectOffStudyAudit'])

        # Adding model 'RBDSubjectOffStudy'
        db.create_table(u'bcpp_rbd_subject_rbdsubjectoffstudy', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_rbd_subject', ['RBDSubjectOffStudy'])


    def backwards(self, orm):
        # Deleting model 'RBDSubjectOffStudyAudit'
        db.delete_table(u'bcpp_rbd_subject_rbdsubjectoffstudy_audit')

        # Deleting model 'RBDSubjectOffStudy'
        db.delete_table(u'bcpp_rbd_subject_rbdsubjectoffstudy')
