...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubjectVisitRBDAudit'
        db.create_table(u'bcpp_rbd_subject_subjectvisitrbd_audit', (
            ...
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectvisitrbd', to=orm['bcpp_household_member.HouseholdMember'])),
            ...
            ('appointment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectvisitrbd', to=orm['appointment.Appointment'])),
        ))
        db.send_create_signal('bcpp_rbd_subject', ['SubjectVisitRBDAudit'])

        # Adding model 'SubjectVisitRBD'
        db.create_table(u'bcpp_rbd_subject_subjectvisitrbd', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_rbd_subject', ['SubjectVisitRBD'])

        # Adding model 'SubjectLocatorRBDAudit'
        db.create_table(u'bcpp_rbd_subject_subjectlocatorrbd_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('hostname_modified', self.gf('django.db.models.fields.CharField')(default='One.local', max_length=50, db_index=True, blank=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 11, 0, 0))),
            ('date_signed', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 11, 0, 0))),
            ...
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectlocatorrbd', null=True, to=orm['bcpp_rbd_subject.SubjectVisitRBD'])),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('_audit_id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('registered_subject', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_subjectlocatorrbd', null=True, to=orm['registration.RegisteredSubject'])),
        ))
        db.send_create_signal('bcpp_rbd_subject', ['SubjectLocatorRBDAudit'])

        # Adding model 'SubjectLocatorRBD'
        db.create_table(u'bcpp_rbd_subject_subjectlocatorrbd', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('contact_cell', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('subject_visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bcpp_rbd_subject.SubjectVisitRBD'], null=True)),
            ('alt_contact_cell_number', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('has_alt_contact', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('alt_contact_name', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
            ('alt_contact_rel', self.gf('django.db.models.fields.CharField')(max_length=78L, null=True, blank=True)),
        ...
        db.send_create_signal('bcpp_rbd_subject', ['SubjectLocatorRBD'])
        ...
        # Adding model 'SubjectConsentRBDonly'
        db.create_table(u'bcpp_rbd_subject_subjectconsentrbdonly', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
        ...
        db.send_create_signal('bcpp_rbd_subject', ['SubjectConsentRBDonly'])

        # Adding unique constraint on 'SubjectConsentRBDonly', fields ['subject_identifier', 'survey']
        db.create_unique(u'bcpp_rbd_subject_subjectconsentrbdonly', ['subject_identifier', 'survey_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubjectConsentRBDonly', fields ['subject_identifier', 'survey']
        db.delete_unique(u'bcpp_rbd_subject_subjectconsentrbdonly', ['subject_identifier', 'survey_id'])

        # Deleting model 'SubjectVisitRBDAudit'
        db.delete_table(u'bcpp_rbd_subject_subjectvisitrbd_audit')

        # Deleting model 'SubjectVisitRBD'
        db.delete_table(u'bcpp_rbd_subject_subjectvisitrbd')

        # Deleting model 'SubjectLocatorRBDAudit'
        db.delete_table(u'bcpp_rbd_subject_subjectlocatorrbd_audit')

        # Deleting model 'SubjectLocatorRBD'
        db.delete_table(u'bcpp_rbd_subject_subjectlocatorrbd')

        # Deleting model 'SubjectConsentRBDonlyAudit'
        db.delete_table(u'bcpp_rbd_subject_subjectconsentrbdonly_audit')

        # Deleting model 'SubjectConsentRBDonly'
        db.delete_table(u'bcpp_rbd_subject_subjectconsentrbdonly')
    ...
    models = {
        ...
        'bcpp_rbd_subject.subjectlocatorrbd': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
