...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RBDEligibility'
        db.create_table(u'bcpp_rbd_subject_rbdeligibility', (
            ...
            ('part_time_resident', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('hiv_status', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('bcpp_rbd_subject', ['RBDEligibility'])

        # Adding model 'RBDDemographics'
        db.create_table(u'bcpp_rbd_subject_rbddemographics', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('id', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('subject_visit_rbd', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bcpp_rbd_subject.SubjectVisitRBD'], unique=True)),
            ('report_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 20, 0, 0))),
        ...
        db.send_create_signal('bcpp_rbd_subject', ['RBDDemographics'])

        # Adding M2M table for field religion on 'RBDDemographics'
        m2m_table_name = db.shorten_name(u'bcpp_rbd_subject_rbddemographics_religion')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd_subject.rbddemographics'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'bcpp_rbd_subject_rbddemographics_ethnic')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd_subject.rbddemographics'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'bcpp_rbd_subject_rbddemographics_live_with')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rbddemographics', models.ForeignKey(orm['bcpp_rbd_subject.rbddemographics'], null=False)),
        ...
        db.create_table(u'bcpp_rbd_subject_rbddemographics_audit', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('user_created', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ('user_modified', self.gf('django.db.models.fields.CharField')(default='', max_length=250, db_index=True)),
            ...
            ('subject_visit_rbd', self.gf('django.db.models.fields.related.ForeignKey')(related_name='_audit_rbddemographics', to=orm['bcpp_rbd_subject.SubjectVisitRBD'])),
        ))
        db.send_create_signal('bcpp_rbd_subject', ['RBDDemographicsAudit'])


    def backwards(self, orm):
        # Deleting model 'RBDEligibility'
        db.delete_table(u'bcpp_rbd_subject_rbdeligibility')

        # Deleting model 'RBDDemographics'
        db.delete_table(u'bcpp_rbd_subject_rbddemographics')

        # Removing M2M table for field religion on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_subject_rbddemographics_religion'))

        # Removing M2M table for field ethnic on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_subject_rbddemographics_ethnic'))

        # Removing M2M table for field live_with on 'RBDDemographics'
        db.delete_table(db.shorten_name(u'bcpp_rbd_subject_rbddemographics_live_with'))

        # Deleting model 'RBDDemographicsAudit'
        db.delete_table(u'bcpp_rbd_subject_rbddemographics_audit')
    ...
    models = {
        ...
        'bcpp_rbd_subject.rbddemographics': {
            ...
            'report_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 20, 0, 0)'}),
            'revision': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
        ...
        'bcpp_rbd_subject.subjectlocatorrbd': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date_signed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 20, 0, 0)'}),
