...
class CommunityComparisonPDF(object):
    ...
    def __init__(self, pdf_data, title):
        self.community1_data = pdf_data['community1_data']
        self.community2_data = pdf_data['community2_data']
        self.community1_name = self.community1_data[0].community
        self.community2_name = self.community2_data[0].community
    ...
    def build(self, output):
        ...
        story = []
        story.append(Paragraph("Community Accrual Report", self.p_style['ReportName']))
        ...
        report_data = []
        report_table_headers = [Paragraph("Accrual Report Variables", self.p_style['report_vars'])]
        ...
        extra_styles = []
        empty_column = " "
        for sect1, sect2 in izip(self.community1_data, self.community2_data):
