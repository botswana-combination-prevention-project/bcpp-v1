...
class OperationalHousehold(BaseOperationalReport):
    ...
    def report_data(self):
        ...
        threads = []
        household = Household.objects.filter(plot__community__icontains=self.community,
        ...
        # Create new threads
        thread1 = NonEnumeratedHouseholds(1, "NonEnumeratedHouseholds-1", 1, household_non_enumerated_structures, self.data_dict)
        thread1.start()
