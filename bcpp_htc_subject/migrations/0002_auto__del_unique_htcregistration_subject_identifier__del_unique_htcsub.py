...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'HtcSubjectConsent', fields ['subject_identifier']
        db.delete_unique('bcpp_htc_subject_htcsubjectconsent', ['subject_identifier'])

        # Removing unique constraint on 'HtcRegistration', fields ['subject_identifier']
        db.delete_unique('bcpp_htc_subject_htcregistration', ['subject_identifier'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'HtcRegistration', fields ['subject_identifier']
        db.create_unique('bcpp_htc_subject_htcregistration', ['subject_identifier'])

        # Adding unique constraint on 'HtcSubjectConsent', fields ['subject_identifier']
        db.create_unique('bcpp_htc_subject_htcsubjectconsent', ['subject_identifier'])
